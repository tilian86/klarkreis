...
,
      ...
      pair: {
        ...
        stations: withFeedback([
          ...
          { name: 'Reiter', title: 'Die Vier Apokalyptischen Reiter', duration: 12*60,
            ...
            description: 'Gottman hat vier Verhaltensmuster identifiziert, deren Auftreten in der Streit-Eröffnung mit hoher Trefferquote vorhersagt, ob das Gespräch — und die Beziehung — gut endet. Er nennt sie die Vier Apokalyptischen Reiter, weil sie nicht einzeln stehen. Sie kommen oft in Reihenfolge, und einer öffnet dem nächsten die Tür.',
            items: [
              ...
              { accent: '3.', label: 'Rechtfertigung', text: 'Verteidigung statt Verantwortung. „Ich habe es nicht vergessen, du hast mir nichts gesagt." Das macht die Partner:in zum Problem statt zur Lösung.' },
              { accent: '4.', label: 'Mauern', text: 'Schweigen, Wegschauen, sich emotional zurückziehen. Wirkt cool, ist aber das Gegenteil — innerlich ist man überflutet und macht zu, weil man nicht mehr kann.' }
            ],
          ...
          { name: 'Szene', title: 'Eine echte Szene, langsam durchgehen', duration: 14*60,
            hostNote: 'Wählt gemeinsam eine konkrete Streitszene aus den letzten Wochen — eine, die ihr beide noch erinnert. Nicht die schlimmste, eine mittelschwere. Jede:r erzählt 5 Min die eigene Erinnerung der ersten drei Minuten dieses Streits. Die andere Person hört nur zu. Danach: welche Reiter sind aufgetreten? Auch hier: jede:r nennt nur die eigenen.',
          ...
          { name: 'Reparatur', title: 'Die Gegen-Werkzeuge: Reparatur-Versuche', duration: 10*60,
            ...
            items: [
              ...
              { accent: '2.', label: 'Humor', text: 'Ein Insider-Witz, ein Augenzwinkern, eine gemeinsame Albernheit — wirkt fast magisch, weil das die Verachtung sofort ableitet.' },
              ...
              { accent: '4.', label: 'Time-out', text: 'Pause vereinbaren, wenn eine:r überflutet ist. Mindestens 20 Minuten, danach wieder anfangen. „Ich brauche zehn Minuten" ist kein Rückzug, sondern Regulation.' },
      ...
      solo: {
        ...
        stations: withFeedback([
          ...
          { name: 'Einstieg', title: 'Was Glück in Beziehungen ausmacht', duration: 4*60,
            ...
            description: 'Gottman hat über Jahrzehnte Paare im Labor beobachtet und kann nach kurzer Zeit mit hoher Treffsicherheit vorhersagen, ob eine Beziehung halten wird. Sein Befund ist nüchtern: es geht nicht um große Liebe, sondern um Mikro-Gewohnheiten.' },
          { name: 'Reiter', title: 'Die vier Apokalyptischen Reiter', duration: 6*60,
            ...
            items: [
              ...
              { accent: '4.', label: 'Mauern', text: 'Sich emotional zurückziehen, wenn man überflutet ist.' }
            ] },
          ...
          { name: 'Mini-Karte', title: 'Wie gut kennst du sie oder ihn noch?', duration: 6*60,
            ...
            question: 'Beantworte für dich: Was sind die drei größten Stressquellen deiner Partner:in gerade? Was ist ihr heimlicher Traum? Was nervt sie an dir, das sie noch nicht ausgesprochen hat? Und wann hat sie zuletzt geweint?' },
  ...
  // =====================================================================
  // WIR-REISE · ABEND 2 — Liebeslandkarten (Gottman Geheimnis 1)
  // Wer ist mein Partner heute? Über 60 Fragen, ein präzises inneres Bild.
  // =====================================================================
  wir_reise_2: {
    title: 'Liebeslandkarten',
    subtitle: 'Wir-Reise · Abend 2 von 7',
    lead: 'Im biblischen Sinne hieß sexuelle Liebe „erkennen". Wer den anderen nicht wirklich kennt, kann ihn nicht wirklich lieben. Heute aktualisiert ihr eure innere Karte voneinander — inspiriert von John Gottmans Liebeslandkarten-Forschung, in einer eigenen 20-Aussagen-Diagnose, einem 60-Fragen-Spiel und fünf Selbstbild-Fragen.',
    category: 'Wir-Reise',
    image: 'images/wir-reise-2.jpg',
    reise: { id: 'wir', nr: 2, total: 7, titel: 'Wir-Reise — Sieben Abende nach Gottman' },
    philosophy1: 'Gottmans Daten sind nüchtern: 67 Prozent der Paare erleben nach der ersten Elternschaft einen jähen Einbruch der Beziehungsqualität. Das eine Drittel, das ihn nicht erlebt, hat eine messbare Gemeinsamkeit: detaillierte Liebeslandkarten. Sie wissen, wie die andere Person innerlich tickt, und sie aktualisieren dieses Wissen. Krisen werfen sie nicht aus der Bahn — weil ihre Innenkarte zur Außenwelt passt.',
    philosophy2: 'Liebeslandkarten sind nicht Trivia-Wissen wie „Lieblingsfarbe Blau". Sie sind das, was Gottman „kognitiven Raum" nennt — wie viel Platz dein Kopf für die Innenwelt deiner Partner:in reserviert. Heute prüft ihr die Genauigkeit eurer Karten und füllt die weißen Flecken. Es wird leichter als ihr denkt — und ehrlicher als ihr erwartet.',
    formats: {
      pair: {
        label: 'Zu zweit',
        duration: '~1 Std. 50 Min.',
        people: '2 Personen',
        stations: withFeedback([
          { name: 'Öffnen', title: 'Wieder bei euch', duration: 3*60,
            hostNote: 'Kerze, Handys weg, drei Atemzüge. Eine Woche ist um — was hat der Vier-Reiter-Blick mit euch gemacht?',
            description: 'Zweiter Abend einer Reise braucht einen bewussten Wieder-Einstieg. Keine Zusammenfassung, kein Tagebuchverlesen — nur ein Moment, in dem ihr beide bemerkt, dass ihr wieder hier seid.',
            teaser: 'Wieder im Raum, eine Woche später.' },
          { name: 'Rückblende', title: 'Was die Vier Reiter gemacht haben', duration: 8*60,
            hostNote: 'Beide je 3-4 Min. Nicht die andere Person analysieren — nur Eigenes berichten.',
            question: 'Was hast du in der Woche bei dir bemerkt — welcher Reiter ist dir aufgefallen, bevor er reiten konnte?' },
          { name: 'Einstieg', title: 'Erkennen heißt lieben', duration: 6*60,
            hostNote: 'Eine:r liest langsam. 30 Sek Stille nach dem Zitat.',
            ...
            description: 'Gottman dreht eine alte Frage um. Nicht: liebt ihr euch tief genug, um euch wirklich zu kennen? Sondern: kennt ihr euch genau genug, um euch wirklich zu lieben? Heute prüft ihr eure Karten. Lücken sind dabei keine Schande — sie sind Material.',
            teaser: 'Was du nicht weißt, kannst du nicht halten.' },
          { name: 'Selbsttest', title: 'Wie genau ist deine Karte?', duration: 12*60,
            hostNote: 'Jede:r markiert für sich die 20 Aussagen mit „wahr" oder „falsch". Gezählt wird nur „wahr". Über 10 Punkte heißt: solide. Unter 10 heißt: es liegt brach. Wichtig: ihr testet euer EIGENES Wissen, nicht das der anderen Person.',
            description: 'Eine eigene Selbst-Diagnose-Liste, inspiriert von Gottmans Liebeslandkarten-Forschung. 20 Aussagen — wie viele kannst du ehrlich mit „wahr" beantworten?',
            items: [
          ...
          { name: 'Auswertung', title: 'Was die Punktzahl bedeutet', duration: 4*60,
            hostNote: 'Reihum: nennt eure Zahl. Ohne Wertung — keine Diskussion, kein Trösten.',
            description: '10 Punkte oder mehr: solide Innenkarte. Lücken bestehen, aber das Grundwissen ist da.\nUnter 10 Punkte: hier ist Raum. Ihr habt nicht „versagt" — euer Alltag hat euch die Aktualisierung gestohlen. Heute holt ihr sie nach.',
            question: 'Welche eine Aussage hat dich beim Bewerten am meisten zucken lassen?' },
          { name: 'Das Spiel', title: 'Sechzig Fragen — ein Karten-Spiel', duration: 25*60,
            hostNote: 'Jede:r wählt zufällig 10 Zahlen zwischen 1 und 60 und schreibt sie auf einen Zettel. In der Liste unten findet ihr die zugehörigen Fragen und stellt sie der Partner:in. Wenn sie antwortet und ihr als Fragesteller:in urteilt „korrekt", gibt es Punkte für beide — einen Antwortpunkt für die Partner:in, einen Wisspunkt für euch. „Falsch" heißt: null Punkte für beide. Wechselt nach jeder Frage. Lacht. Macht euch keinen Stress. Es geht nicht ums Gewinnen.',
            description: 'Wählt zufällig je 10 Fragen aus dieser 60er-Liste — die Punkte in Klammern werten, wie tief die Frage geht (1 = leichtes Trivia, 5 = innere Wahrheit). Spielt zu zweit. Eure Karte aktualisiert sich, während ihr spielt.',
            items: [
              ...
              { accent: '36.', label: 'Versagens-Angst', text: 'Wovor habe ich Angst, das es nie passieren wird? (4)' },
              { accent: '37.', label: 'Stille Sehnsucht', text: 'Was sehne ich mir leise an, ohne es oft auszusprechen? (5)' },
              ...
              { accent: '52.', label: 'Inneres Kind', text: 'Welches ist die Eigenschaft an mir, die noch das Kind in mir ist? (4)' },
            ...
            teaser: 'Zwanzig Fragen pro Person — wer am Ende mehr Punkte hat, hat sich besser eingehört.' },
          { name: 'Stille', title: 'Drei Minuten Verdauen', duration: 3*60,
            hostNote: 'Kerze, Atem. Nichts kommentieren. Drei Minuten.',
            description: 'Das Spiel hat Material aufgewirbelt. Bevor ihr in die nächste Übung geht, darf Stille tragen.' },
          { name: 'Fünf Fragen', title: 'Wer du werden willst', duration: 18*60,
            ...
            description: 'Fünf Fragen, die das Selbstbild eines Menschen ausmachen — inspiriert von Gottmans Selbstbild-Arbeit, aber in unserer eigenen Sprache. Wer diese Antworten der eigenen Partner:in nicht kennt, kennt nur die Außenseite. Heute legt ihr die fünf nebeneinander.',
            items: [
              ...
              { accent: '3.', label: 'Innere Dämonen', text: 'Welche inneren Widerstände hast du dabei bekämpft — welche stehen noch?' },
          ...
          { name: 'Lücken', title: 'Was war neu?', duration: 8*60,
            hostNote: 'Beide je 3 Min. Nicht analysieren — nur benennen.',
            question: 'Welche Antwort heute Abend war für dich ehrlich neu — und was hat das in dir ausgelöst?' },
          { name: 'Einladung', title: 'Wohin Abend 3 führt', duration: 5*60,
            hostNote: 'Eine:r liest vor.',
            description: 'Heute habt ihr eure innere Karte aktualisiert. Aber Wissen allein reicht nicht — wenn das Wissen nicht in Wertschätzung mündet, bleibt es Datensammlung.\n\n→ Abend 3 — Zuneigung und Bewunderung. Wie pflegt man die innere positive Brille, die jede Beziehung trägt? Gottman zeigt: wer in stabilen Ehen die geliebte Person ehrlich beschreiben kann, antwortet ganz anders als in instabilen — selbst bei denselben Eigenschaften. Es geht um Erinnerung, um aktive Aufwertung, um Geschichten. Sieben-Wochen-Plan inklusive.' },
          { name: 'Schritt', title: 'Diese Woche aktualisieren', duration: 6*60,
            hostNote: 'Je 2-3 Min: ein konkreter Schritt diese Woche, der eure Karten weiter aktualisiert.',
            description: 'Nicht „ich werde aufmerksamer". Sondern: „Jeden Tag eine offene Frage stellen, die ich noch nicht weiß." Oder: „Dienstag beim Abendessen die Frage stellen, die ich heute nicht gestellt habe."',
            question: 'Welche eine konkrete Aktualisierung diese Woche?' },
          { name: 'Wort', title: 'Ein Wort, mit dem ihr geht', duration: 3*60,
            hostNote: 'Beide je ein Wort. Keine Begründung.',
            question: 'Ein Wort.' }
        ])
      ...
      solo: {
        ...
        people: 'Nur du',
        stations: withFeedback([
          { name: 'Öffnen', title: 'Allein bei dir', duration: 2*60,
            hostNote: 'Kerze, Stift, Papier. Niemand außer dir liest mit.',
            description: 'Du machst Liebeslandkarten-Arbeit allein — als Vorbereitung, als Bilanz, oder weil deine Partner:in nicht dabei ist. Was du findest, ist deins.' },
          { name: 'Einstieg', title: 'Erkennen heißt lieben', duration: 4*60,
            hostNote: 'Lies langsam, zweimal.',
            quote: { text: 'Wenn man jemanden nicht wirklich kennt, wie soll man ihn dann wirklich lieben können?', author: 'John Gottman' },
            description: 'Heute prüfst du, wie aktuell deine innere Karte deiner Partner:in ist. Lücken sind keine Schande — sie sind Material.' },
          { name: 'Selbsttest', title: 'Wie genau ist deine Karte?', duration: 10*60,
            hostNote: 'Schreibe die 20 Aussagen auf Papier und markiere ehrlich „wahr" / „falsch". Zähle nur die Wahr-Treffer.',
            description: 'Eine eigene Diagnose-Liste, inspiriert von Gottmans Liebeslandkarten-Forschung. 20 Aussagen über dein Wissen vom Innen-Leben deiner Partner:in.',
            items: [
              ...
              { accent: '4.', label: 'Aktuelle Ängste', text: 'Ich kenne die Ängste, die sie gerade nachts wach halten.' },
              ...
              { accent: '7.', label: 'Lotto-Test', text: 'Ich weiß, was sie bei plötzlichem Lotto-Gewinn tun würde.' },
              { accent: '8.', label: 'Aktive Neugier', text: 'Ich frage regelmäßig nach ihren Vorstellungen und Erfahrungen.' }
            ],
            question: 'Wie viele kannst du heute wirklich mit „wahr" beantworten?' },
          { name: 'Was du nicht weißt', title: 'Drei Lücken', duration: 8*60,
            hostNote: 'Schreibe 6 Min am Stück. Drei konkrete Lücken in deinem Wissen.',
            question: 'Welche drei Fragen über deine Partner:in kannst du gerade nicht wirklich beantworten?' },
          { name: 'Fünf Fragen', title: 'Wer sie oder er werden will', duration: 10*60,
            hostNote: 'Schreibe für jede der fünf Fragen, was du glaubst, dass deine Partner:in antworten würde. Wo du unsicher bist, markiere mit Fragezeichen.',
            description: 'Fünf Selbstbild-Fragen, inspiriert von Gottmans Selbstbild-Arbeit. Beantworte sie aus der Sicht deiner Partner:in. Die Fragezeichen sind die wertvollste Information.',
            items: [
              { accent: '1.', label: 'Werden', text: 'Wer will sie werden?' },
              { accent: '2.', label: 'Tun', text: 'Was tut sie konkret dafür?' },
              { accent: '3.', label: 'Dämonen', text: 'Mit welchen inneren Widerständen kämpft sie?' },
              { accent: '4.', label: 'Verlorene Träume', text: 'Welche Träume hat sie sich nicht gegönnt?' },
              { accent: '5.', label: 'Fünf Jahre', text: 'Wie soll ihr Leben in fünf Jahren aussehen?' }
            ] },
          { name: 'Eigene Bilanz', title: 'Wer du selbst werden willst', duration: 8*60,
            hostNote: 'Beantworte dieselben fünf Fragen für dich selbst. Ehrlich, ungefiltert.',
            description: 'Jetzt umgekehrt — wer bist DU heute, wenn du diese fünf Fragen ehrlich beantwortest? Vielleicht hat deine Partner:in ein veraltetes Bild von dir. Das ist wertvolle Information für Abend 3.',
            question: 'Was würde deine Partner:in über dich raten, das nicht mehr stimmt?' },
          { name: 'Drei Fragen', title: 'Was du beim nächsten Treffen wissen willst', duration: 5*60,
            hostNote: 'Schreibe drei konkrete Fragen auf einen Zettel.',
            question: 'Welche drei Fragen willst du deiner Partner:in stellen, sobald sich Gelegenheit ergibt?' },
          { name: 'Ausblick', title: 'Was Abend 3 bringt', duration: 3*60,
            hostNote: 'Lies.',
            description: '→ Abend 3 — Zuneigung und Bewunderung. Wissen wird zur Wertschätzung, sonst bleibt es Datensammlung. Du lernst Gottmans 7-Wochen-Übung kennen und einen Weg, die positive innere Brille wieder zu aktivieren, auch wenn der Alltag sie hat trübe werden lassen.' },
          { name: 'Wort', title: 'Ein Wort', duration: 3*60,
            hostNote: 'Ein Wort, Zettel, Tasche.',
            question: 'Ein Wort.' }
        ])
      }
    }
  ...
  // =====================================================================
  // WIR-REISE · ABEND 3 — Zuneigung und Bewunderung (Geheimnis 2)
  // Die positive innere Brille pflegen. Sieben-Wochen-Plan + Geschichte.
  // =====================================================================
  wir_reise_3: {
    title: 'Zuneigung und Bewunderung',
    subtitle: 'Wir-Reise · Abend 3 von 7',
    lead: 'Wissen allein hält keine Beziehung. Was sie hält, ist die positive innere Brille — Gottman nennt sie „Zuneigung und Bewunderung", das stärkste Antidot gegen Verachtung, den gefährlichsten der vier Reiter. Heute reaktiviert ihr eure Brille mit drei Übungen, die in Gottmans Daten messbar wirken: das Geschichte-Erinnern, die 50 Wertschätzungs-Worte, der Sieben-Wochen-Plan.',
    category: 'Wir-Reise',
    image: 'images/wir-reise-3.jpg',
    reise: { id: 'wir', nr: 3, total: 7, titel: 'Wir-Reise — Sieben Abende nach Gottman' },
    philosophy1: 'In glücklichen Beziehungen passieren ständig zwei Dinge gleichzeitig: einer macht etwas Kleines, die andere Person bemerkt es positiv. Das nennt Gottman „die positive Innenwelt". Bei Paaren in Krise dreht sich diese Mechanik um — selbst gute Taten werden negativ gedeutet („was hat sie denn jetzt im Schilde?"). Diese Filter-Verschiebung ist messbar, und sie ist umkehrbar.',
    philosophy2: 'Gottman: wenn ihr eure Geschichte nicht mehr in positiven Worten erzählen könnt, ist eure Beziehung in Gefahr. Wenn ihr es noch könnt — auch nach Streit, auch nach schweren Zeiten — habt ihr ein Polster, das Stürme trägt. Heute erinnert ihr eure Geschichte und übt die Worte ein.',
    formats: {
      pair: {
        label: 'Zu zweit',
        duration: '~1 Std. 40 Min.',
        ...
        stations: withFeedback([
          { name: 'Öffnen', title: 'Wieder hier', duration: 3*60,
            hostNote: 'Kerze, Atem. Was hat die Liebeslandkarten-Woche bewegt?',
            description: 'Dritte Begegnung. Inzwischen kennt der Körper das Ritual — und genau das ist die Idee.' },
          { name: 'Rückblende', title: 'Was Karten aufgedeckt haben', duration: 7*60,
            hostNote: 'Beide je 3 Min.',
            question: 'Welche Lücke aus Abend 2 ist diese Woche kleiner geworden — und wie?' },
          { name: 'Einstieg', title: 'Die positive innere Brille', duration: 6*60,
            hostNote: 'Eine:r liest vor.',
            quote: { text: 'Wenn ihr eure Geschichte nicht mehr in positiven Worten erzählen könnt, ist eure Beziehung in Gefahr. Wenn ihr es noch könnt — auch nach Streit — habt ihr ein Polster, das Stürme trägt.', author: 'John Gottman (sinngemäß)' },
            description: 'Verachtung — der gefährlichste der vier Reiter — wächst auf einem trockenen Boden: einer Beziehung, in der die positiven Mikro-Momente nicht mehr bemerkt werden. Das Antidot ist nicht „mehr Komplimente", sondern eine Verschiebung der Brille. Heute reaktiviert ihr sie konkret.',
            teaser: 'Antidot gegen Verachtung — die innere Brille, durch die ihr euch seht.' },
          { name: 'Geschichte', title: 'Wie alles anfing — neu erzählt', duration: 18*60,
            hostNote: 'Setzt euch gegenüber. Person A erzählt 7 Min: Wie habt ihr euch das erste Mal getroffen? Was hat dich an ihr oder ihm sofort getroffen? Welche Szene aus der frühen Zeit ist dir geblieben? Person B hört nur zu — nicht korrigieren, nicht ergänzen. Dann wechseln. Wer schon viele Jahre zusammen ist: erzählt eine konkrete Anekdote aus dem ersten Jahr, die ihr nicht oft erzählt habt.',
            description: 'Gottman hat herausgefunden: Paare, die ihre Geschichte mit Wärme und Detail erzählen können, sind die stabilsten. Bei Paaren in Krise verflacht die Geschichte oder dreht ins Negative — „was haben wir bloß gesehen ineinander". Das Erzählen selbst aktiviert die positive Brille messbar.',
            question: 'Was war der Moment, an dem du wusstest, dass du die andere Person wirklich kennenlernen willst?' },
          { name: 'Was ich schätze', title: '50 Wertschätzungs-Worte', duration: 12*60,
            hostNote: 'Beide markieren für sich je drei Eigenschaften aus der Liste, die ihr an der Partner:in besonders schätzt. Dann reihum: nennt eure drei und benennt jeweils einen konkreten Moment, in dem ihr diese Eigenschaft erlebt habt. Die empfangende Person sagt nur „Danke".',
            description: 'Gottmans Liste von 50 Wertschätzungs-Worten — wählt drei, mit denen ihr eure Partner:in ehrlich beschreiben würdet.',
            items: [
              { accent: '·', label: 'Energie', text: 'deine Energie' },
              { accent: '·', label: 'Stärke', text: 'deine Stärke' },
              { accent: '·', label: 'Selbst-Beherrschung', text: 'die Art, wie du dich beherrschst' },
              { accent: '·', label: 'Empfindsamkeit', text: 'wie empfindsam du mir gegenüber bist' },
              { accent: '·', label: 'Unterstützung', text: 'wie du auf meine Stimmungen reagierst' },
              { accent: '·', label: 'Durchschauen', text: 'deine Fähigkeit, mich zu durchschauen' },
              { accent: '·', label: 'Entscheiden', text: 'wie du bist, wenn wir Entscheidungen treffen' },
              { accent: '·', label: 'Ich-sein-lassen', text: 'dass du mich ich selbst sein lässt' },
              { accent: '·', label: 'Haut', text: 'deine Haut' },
              { accent: '·', label: 'Gesicht', text: 'dein Gesicht' },
              { accent: '·', label: 'Wärme', text: 'deine Wärme' },
              { accent: '·', label: 'Begeisterung', text: 'deine Begeisterungsfähigkeit' },
              { accent: '·', label: 'Haar', text: 'dein Haar' },
              { accent: '·', label: 'Berührung', text: 'wie du mich berührst' },
              { accent: '·', label: 'Sicherheit', text: 'dass ich mich bei dir sicher fühle' },
              { accent: '·', label: 'Zärtlichkeit', text: 'deine Zärtlichkeit' },
              { accent: '·', label: 'Vorstellungskraft', text: 'deine Vorstellungskraft' },
              { accent: '·', label: 'Augen', text: 'deine Augen' },
              { accent: '·', label: 'Vertrauen', text: 'dass ich dir vertrauen kann' },
              { accent: '·', label: 'Leidenschaft', text: 'deine Leidenschaft' },
              { accent: '·', label: 'Anmut', text: 'deine Anmut' },
              { accent: '·', label: 'Bewegen', text: 'die Art, wie du dich bewegst' },
              { accent: '·', label: 'Küssen', text: 'die Art, wie du mich küsst' },
              { accent: '·', label: 'Zuneigung', text: 'deine Zuneigung' },
              { accent: '·', label: 'Verspieltheit', text: 'deine Verspieltheit' },
              { accent: '·', label: 'Humor', text: 'dein Humor' },
              { accent: '·', label: 'Loyalität', text: 'deine Loyalität mir gegenüber' },
              { accent: '·', label: 'Partner-Sein', text: 'deine Fähigkeit als Partner' },
              { accent: '·', label: 'Eltern-Sein', text: 'deine Fähigkeit als Mutter/Vater (falls zutreffend)' },
              { accent: '·', label: 'Freund-Sein', text: 'wie du als Freund:in bist' }
            ],
            teaser: 'Drei Worte, mit denen du den anderen ehrlich beschreiben würdest.' },
          { name: 'Konto', title: 'Das emotionale Bankkonto', duration: 8*60,
            hostNote: 'Lest gemeinsam.',
            description: 'Gottman nennt das, was zwischen zwei Menschen wächst, „Gefühlskonto". Jede positive Mikro-Interaktion (ein Nicken, ein Lächeln, ein „Wie war dein Tag?") ist eine kleine Einzahlung. Jede Reibung ist eine Abhebung. Wer regelmäßig einzahlt, hat ein Polster für die Stürme. Wer nur abhebt, lebt von Reserven.\n\nDie Mathematik ist freundlich: einzahlen geht schnell, abheben langsam. Ein Drei-Sekunden-Berühren beim Vorbeigehen ist ein voller Einzahlungs-Akt.',
            question: 'In welcher Form zahlt ihr beide gerade ein — und wo wird das Konto leer?' },
          { name: 'Stille', title: 'Drei Minuten Hand auf Hand', duration: 3*60,
            hostNote: 'Setzt euch nah, eine Hand jeder auf der Hand des anderen. Augen zu oder weich offen. Nicht reden.',
            description: 'Berührung ohne Sprache aktiviert das Oxytocin-System unmittelbar. Drei Minuten reichen für eine messbare Verschiebung.' },
          { name: 'Sieben Wochen', title: 'Der Sieben-Wochen-Plan', duration: 8*60,
            hostNote: 'Eine Person liest die Anweisung vor. Ihr bekommt diesen Plan als Mitnahme — er ist die eigentliche Arbeit zwischen heute und Abend 4.',
            description: 'Gottmans messbar wirksame Methode, die positive Brille einzuüben: sieben Wochen lang, jeden Werktag, ein Gedanke und eine Aufgabe. Die Aufgaben sind klein, die Gedanken positiv und konkret.\n\nBeispiele, jeden Tag ein anderer Mini-Anker: „Meine Partner:in ist großzügig" — heute schreibe ich einen Satz auf einen Zettel, der das ehrt. „Sex ist gut zwischen uns" — heute plane ich einen erotischen Abend. „Wir haben es weit zusammen gebracht" — heute erinnere ich an eine schwere Zeit, die wir durchstanden haben.\n\nDer Plan ist nicht Selbst-Training — er ist Aufmerksamkeits-Verschiebung. Sieben Wochen reichen, weil die Forschung zeigt: nach sieben Wochen bewusster Wertschätzung hat sich die Standard-Brille verändert.',
            teaser: '49 kleine Akte. Eine Aufmerksamkeits-Verschiebung, die trägt.' },
          { name: 'Erste Woche', title: 'Eure erste Woche planen', duration: 8*60,
            hostNote: 'Beide schreiben für sich fünf Aufgaben für die erste Woche — Montag bis Freitag, je eine kleine konkrete Mini-Tat. Dann tauscht ihr aus. Wichtig: nicht „ich werde besser sein", sondern zum Beispiel: „Montag schicke ich ihr ein Foto von dem Café, in dem wir zum ersten Mal Kaffee getrunken haben."',
            question: 'Welche fünf Mini-Akte schreibst du dir für diese Woche auf?' },
          { name: 'Einladung', title: 'Wohin Abend 4 führt', duration: 4*60,
            hostNote: 'Vorlesen.',
            description: '→ Abend 4 — Sich einander zuwenden. Die positive Brille macht eure Wahrnehmung weicher. Aber Wahrnehmung allein lebt nur, wenn ihr handelt. Gottman nennt die Mikro-Momente, in denen einer der beiden ein „Angebot" macht und der andere antwortet, „bids for connection". In stabilen Beziehungen werden 86 % dieser Angebote angenommen. In instabilen nur 33 %. Der Unterschied bestimmt das Schicksal einer Ehe — und ihr werdet sehen, wie messbar das ist.' },
          { name: 'Wort', title: 'Ein Wort zur Mitnahme', duration: 3*60,
            hostNote: 'Beide je ein Wort.',
            question: 'Ein Wort.' }
        ])
      },
      solo: {
        ...
        stations: withFeedback([
          { name: 'Öffnen', title: 'Kurz ankommen', duration: 2*60,
            hostNote: 'Kerze, Notizbuch.',
            description: 'Wertschätzungs-Arbeit allein ist genauso real — sie reaktiviert deine eigene Brille auf die Partner:in, die nicht im Raum ist.' },
          { name: 'Einstieg', title: 'Die positive Brille', duration: 4*60,
            hostNote: 'Lies zweimal.',
            quote: { text: 'Wenn ihr eure Geschichte nicht mehr in positiven Worten erzählen könnt, ist eure Beziehung in Gefahr.', author: 'John Gottman' },
            description: 'Heute reaktivierst du deine eigene Wertschätzungs-Brille — auch wenn deine Partner:in nicht da ist.' },
          { name: 'Geschichte', title: 'Wie alles anfing', duration: 10*60,
            hostNote: 'Schreibe 8 Min am Stück — nicht editieren.',
            question: 'Wie habt ihr euch das erste Mal getroffen? Was hat dich an ihr oder ihm sofort getroffen — und welche Szene aus der frühen Zeit erinnerst du besonders warm?' },
          { name: 'Drei Worte', title: 'Wertschätzung in drei Worten', duration: 6*60,
            hostNote: 'Schreibe drei Eigenschaften deiner Partner:in auf — und für jede einen konkreten Moment, in dem du sie erlebt hast.',
            description: 'Wertschätzung ohne Anlass ist Kompliment. Wertschätzung mit konkretem Moment ist Wahrheit.',
            question: 'Welche drei Eigenschaften deiner Partner:in schätzt du gerade besonders — und woran erinnerst du sie?' },
          { name: 'Brief', title: 'Ein nicht-geschickter Brief', duration: 10*60,
            hostNote: 'Schreibe einen Brief an deine Partner:in, den du nicht abschickst. Beginne mit: „Was du nicht weißt, ist…". Schreibe 8 Min, ohne abzusetzen.',
            description: 'Ein Brief, der nicht abgeschickt wird, ist ehrlicher als jeder mündliche Satz. Schreib, was du für richtig hältst — niemand sieht es.',
            question: 'Was schreibst du, wenn du weißt, dass keiner es liest?' },
          { name: 'Sieben Wochen', title: 'Der Plan für dich allein', duration: 6*60,
            hostNote: 'Schreibe für die ersten fünf Werktage je eine Mini-Aufgabe. Wenn du allein machst, fließen die Aufgaben in deine Aufmerksamkeit, nicht in ihre Reaktion.',
            description: 'Auch ohne Partner:in kannst du den Sieben-Wochen-Plan beginnen. Jeden Tag eine konkrete Mini-Geste: eine Nachricht, ein Erinnerungs-Foto, ein kurzes „Ich denke an dich". Die Verschiebung ist deine.',
            question: 'Fünf Mini-Akte für die nächsten fünf Werktage?' },
          { name: 'Brille-Check', title: 'Wo deine Brille trüb ist', duration: 5*60,
            hostNote: 'Schreibe ehrlich.',
            question: 'In welchem Bereich deiner Wahrnehmung deiner Partner:in ist die positive Brille gerade trüb geworden — und was hat sie trüb gemacht?' },
          { name: 'Ausblick', title: 'Abend 4', duration: 3*60,
            hostNote: 'Lies.',
            description: '→ Abend 4 — Sich zuwenden. Die Mikro-Gesten der Bindung, in denen 86 % vs. 33 % über das Schicksal einer Ehe entscheiden.' },
          { name: 'Wort', title: 'Ein Wort', duration: 2*60,
            hostNote: 'Ein Wort, Zettel, Tasche.',
            question: 'Ein Wort.' }
        ])
  ...
  // =====================================================================
  // WIR-REISE · ABEND 4 — Sich einander zuwenden (Geheimnis 3)
  // Bids for connection. 86% vs 33%. Gefühlskonto im Alltag.
  // =====================================================================
  wir_reise_4: {
    title: 'Sich einander zuwenden',
    subtitle: 'Wir-Reise · Abend 4 von 7',
    lead: 'Romantik wird nicht durch Kerzenschein gemacht, sondern durch das, was Gottman „bids for connection" nennt — die Mikro-Angebote zur Verbindung im Alltag. In stabilen Ehen werden 86 % davon angenommen. In zerbrechenden nur 33 %. Heute lernt ihr, diese Angebote zu sehen, zu senden und nicht zu verpassen.',
    category: 'Wir-Reise',
    image: 'images/wir-reise-4.jpg',
    reise: { id: 'wir', nr: 4, total: 7, titel: 'Wir-Reise — Sieben Abende nach Gottman' },
    philosophy1: 'Im Ehelabor liebt Gottman die langweiligen Szenen am meisten — wenn eine Partner:in aus dem Fenster schaut und sagt „He, schau dir das Schiff an", und die andere kurz aufblickt und nickt. Solche Mikro-Momente sind es, was Beziehungen wirklich trägt. Sie scheinen banal — und sind in Wahrheit das Material, aus dem Romantik gemacht ist.',
    philosophy2: 'Das Gefühlskonto wächst nicht durch große Liebesabende, sondern durch Hunderte täglicher Mikro-Einzahlungen. Wer sich konsequent abwendet — mit dem Handy weiter scrollt, statt aufzuschauen —, schreibt nicht „Großes" ab. Er schreibt das tägliche Polster ab. Heute schaut ihr genau hin: wo wendet ihr euch zu, wo voneinander ab.',
    formats: {
      pair: {
        label: 'Zu zweit',
        duration: '~1 Std. 40 Min.',
        people: '2 Personen',
        stations: withFeedback([
          { name: 'Öffnen', title: 'Wieder gemeinsam', duration: 3*60,
            hostNote: 'Kerze, Atem.',
            description: 'Vierter Abend. Inzwischen ist das Format vertraut — und genau deshalb beginnt es jetzt zu wirken.' },
          { name: 'Rückblende', title: 'Was die Brille gemacht hat', duration: 7*60,
            hostNote: 'Beide je 3 Min.',
            question: 'Was war der schönste Mini-Akt aus eurer Sieben-Wochen-Woche — und was war schwierig?' },
          { name: 'Einstieg', title: 'Die Mikro-Momente', duration: 7*60,
            hostNote: 'Vorlesen.',
            quote: { text: 'In den langweiligsten Szenen — wenn einer sagt „he, schau dir das Schiff an" und die andere kurz hochschaut — entscheidet sich das Schicksal einer Ehe.', author: 'John Gottman (sinngemäß)' },
            description: 'Gottman hat eine kleine Studie gemacht, die alles verändert: 130 Paare beobachtet, sechs Jahre später nachgesehen. In den Ehen, die hielten, hatten die Partner:innen 86 Prozent der „bids for connection" — der kleinen Verbindungsangebote — angenommen. In den geschiedenen Ehen nur 33 Prozent. Das war alles. Keine großen Streits. Nur das tägliche Wegschauen.',
            teaser: '86 % vs. 33 % — die Mathematik einer Beziehung.' },
          { name: 'Angebote', title: 'Was ist ein „Angebot"?', duration: 10*60,
            hostNote: 'Gemeinsam lesen, dann reihum: erkennt ihr euren typischen Angebot-Stil?',
            description: 'Ein „Angebot zur Verbindung" ist alles, was einer der beiden tut, um Aufmerksamkeit oder Resonanz zu suchen. Es muss nicht ausgesprochen sein:',
            items: [
              { accent: '1.', label: 'Erzählen', text: '„Schau mal." „Weißt du, was heute passiert ist…" „Hör mal kurz." Klassisches verbales Angebot.' },
              { accent: '2.', label: 'Berühren', text: 'Eine Hand auf den Arm, ein Knie-Streifen beim Sitzen. Körperliches Angebot.' },
              { accent: '3.', label: 'Fragen', text: '„Hast du gut geschlafen?" „Hat das geklappt?" Aufmerksamkeitsabfrage.' },
              { accent: '4.', label: 'Seufzen / Lachen', text: 'Manchmal nur ein Laut — der prüft: hast du gemerkt, was gerade in mir war?' },
              { accent: '5.', label: 'Anschauen', text: 'Ein Blick. Ein längeres Hinschauen vom Sofa aus. Wortlos.' },
              { accent: '6.', label: 'Aufgaben-Verteilung', text: '„Hilfst du mir kurz?" Auch wenn pragmatisch — das Antwortverhalten ist ein Bindungssignal.' }
            ],
            teaser: 'Sechs Formen des Verbindungs-Angebots — alle messbar.' },
          { name: 'Antworten', title: 'Drei Antwort-Klassen', duration: 8*60,
            hostNote: 'Reihum. Erkennt ihr eure Standard-Antwort?',
            description: 'Auf jedes Angebot reagiert ihr — auch das Nicht-Reagieren ist eine Reaktion. Gottman unterscheidet drei Klassen:',
            items: [
              { accent: 'A.', label: 'Zuwenden', text: 'Aufschauen, kurz antworten, nicken, zustimmen. Auch minimale Aktivität zählt. Ein „Aha" reicht oft.' },
              { accent: 'B.', label: 'Abwenden', text: 'Ignorieren, nicht reagieren, mit dem Handy weitermachen. Häufigste Klasse in zerbrechenden Beziehungen.' },
              { accent: 'C.', label: 'Gegen-Drehen', text: 'Genervt reagieren („Jetzt nicht"), Sarkasmus, abwerten. Seltener als Abwenden, aber giftiger.' }
            ],
            question: 'In welche Klasse fällt deine Standard-Antwort auf Mikro-Angebote deiner Partner:in?' },
          { name: 'Beobachtungs-Übung', title: 'Eine Stunde Mikro-Inventar', duration: 12*60,
            hostNote: 'Zwei Minuten still. Dann reihum: erinnert euch an die letzte gemeinsame Stunde — gestern Abend oder heute morgen. Geht sie langsam durch. Welche Angebote habt ihr gesendet, welche habt ihr bekommen? Wie habt ihr reagiert? Sehr wichtige Regel: jede:r benennt nur eigene Angebote und eigene Reaktionen. Die andere Person nicht analysieren.',
            description: 'Die meisten Paare sind verblüfft, wenn sie das erste Mal eine ganz normale Alltagsstunde langsam durchgehen. Da waren plötzlich 8, 12, 20 kleine Angebote. Und ein Großteil wurde übersehen — nicht aus Bosheit, sondern aus Müdigkeit, Handy, Routine.',
            question: 'Welche Angebote von dir wurden in dieser Stunde nicht angenommen — und welche hast du selbst nicht angenommen?' },
          { name: 'Stille', title: 'Drei Minuten gemeinsam atmen', duration: 3*60,
            hostNote: 'Setzt euch gegenüber, Augen weich. Atmet im selben Rhythmus.',
            description: 'Auch das hier ist ein Angebot — und beide nehmen es an. Spürt, was das macht.' },
          { name: 'Mini-Praxen', title: 'Sechs Mikro-Übungen für die Woche', duration: 10*60,
            hostNote: 'Gemeinsam lesen. Wählt zu zweit zwei davon, die ihr diese Woche einübt.',
            description: 'Konkrete Übungen, die das Gefühlskonto in eurem Alltag aufstocken — alle aus Gottmans Workshops:',
            items: [
              { accent: '1.', label: 'Sechs-Sekunden-Kuss', text: 'Beim Verabschieden morgens, beim Wiedersehen abends — sechs Sekunden, nicht zwei. Lang genug, dass das Nervensystem es bemerkt.' },
              { accent: '2.', label: 'Sechs-Stunden-Regel', text: 'Gottmans empirischer Befund: Paare, die mindestens sechs Stunden pro Woche bewusst füreinander aufwenden — verteilt über die Tage —, bleiben verbunden. Aufteilbar in fünf Mini-Akte täglich.' },
              { accent: '3.', label: 'Tag-Briefing', text: 'Einmal täglich, fester Slot, 5 Minuten. Wie war dein Tag? Nicht „gut, und deiner?". Echte Antwort, echtes Zuhören.' },
              { accent: '4.', label: 'Stress-Reduktions-Gespräch', text: '20 Minuten am Abend, in denen ihr nicht über euch beide diskutiert, sondern jede:r über externen Stress — Arbeit, Familie, Welt — spricht. Die andere Person hört nur zu und tröstet. Stress importieren, nicht lösen.' },
              { accent: '5.', label: 'Abschieds-Ritual', text: 'Bevor ihr morgens auseinandergeht: kurz fragen, was heute ansteht. 30 Sekunden, jede:r ein Satz.' },
              { accent: '6.', label: 'Hand-auf-Schulter', text: 'Beim Vorbeigehen, wenn die andere Person am Schreibtisch sitzt: einmal kurz die Hand auf die Schulter. Wortlos.' }
            ],
            teaser: 'Sechs Übungen — wählt zwei für diese Woche.' },
          { name: 'Schritt', title: 'Die zwei für diese Woche', duration: 6*60,
            hostNote: 'Schreibt auf einen Zettel: welche zwei Mini-Übungen macht ihr ab morgen?',
            question: 'Welche zwei Mikro-Übungen übt ihr diese Woche bewusst ein?' },
          { name: 'Einladung', title: 'Wohin Abend 5 führt', duration: 4*60,
            hostNote: 'Vorlesen.',
            description: '→ Abend 5 — Einfluss zulassen. Hier wird es politisch: Macht teilen ist nicht „brav", es ist statistisch das stärkste Mittel gegen Trennung. Gottman fand: Ehemänner, die den Einfluss ihrer Frauen NICHT zulassen, scheitern zu 81 Prozent. Das gilt für alle Partner:innen aller Konstellationen — wer die Stimme der anderen Person nicht wirklich an sich heranlässt, verliert sie irgendwann.' },
          { name: 'Wort', title: 'Ein Wort', duration: 3*60,
            hostNote: 'Beide je ein Wort.',
            question: 'Ein Wort.' }
        ])
      ...
      solo: {
        ...
        stations: withFeedback([
          { name: 'Öffnen', title: 'Kurz ankommen', duration: 2*60,
            hostNote: 'Kerze, Notizbuch.',
            description: 'Auch allein machst du dir die Mikro-Bewegungen bewusst — sie laufen ja in deiner Wahrnehmung mit, ob du willst oder nicht.' },
          { name: 'Einstieg', title: '86 vs 33', duration: 4*60,
            hostNote: 'Lies zweimal.',
            quote: { text: 'In stabilen Ehen werden 86 Prozent der Verbindungs-Angebote angenommen. In geschiedenen nur 33.', author: 'John Gottman' },
            description: 'Heute schaust du genau hin: wo bist du selbst Angebot, wo Antwort — und wie sieht deine Bilanz aus?' },
          { name: 'Drei Klassen', title: 'Deine Standard-Antwort', duration: 6*60,
            hostNote: 'Schreibe ehrlich.',
            items: [
              { accent: 'A.', label: 'Zuwenden', text: 'aufschauen, kurz antworten, nicken' },
              { accent: 'B.', label: 'Abwenden', text: 'ignorieren, Handy, nicht reagieren' },
              { accent: 'C.', label: 'Gegen-Drehen', text: 'genervt, sarkastisch, abwerten' }
            ],
            question: 'In welche Klasse fällt deine Standard-Antwort — und in welche Klasse fällt deine Standard-Antwort, wenn du müde oder gestresst bist?' },
          { name: 'Inventar', title: 'Die letzte Stunde mit ihr oder ihm', duration: 10*60,
            hostNote: 'Schreibe 8 Min am Stück. Geh die letzte gemeinsame Stunde durch.',
            question: 'Welche Mini-Angebote sind in der letzten gemeinsamen Stunde an dich gegangen — und wie hast du jeweils reagiert?' },
          { name: 'Sieben-Stress', title: 'Wann wendet ihr euch ab?', duration: 6*60,
            hostNote: 'Schreibe.',
            question: 'In welcher Tageszeit oder Situation wendet ihr euch zuverlässig voneinander ab — und was wäre eine kleine Schutzmauer dagegen?' },
          { name: 'Sechs Übungen', title: 'Was du allein einüben kannst', duration: 8*60,
            hostNote: 'Lies. Markiere die zwei, die du diese Woche probierst.',
            description: 'Auch ohne deine Partner:in kannst du beginnen — das Angebot-Senden ist immer in deiner Macht:',
            items: [
              { accent: '1.', label: '6-Sekunden-Kuss', text: 'Beim Hallo und Tschüss, sechs statt zwei Sekunden.' },
              { accent: '2.', label: 'Tag-Briefing', text: 'Fester Slot, echte Antwort.' },
              { accent: '3.', label: 'Hand-auf-Schulter', text: 'Wortlos beim Vorbeigehen.' },
              { accent: '4.', label: 'Stress-Reduktions-Gespräch', text: '20 Minuten Zuhören ohne Lösungs-Drang.' },
              { accent: '5.', label: 'Abschieds-Ritual', text: '30 Sekunden vor dem Auseinandergehen.' },
              { accent: '6.', label: 'Aktive Antwort', text: '24 Stunden lang bewusst jedem Angebot zuwenden, auch dem kleinsten.' }
            ],
            question: 'Welche zwei probierst du diese Woche?' },
          { name: 'Ausblick', title: 'Abend 5', duration: 3*60,
            hostNote: 'Lies.',
            description: '→ Abend 5 — Einfluss zulassen. Die schwerste Übung der Reise: wirklich die Stimme der anderen Person an sich heranlassen.' },
          { name: 'Wort', title: 'Ein Wort', duration: 2*60,
            hostNote: 'Ein Wort.',
            question: 'Ein Wort.' }
        ])
  ...
  // =====================================================================
  // WIR-REISE · ABEND 5 — Einfluss zulassen (Geheimnis 4)
  // Macht teilen. 81% Statistik. Wenn du nicht beeinflussbar bist, verlierst du.
  // =====================================================================
  wir_reise_5: {
    title: 'Einfluss zulassen',
    subtitle: 'Wir-Reise · Abend 5 von 7',
    lead: 'Gottmans schärfste Statistik: Ehemänner, die ihre Frauen NICHT an sich heranlassen, scheitern zu 81 Prozent. Das ist nicht „nett sein müssen" — das ist Beziehungs-Physik. Wer die Stimme der anderen Person nicht wirklich an sich heranlässt, verliert sie irgendwann ganz. Heute schaut ihr ehrlich hin: wo lasst ihr Einfluss zu, wo blockt ihr ab.',
    category: 'Wir-Reise',
    image: 'images/wir-reise-5.jpg',
    reise: { id: 'wir', nr: 5, total: 7, titel: 'Wir-Reise — Sieben Abende nach Gottman' },
    philosophy1: 'Einfluss zulassen heißt nicht nachgeben. Es heißt: die Meinung der anderen Person ernsthaft in dein Entscheiden einbeziehen — als gleichwertig, nicht als Bittsteller-Stimme. Gottman fand: wer das tut, hat in den meisten Konflikten später eine bessere Lösung als der „Sieger" eines Machtkampfs. Beeinflussbarkeit ist keine Schwäche — sie ist Beziehungs-Intelligenz.',
    philosophy2: 'Dieses Geheimnis ist das schwerste. Es kratzt am Selbstbild — „ich bin doch flexibel". Heute prüft ihr ehrlich mit Gottmans Selbsttest, wo ihr blockt. Und ihr seht eine Hierarchie der Mauer: welcher der vier Reiter wird euer Standard-Tool, sobald die Stimme der anderen Person unbequem wird.',
    formats: {
      pair: {
        label: 'Zu zweit',
        duration: '~1 Std. 40 Min.',
        people: '2 Personen',
        stations: withFeedback([
          { name: 'Öffnen', title: 'Vorbereitung', duration: 3*60,
            hostNote: 'Kerze, Atem. Heute braucht das Nervensystem Reserve — das wird der ehrlichste Abend der Reise.',
            description: 'Einfluss zulassen ist das Geheimnis, das am stärksten am Selbstbild kratzt. Atmet vor.' },
          { name: 'Rückblende', title: 'Was Mikro-Übungen gemacht haben', duration: 6*60,
            hostNote: 'Beide je 3 Min.',
            question: 'Welche der beiden Mikro-Übungen aus letzter Woche hast du tatsächlich gemacht — und was ist passiert?' },
          { name: 'Einstieg', title: 'Die 81-Prozent-Zahl', duration: 7*60,
            hostNote: 'Vorlesen.',
            ...
            description: 'Gottman hat diese Zahl bei jungverheirateten Paaren in den ersten Ehemonaten gemessen. 81 Prozent ist keine Schätzung — es ist die direkt vorhergesagte Scheidungsrate für eine messbare Eigenschaft: Beeinflussbarkeit. Männer, die ihren Frauen die Tür zur Mit-Entscheidung verschließen, verlieren ihre Ehe mit dieser Wahrscheinlichkeit.\n\nDie Zahl gilt umgekehrt nicht so scharf — Frauen, die ihre Männer blockieren, gefährden die Ehe nicht so messbar, weil sie statistisch ohnehin meistens beeinflussbar sind. Aber das Prinzip ist gegenseitig: wer die Stimme der anderen Person nicht ernsthaft an sich heranlässt, verliert sie irgendwann ganz.',
            teaser: '81 % — die schärfste Zahl der Beziehungs-Forschung.' },
          { name: 'Selbsttest', title: 'Wie beeinflussbar bist du?', duration: 12*60,
            hostNote: 'Jede:r markiert für sich „trifft zu" oder „trifft nicht zu". Jedes „trifft nicht zu" gibt einen Punkt für Beeinflussbarkeit. Maximum: 13 Punkte. Unter 7 Punkten lohnt sich ein genauer Blick.',
            description: 'Gottmans Diagnostik. Antworte ehrlich — niemand außer dir hat Einblick.',
            items: [
              { accent: '1.', label: 'Schwarz-weiß', text: 'Wenn wir streiten, halte ich meine Position am Schluss meistens für klar richtig.' },
              { accent: '2.', label: 'Eskalation', text: 'Wenn sie mit Kritik kommt, antworte ich oft mit größerer Kritik zurück.' },
              { accent: '3.', label: 'Spott', text: 'Manchmal mache ich ihre Position lächerlich, ohne es zu wollen.' },
              ...
              { accent: '6.', label: 'Übersehen', text: 'Wenn sie einen guten Punkt macht, sage ich das selten zu Beginn.' },
              ...
              { accent: '10.', label: 'Pünktlichkeit', text: 'Wenn ihre Wünsche meinen Plan stören, halte ich meinen Plan.' },
              { accent: '11.', label: 'Verteidigen', text: 'Bei Beschwerde fange ich oft mit „aber" oder „du auch" an.' },
              { accent: '12.', label: 'Gefühl-Übersehen', text: 'Wenn sie traurig ist, suche ich oft sofort eine Lösung, statt zuzuhören.' },
          ...
          { name: 'Auswertung', title: 'Was die Zahl bedeutet', duration: 5*60,
            hostNote: 'Reihum: nennt eure Zahl ohne Erklärung. Kein Trösten, kein Verteidigen.',
            description: '11 bis 13 Punkte: solide beeinflussbar. Wahrscheinlich eine Quelle der Stabilität in eurer Beziehung.\n7 bis 10: durchwachsen. In Stress-Situationen klappt es weniger. Hier lohnt sich Übung.\nUnter 7: hier ist Material. Nicht „du bist schlecht" — du hast Muster, die in Stress-Momenten greifen, und sie kosten dich.',
            question: 'Welche Aussage hat dich beim Markieren am meisten zucken lassen?' },
          { name: 'Vier Reiter Reload', title: 'Welcher Reiter trägt deine Blockade?', duration: 10*60,
            hostNote: 'Reihum je 4 Min. Erinnere dich konkret an einen Moment der letzten zwei Wochen, in dem du nicht an dich herangelassen hast. Welcher Reiter war es?',
            description: 'Einfluss-Blockade hat fast immer einen der vier Reiter als Tool: Kritik macht die eigene Position klein, Verachtung macht die andere Person klein, Rechtfertigung erklärt alles weg, Mauern macht zu. Welcher ist dein Standard, wenn etwas zu nah kommt?',
          ...
          { name: 'Stille', title: 'Drei Minuten', duration: 3*60,
            hostNote: 'Kerze. Nichts erklären, nichts verteidigen.',
            description: 'Beeinflussbarkeit beginnt mit der Bereitschaft, eine Weile nicht zu antworten.' },
          { name: 'Drei Themen', title: 'Drei Bereiche, in denen du an dich heranlassen willst', duration: 14*60,
            hostNote: 'Beide schreiben für sich 5 Min: drei konkrete Bereiche, in denen ihr bisher nicht wirklich gleichberechtigt entscheidet — eure Stimme dominiert oder verstummt. Dann reihum je 4 Min — die andere Person hört nur zu und sagt am Schluss „Danke".',
            description: 'Es gibt in jeder Beziehung Bereiche, in denen eine:r der beiden faktisch entscheidet: Geld, Urlaubsplanung, Kindererziehung, Wohnungs-Einrichtung, sexuelle Initiative, Sozialkontakte. Wer die Macht in einem Bereich nicht teilt, gewinnt scheinbar — und verliert auf lange Sicht. Heute benennt ihr drei.',
            question: 'In welchen drei Bereichen lässt du Einfluss bisher kaum zu — und wo verstummt deine eigene Stimme?' },
          { name: 'Konkreter Pakt', title: 'Ein Pakt für die Woche', duration: 8*60,
            hostNote: 'Vereinbart zu zweit eine konkrete Entscheidung, die ihr diese Woche bewusst gemeinsam trefft — beide ehrlich mit Stimme. Schreibt sie auf einen Zettel.',
            description: 'Nicht „wir werden besser kommunizieren". Sondern zum Beispiel: „Sonntag, bei der Wochenend-Planung, hören wir beide einander 5 Min an, bevor wir entscheiden." Klein, konkret, überprüfbar.',
            question: 'Welche eine Entscheidung trefft ihr diese Woche bewusst zu zweit, mit Stimme von beiden?' },
          { name: 'Einladung', title: 'Wohin Abend 6 führt', duration: 4*60,
            hostNote: 'Vorlesen.',
            description: '→ Abend 6 — Konflikte: lösbar versus patt. Jetzt geht ihr an das, was im Alltag wirklich schwierig ist: streiten. Gottman hat in seinen Daten zwei Arten Streit entdeckt. Rund 69 Prozent aller Paar-Konflikte sind ewige Probleme — Pattsituationen, die nicht gelöst werden können, sondern nur gemanagt. Die restlichen 31 Prozent sind lösbar. Wer das nicht trennt, kämpft an der falschen Front. Dazu: Träume hinter Pattsituationen, die Goldader unter euren Dauer-Konflikten.' },
          { name: 'Wort', title: 'Ein Wort', duration: 3*60,
            hostNote: 'Beide je ein Wort.',
            question: 'Ein Wort.' }
        ])
      ...
      solo: {
        ...
        people: 'Nur du',
        stations: withFeedback([
          { name: 'Öffnen', title: 'Eine ehrliche Stunde', duration: 2*60,
            hostNote: 'Kerze, Notizbuch.',
            description: 'Heute prüfst du allein deine Beeinflussbarkeit. Niemand sieht dein Ergebnis — das macht es leichter, ehrlich zu sein.' },
          { name: 'Einstieg', title: '81 Prozent', duration: 4*60,
            hostNote: 'Lies zweimal.',
            quote: { text: 'Wer die Stimme der anderen Person nicht wirklich an sich heranlässt, verliert sie irgendwann.', author: 'John Gottman (sinngemäß)' },
            description: 'Heute prüfst du, wo bei dir Türen zu sind — und welcher der vier Reiter sie zumacht.' },
          { name: 'Selbsttest', title: 'Deine Beeinflussbarkeit', duration: 10*60,
            hostNote: 'Schreibe die Aussagen auf Papier und markiere ehrlich.',
            description: 'Acht Aussagen — jedes „trifft nicht zu" ist ein Punkt für Beeinflussbarkeit.',
            items: [
          ...
          { name: 'Reiter-Diagnose', title: 'Welcher Reiter trägt dich?', duration: 8*60,
            hostNote: 'Schreibe.',
            question: 'Erinnere dich konkret an einen Moment der letzten zwei Wochen, in dem du nicht an dich herangelassen hast — welcher der vier Reiter (Kritik, Verachtung, Rechtfertigung, Mauern) war dein Tool?' },
          { name: 'Drei Bereiche', title: 'Wo du nicht teilst', duration: 10*60,
            hostNote: 'Schreibe 8 Min am Stück.',
            question: 'In welchen drei Bereichen eurer Beziehung lässt du Einfluss bisher kaum zu — und wo verstummt umgekehrt deine eigene Stimme?' },
          { name: 'Geste', title: 'Eine konkrete Geste für die Woche', duration: 5*60,
            hostNote: 'Schreibe einen einzigen Satz.',
            question: 'Welche eine konkrete Geste in deinem Alltag macht diese Woche sichtbar, dass du die Stimme der anderen Person wirklich einlässt?' },
          { name: 'Ausblick', title: 'Abend 6', duration: 3*60,
            hostNote: 'Lies.',
            description: '→ Abend 6 — Konflikte: lösbar oder ewig. Die zwei Arten Streit, und wie ihr sie unterscheidet.' },
          { name: 'Wort', title: 'Ein Wort', duration: 3*60,
            hostNote: 'Ein Wort, Zettel, Tasche.',
            question: 'Ein Wort.' }
        ])
  ...
  // =====================================================================
  // WIR-REISE · ABEND 6 — Konflikte (Geheimnisse 5+6)
  // Lösbare Probleme + Pattsituationen + Träume hinter Konflikten.
  // =====================================================================
  wir_reise_6: {
    title: 'Konflikte: lösbar und ewig',
    subtitle: 'Wir-Reise · Abend 6 von 7',
    lead: '69 Prozent aller Paar-Konflikte sind nicht lösbar — sie sind ewige Probleme, in denen ihr lernt zu leben. Die anderen 31 Prozent sind lösbar, brauchen aber Werkzeug. Gottmans schärfste Diagnose: wer beide Typen für lösbar hält, kämpft sich tot. Wer beide für unlösbar hält, gibt zu früh auf. Heute lernt ihr zu trennen und in beiden zu navigieren.',
    category: 'Wir-Reise',
    image: 'images/wir-reise-6.jpg',
    reise: { id: 'wir', nr: 6, total: 7, titel: 'Wir-Reise — Sieben Abende nach Gottman' },
    philosophy1: 'Gottman hat 130 Paare über sieben Jahre beobachtet. Bei allen fand er: die ewigen Probleme sind dieselben — Punkt 1 nach fünf Jahren ist Punkt 1 nach zwölf Jahren. „Sie wollte mehr zusammen sein, er wollte mehr Zeit allein" — das ändert sich nicht. Was sich ändert, ist, wie das Paar damit umgeht. Glückliche Paare lachen darüber. Unglückliche zerreiben sich.',
    philosophy2: 'Hinter jeder Pattsituation steht ein Traum. Sie will jeden Sonntag essen gehen — das ist ein Traum von Familie, der bis in die Kindheit reicht. Er will sonntags kochen — auch ein Traum, aus seiner Kindheit. Wenn der Konflikt nur an der Oberfläche bleibt — „Restaurant oder Küche?" —, kommt ihr nicht raus. Wenn ihr die Träume freilegt, wird der Streit zur Brücke.',
    formats: {
      pair: {
        label: 'Zu zweit',
        duration: '~2 Std.',
        people: '2 Personen',
        stations: withFeedback([
          { name: 'Öffnen', title: 'Heute der intensivste Abend', duration: 3*60,
            hostNote: 'Kerze, Atem. Mehr als sonst.',
            description: 'Abend 6 ist der intensivste. Ihr werdet eine echte eigene Streit-Situation durchgehen. Atmet vor.' },
          { name: 'Rückblende', title: 'Was Einfluss-zulassen gemacht hat', duration: 7*60,
            hostNote: 'Beide je 3 Min.',
            question: 'Was hat der Pakt aus Abend 5 mit euch gemacht — wo ist die Tür ein Stück offener?' },
          { name: 'Einstieg', title: 'Zwei Arten Streit', duration: 8*60,
            hostNote: 'Vorlesen.',
            quote: { text: '69 Prozent aller Konflikte zwischen Paaren sind ewige Probleme. Sie sind nicht zu lösen. Sie sind zu leben.', author: 'John Gottman' },
            description: 'Gottmans schärfste Einsicht: Konflikte teilen sich in zwei klare Klassen.\n\nLösbare Probleme — die 31 Prozent: konkret, situativ, ohne tiefere persönliche Wurzel. „Wer ruft die Schwiegermutter an?" „Wer macht heute den Müll?" Diese kann man mit Methode wirklich lösen.\n\nEwige Probleme — die 69 Prozent: tiefer verwurzelt in Persönlichkeit, Werten, Lebensträumen. „Wir wollen unterschiedlich oft Sex." „Du willst Stadt, ich Land." „Du willst Kinder, ich nicht." Diese kann man NICHT lösen. Man kann sie nur konstruktiv leben.\n\nDer fatale Fehler: ein ewiges Problem wie ein lösbares behandeln. Da kämpft man sich tot. Heute lernt ihr beide Wege.',
            teaser: 'Lösbar oder ewig — der erste Schritt jedes Konflikts ist die Diagnose.' },
          { name: 'Lösbar Schritt 1', title: 'Der sanfte Auftakt', duration: 10*60,
            hostNote: 'Vorlesen.',
            description: 'Gottman hat untersucht, was in den ersten drei Minuten eines Streits passiert — und mit hoher Genauigkeit das Ende vorhergesagt. Der Schlüssel ist der Auftakt.\n\nGrober Auftakt: „Du bist so ein Egoist." „Du hörst NIE zu." „Wieder mal hast du..." Vier-Reiter-Energie ab Sekunde eins.\n\nSanfter Auftakt: „Ich war heute traurig, als…" „Mir würde es helfen, wenn…" „Ich brauche dich gerade für..." Ich-Botschaft, konkret, ohne Charakter-Attacke.\n\nGottmans Daten: nach grobem Auftakt endet der Streit fast immer negativ — egal was danach passiert. Nach sanftem Auftakt geht es deutlich häufiger gut aus.',
            items: [
              { accent: '✗', label: 'Grober Auftakt', text: '„Du machst immer..."  „Wieder mal hast du..." „Du hörst NIE zu."' },
              { accent: '✓', label: 'Sanfter Auftakt', text: '„Ich fühle mich..." „Mir geht es schlecht, wenn..." „Ich brauche..." Ich-Botschaft, ohne „du".' }
            ],
            teaser: 'Die ersten drei Minuten entscheiden.' },
          { name: 'Lösbar Schritt 2-5', title: 'Vier weitere Schritte für Lösbares', duration: 12*60,
            hostNote: 'Vorlesen.',
            description: 'Gottmans 5-Schritt-Modell für lösbare Probleme. Die ersten drei sind im Streit selbst, die letzten zwei danach:',
            items: [
              { accent: '1.', label: 'Sanfter Auftakt', text: 'Siehe oben.' },
              { accent: '2.', label: 'Reparatur-Versuche annehmen', text: 'Mitten im Streit macht eine:r von euch ein Repair: Humor, Berührung, „Du hast recht damit". Das ist Gold — wenn ihr es bemerkt und annehmt.' },
              { accent: '3.', label: 'Selbst-Beruhigung', text: 'Bei Überflutung: Pause vereinbaren. Mindestens 20 Minuten, in denen ihr NICHT übers Thema redet. Atmet, geht spazieren, hört Musik. Dann wieder rein.' },
              { accent: '4.', label: 'Kompromiss finden', text: 'Beide schreiben für sich: Was darf nicht verhandelt werden? Was ist flexibel? Tauscht aus. Der Kompromiss liegt da, wo sich beide Flexibel-Listen treffen.' },
              { accent: '5.', label: 'Schwächen tolerieren', text: 'Wer die Verschrobenheit der anderen Person NICHT akzeptiert, kann nichts wirklich lösen. Ihr verhandelt nicht „wer hat recht", sondern „wie machen WIR das?".' }
            ],
            teaser: 'Fünf Schritte für die 31 Prozent der Konflikte, die wirklich lösbar sind.' },
          { name: 'Lebensszene', title: 'Eine echte eigene Szene durchgehen', duration: 18*60,
            hostNote: 'Wählt gemeinsam eine konkrete lösbare Konflikt-Situation aus den letzten Wochen — eine mittlere, nicht die schwerste. Dann geht ihr sie durch das 5-Schritt-Modell. Wie wäre der sanfte Auftakt gewesen? Wo wären Repair-Möglichkeiten gewesen? Wo der Kompromiss?',
            description: 'Theorie ist leicht. Das eigene Beispiel durch das Modell laufen zu lassen, ist die Übung. Achtet darauf: heute IST das nicht der Streit, heute ist es Analyse. Wenn dabei doch Emotionen hochkommen, atmet und macht ruhig weiter.',
            question: 'Wie hätte die Szene mit Gottmans 5-Schritt-Modell anders laufen können?' },
          { name: 'Stille', title: 'Drei Minuten', duration: 3*60,
            hostNote: 'Kerze. Nichts sagen.',
            description: 'Lösbare Probleme sind Handwerk. Was jetzt kommt, ist Tiefe.' },
          { name: 'Ewig', title: 'Die Träume hinter Pattsituationen', duration: 10*60,
            hostNote: 'Vorlesen.',
            description: 'Pattsituationen — die 69 Prozent — sind nie nur an der Oberfläche. Hinter jeder steht ein Traum auf beiden Seiten. Gottman hat eine Liste typischer Träume, die Paare in Konflikten verteidigen, ohne sie zu kennen:\n\nFreiheit · Frieden · Einheit mit der Natur · Abenteuer · Spiritualität · Gerechtigkeit · Ehre · Verbindung zur Vergangenheit · Heilung · Familie kennen · Macht erleben · mit Alter umgehen · Kreativität · alte Verletzungen überwinden · Kompetenz · Vergebung · einen verlorenen Teil zurückholen · Ordnung · Produktivität · einfach sein können · entspannen · Bilanz ziehen · Prioritäten setzen · etwas Wichtiges abschließen · Körperlichkeit ausleben · kämpfen und siegen · reisen · Stille · Buße tun · etwas Bedeutendes bauen · Abschied nehmen.\n\nWenn ihr in einem Dauer-Konflikt steckt: hinter eurem Streit liegt mindestens einer dieser Träume von jeder Seite.',
            teaser: '32 Träume — welche liegen unter euren Dauer-Konflikten?' },
          { name: 'Eigene Patt', title: 'Eure ewige Streit-Frage', duration: 15*60,
            hostNote: 'Wählt einen Konflikt, der zwischen euch seit Monaten oder Jahren immer wiederkehrt. Beide schreiben 5 Min für sich: Welcher Traum von mir verteidigt sich in diesem Konflikt? Aus welcher Geschichte kommt er? Was wäre der Preis, wenn ich ihn aufgäbe? Dann reihum je 5 Min vorlesen — nicht diskutieren, nur zuhören.',
            description: 'Das ist die wahrscheinlich wichtigste Übung der ganzen Reise. Wenn ihr versteht, welche Träume in einer Pattsituation auf beiden Seiten ringen, könnt ihr den Streit zwar nicht „lösen" — aber respektieren. Und respektierte Pattsituationen verlieren ihre Schärfe.',
            question: 'Welcher Traum von dir verteidigt sich in eurer ewigen Streit-Frage — und woher kommt er?' },
          { name: 'Einladung', title: 'Wohin Abend 7 führt', duration: 5*60,
            hostNote: 'Vorlesen.',
            description: '→ Abend 7 — Gemeinsamer Sinn. Die Krönung. Wenn ihr die ersten sechs Geheimnisse beherrscht, ist eure Beziehung stabil. Aber: ist das alles? Gottman fand: viele stabile Ehen fühlen sich nach Jahren leer an — „wir leben gut nebeneinander, aber wir sind keine Familie". Gemeinsamer Sinn ist die kulturelle Schicht der Beziehung — eure Mythen, Symbole, Rituale, Rollen, Ziele. Heute baut ihr eure eigene Kultur.' },
          { name: 'Wort', title: 'Ein Wort', duration: 4*60,
            hostNote: 'Beide je ein Wort.',
            question: 'Ein Wort.' }
        ])
      },
      solo: {
        ...
        people: 'Nur du',
        stations: withFeedback([
          { name: 'Öffnen', title: 'Ein ehrlicher Blick', duration: 2*60,
            hostNote: 'Kerze, Notizbuch.',
            description: 'Heute schaust du ehrlich auf eure Streit-Muster.' },
          { name: 'Einstieg', title: 'Zwei Arten Streit', duration: 5*60,
            hostNote: 'Lies zweimal.',
            quote: { text: '69 Prozent aller Konflikte zwischen Paaren sind ewige Probleme. Nur 31 Prozent sind wirklich lösbar.', author: 'John Gottman' },
            description: 'Den Unterschied zu kennen, ist der erste Schritt. Wer ewige Probleme wie lösbare behandelt, zerreibt sich.' },
          { name: 'Eigene Liste', title: 'Lösbar oder ewig?', duration: 10*60,
            hostNote: 'Schreibe zwei Spalten. Links: lösbare Konflikte zwischen euch. Rechts: ewige.',
            description: 'Lösbare sind situativ-konkret. Ewige sind tiefer verwurzelt — Werte, Persönlichkeit, Träume.',
            question: 'Welche eurer Konflikte sind ehrlich lösbar — welche ewig? Schreib je drei.' },
          { name: 'Sanfter Auftakt', title: 'Wie du beginnst', duration: 8*60,
            hostNote: 'Schreibe.',
            question: 'Welcher deiner letzten zwei Streits hatte einen groben Auftakt — und wie hätte ein sanfter Auftakt geklungen? Also etwa: „Du machst immer..." wird zu „Ich brauche..."' },
          { name: 'Träume', title: 'Welcher Traum liegt unter eurem Dauer-Streit?', duration: 12*60,
            hostNote: 'Schreibe 10 Min. Erinnere an einen Konflikt, der seit Monaten oder Jahren immer wiederkommt.',
            description: '32 Träume nach Gottman — Freiheit, Frieden, Familie kennen, Heilung, Kreativität, Stille, Produktivität, Abenteuer, Spiritualität, Macht erleben, alte Verletzungen überwinden, mit Alter umgehen, Kompetenz, Ordnung, Bedeutendes bauen, Abschied nehmen…',
            question: 'Welcher Traum von dir steckt unter dem Konflikt — und welchen Traum vermutest du bei der anderen Person?' },
          { name: 'Fünf Schritte', title: 'Dein Lösbar-Werkzeug', duration: 8*60,
            hostNote: 'Lies und markiere.',
            description: 'Gottmans fünf Schritte für lösbare Konflikte.',
            items: [
              { accent: '1.', label: 'Sanfter Auftakt', text: 'Ich-Botschaft.' },
              { accent: '2.', label: 'Repair', text: 'Mitten im Streit kleine Reparatur.' },
              { accent: '3.', label: 'Selbst-Beruhigung', text: 'Bei Überflutung: Pause mindestens 20 Minuten.' },
              { accent: '4.', label: 'Kompromiss', text: 'Was ist nicht verhandelbar, was flexibel?' },
              { accent: '5.', label: 'Schwächen tolerieren', text: 'Nicht ändern, akzeptieren.' }
            ],
            question: 'Welcher der fünf fällt dir am leichtesten? Welcher am schwersten?' },
          { name: 'Ausblick', title: 'Abend 7', duration: 3*60,
            hostNote: 'Lies.',
            description: '→ Abend 7 — Gemeinsamer Sinn. Die kulturelle Schicht: eure Mythen, Symbole, Rituale, Rollen. Das, was eure Beziehung zu eurer macht.' },
          { name: 'Wort', title: 'Ein Wort', duration: 3*60,
            hostNote: 'Ein Wort.',
            question: 'Ein Wort.' }
        ])
  ...
  // =====================================================================
  // WIR-REISE · ABEND 7 — Gemeinsamer Sinn (Geheimnis 7)
  // Kultur, Rituale, Rollen, Ziele, Symbole.
  // =====================================================================
  wir_reise_7: {
    title: 'Gemeinsamer Sinn',
    subtitle: 'Wir-Reise · Abend 7 von 7 · Abschluss',
    lead: 'Wenn ihr die ersten sechs Geheimnisse beherrscht, ist eure Beziehung stabil. Aber Gottman fand: viele stabile Ehen fühlen sich nach Jahren leer an — „wir leben gut nebeneinander". Was fehlt, ist gemeinsamer Sinn — die kulturelle Schicht der Beziehung. Heute baut ihr eure eigene Kultur: Rituale, Rollen, Ziele, Symbole. Und ihr feiert den Abschluss der Reise.',
    category: 'Wir-Reise',
    image: 'images/wir-reise-7.jpg',
    reise: { id: 'wir', nr: 7, total: 7, titel: 'Wir-Reise — Sieben Abende nach Gottman' },
    philosophy1: 'Jedes Paar ist eine eigene Mikro-Kultur. Wie eine ethnische Kultur hat sie Bräuche — sonntags wird gemeinsam gekocht. Rituale — vor jedem Abschied umarmen. Symbole — ein bestimmter Ring, eine Geschichte. Und Mythen — die Erzählung darüber, wer „wir" sind. Wer diese Kultur aktiv pflegt, hat eine Beziehung mit Tiefe — nicht nur Stabilität.',
    philosophy2: 'Gottman: ein entscheidendes Ziel der Ehe ist, eine Atmosphäre zu schaffen, in der jede:r ehrlich über seine/ihre Überzeugungen sprechen kann. Je häufiger ihr freundlich und respektvoll miteinander redet, desto wahrscheinlicher nähern sich eure Vorstellungen von Sinnhaftigkeit an. Ihr werdet keine identischen Werte teilen — aber ihr werdet eine gemeinsame Sprache für sie haben.',
    formats: {
      pair: {
        label: 'Zu zweit',
        duration: '~1 Std. 50 Min.',
        ...
        stations: withFeedback([
          { name: 'Öffnen', title: 'Letzter Abend', duration: 3*60,
            hostNote: 'Kerze, ganz bewusst heute. Drei Atemzüge zusammen.',
            description: 'Sieben Abende. Heute schließt der Bogen. Erst die Arbeit, dann die Würdigung.' },
          { name: 'Rückblende', title: 'Die ganze Reise in einem Bild', duration: 12*60,
            hostNote: 'Beide schreiben 4 Min zu der Frage: Wenn die ganze Reise von Abend 1 bis heute ein Bild wäre — was wäre es? Dann reihum je 2 Min vorlesen. Kurz, nicht zu interpretieren versuchen.',
            question: 'Wenn die Wir-Reise ein Bild wäre — welches Bild?' },
          { name: 'Einstieg', title: 'Was Kultur ist', duration: 7*60,
            hostNote: 'Vorlesen.',
            quote: { text: 'Jedes Paar und jede Familie ist eine eigene Mikrokultur. Sie hat ihre Sitten, Rituale, Symbole und Mythen — die Geschichten, die ihr euch übereinander erzählt.', author: 'John Gottman' },
            description: 'Sechs Geheimnisse machen eine Beziehung stabil. Das siebte macht sie tief. Kultur entsteht durch das, was ihr aktiv pflegt: kleine Rituale, geteilte Geschichten, gemeinsame Rollen, klare Ziele. Heute schaut ihr, was bei euch wächst — und was ihr gärtnern wollt.',
            teaser: 'Sechs Geheimnisse für Stabilität. Das siebte für Tiefe.' },
          { name: 'Rituale', title: 'Eure Rituale heute', duration: 12*60,
            hostNote: 'Beide schreiben für sich 5 Min: Welche kleinen Rituale habt ihr schon — bewusst oder unbewusst? Dann reihum vorlesen.',
            description: 'Rituale sind die Mikro-Architektur eurer Kultur. Sie können winzig sein:\n\n• Wie ihr morgens grüßt — Berührung, Wort, Stille?\n• Wie ihr Abschied nehmt\n• Was beim Abendessen passiert\n• Wie ihr Geburtstage feiert\n• Wie ihr nach Streit zurückkommt\n• Wie ihr Sonntage gestaltet\n• Wie ihr Erfolge feiert\n• Wie ihr Krisen begleitet\n\nManche dieser Rituale habt ihr aus eurer Herkunft mitgebracht, manche selbst entwickelt, manche fehlen.',
            question: 'Welche drei kleinen Rituale tragen eure Beziehung gerade — und welches eine Ritual fehlt euch?' },
          { name: 'Symbole', title: 'Was steht für „wir"?', duration: 10*60,
            hostNote: 'Gemeinsam.',
            description: 'Symbole verdichten Sinn. Was symbolisiert für euch eure Beziehung?',
            items: [
              { accent: '1.', label: 'Ein Foto', text: 'Welches Foto würdet ihr nehmen, um „uns" jemandem zu zeigen, der euch nicht kennt?' },
              { accent: '2.', label: 'Ein Gegenstand', text: 'Welcher Gegenstand in eurer Wohnung trägt am meisten Bedeutung für euer „Wir"?' },
              { accent: '3.', label: 'Ein Ort', text: 'Welcher Ort fühlt sich an wie nur eurer?' },
              { accent: '4.', label: 'Ein Lied', text: 'Gibt es ein Lied, das nur euch gehört?' },
              { accent: '5.', label: 'Eine Geschichte', text: 'Welche Anekdote erzählt ihr beide am liebsten, wenn jemand nach euch fragt?' }
            ],
            question: 'Welche zwei dieser Symbole sind bei euch schon stark — und welches eine könntet ihr aktiv gestalten?' },
          { name: 'Rollen', title: 'Wer ihr füreinander seid', duration: 10*60,
            hostNote: 'Reihum, je 4 Min.',
            description: 'In einer Beziehung übernehmt ihr viele Rollen: Partner:in, Freund:in, Verbündete:r, Eltern (sofern Kinder), Ko-Pilot:in im Alltag, manchmal Lehrer:in, manchmal Schüler:in, Tröster:in, Ratgeber:in, Bewunderer:in. Welche Rollen sind klar, welche schwierig?',
            question: 'Welche drei Rollen übernimmst du in unserer Beziehung mit Freude — und welche eine fühlt sich gerade nicht passend an?' },
          { name: 'Ziele', title: 'Eure gemeinsamen Ziele', duration: 10*60,
            hostNote: 'Beide schreiben 4 Min. Reihum austauschen.',
            description: 'Ziele können konkret sein — ein bestimmtes Haus, ein Kind, eine Reise — oder abstrakt: sich sicher fühlen, Abenteuer leben, Würde im Alter. Wichtig ist nicht, dass ihr alle teilt — wichtig ist, dass ihr eure jeweils kennt und respektiert.',
            question: 'Welche drei eurer Ziele teilt ihr — und welche zwei sind individuell, brauchen aber gegenseitige Unterstützung?' },
          { name: 'Stille', title: 'Drei Minuten Atem', duration: 3*60,
            hostNote: 'Hand auf Hand, Augen weich.',
            description: 'Eine letzte Stille auf dieser Reise. Lasst sie.' },
          { name: 'Kreis-Vertrag', title: 'Drei Vereinbarungen, die euch tragen', duration: 14*60,
            hostNote: 'Gemeinsam. Schreibt drei konkrete Vereinbarungen auf Papier, die ab heute eure Kultur tragen. Klein, konkret, einlösbar.',
            description: 'Nicht „wir wollen liebevoll sein". Sondern zum Beispiel: „Jeden Sonntag 30 Minuten Wir-Zeit mit Kaffee und ohne Handy." Oder: „Bei Streit machen wir immer einen sanften Auftakt, auch wenn es schwer ist." Oder: „Einmal im Monat ein langes Gespräch über das, was zwischen uns passiert ist."\n\nSchreibt sie auf einen Zettel, beide unterschreiben symbolisch, an die Wand oder in eine Schublade.',
            items: [
              { accent: '1.', label: 'Vereinbarung 1', text: 'Was machen wir wiederholbar, das uns trägt?' },
              { accent: '2.', label: 'Vereinbarung 2', text: 'Wie gehen wir miteinander um, wenn es schwer wird?' },
              { accent: '3.', label: 'Vereinbarung 3', text: 'Wann nehmen wir uns Zeit für Bilanz?' }
            ],
            question: 'Welche drei kleinen, konkreten Vereinbarungen schreibt ihr heute auf?' },
          { name: 'Dank', title: 'Was ich von dir mitnehme', duration: 10*60,
            hostNote: 'Beide je 4 Min. Beginnt mit dem Satz: „Was ich in diesen sieben Abenden über dich gelernt habe, das ich vorher nicht wusste, ist…" Die andere Person sagt am Ende nur „Danke", nichts mehr.',
            description: 'Eine Reise endet mit Anerkennung. Was hat die andere Person in dir bewegt, geöffnet, verändert?',
            question: 'Was hast du in sieben Abenden über deine:n Partner:in gelernt, das du vorher nicht wusstest?' },
          { name: 'Segen', title: 'Ein Wort für die nächste Phase', duration: 5*60,
            hostNote: 'Beide je ein Wort oder kurzer Satz — als Segen an die Beziehung, nicht an euch selbst.',
            description: 'Der Abschluss. Ein Wort, mit dem ihr eure Beziehung in die nächste Phase entlasst.',
            question: 'Ein Wort oder Satz, mit dem du eure Beziehung von hier weiterschickst.' }
        ])
      },
      solo: {
        label: 'Allein',
        ...
        stations: withFeedback([
          { name: 'Öffnen', title: 'Der letzte Abend', duration: 2*60,
            hostNote: 'Kerze, Notizbuch — bewusst heute.',
            description: 'Sieben Abende, die du allein mit dir gegangen bist. Heute fügst du zusammen.' },
          { name: 'Rückblende', title: 'Die Reise in einem Bild', duration: 6*60,
            hostNote: 'Schreibe 4 Min.',
            question: 'Wenn die ganze Wir-Reise ein Bild wäre — welches Bild?' },
          { name: 'Einstieg', title: 'Kultur', duration: 4*60,
            hostNote: 'Lies zweimal.',
            quote: { text: 'Jedes Paar ist eine eigene Mikrokultur.', author: 'John Gottman' },
            description: 'Sechs Geheimnisse machen Stabilität. Das siebte macht Tiefe.' },
          { name: 'Eure Rituale', title: 'Was schon trägt', duration: 8*60,
            hostNote: 'Schreibe.',
            question: 'Welche drei kleinen Rituale eurer Beziehung tragen sie schon — bewusst oder unbewusst?' },
          { name: 'Was fehlt', title: 'Welches Ritual fehlt euch', duration: 6*60,
            hostNote: 'Schreibe.',
            question: 'Welches eine Ritual würde eurer Beziehung guttun, das ihr noch nicht habt?' },
          { name: 'Symbole', title: 'Was für euch steht', duration: 8*60,
            hostNote: 'Schreibe.',
            question: 'Welche Symbole — ein Foto, ein Gegenstand, ein Ort, ein Lied, eine Geschichte — sind heute schon eure?' },
          { name: 'Zugesagter Schritt', title: 'Was du beitragen wirst', duration: 8*60,
            hostNote: 'Schreibe konkret.',
            question: 'Welche eine konkrete kleine Sache trägst du ab morgen zu eurer Kultur bei — etwas, das ihr noch nicht habt, oder etwas, das du selbst nicht mehr gepflegt hast?' },
          { name: 'Stille', title: 'Drei Minuten', duration: 3*60,
            hostNote: 'Kerze, Augen zu.',
            description: 'Die letzte Stille auf dieser Reise.' },
          { name: 'Dank', title: 'Ein Brief an dich selbst', duration: 6*60,
            hostNote: 'Schreibe einen Dank-Brief an dich selbst dafür, dass du sieben Abende investiert hast.',
            description: 'Du hast dir selbst sieben Abende geschenkt. Dafür darfst du dir danken.',
            question: 'Was hast du dir selbst in sieben Abenden gegeben?' },
          { name: 'Segen', title: 'Ein Wort für die nächste Phase', duration: 4*60,
            hostNote: 'Ein Wort. An die Beziehung, an dich selbst, an die nächste Phase.',
            description: 'Der Abschluss-Segen an dein zukünftiges Wir.',
            question: 'Ein Wort.' }
        ])
      }
    }
