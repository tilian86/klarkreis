...
,
  ...
  wir_reise_2: {
    ...
    lead: 'Im biblischen Sinne hieß sexuelle Liebe „erkennen". Gottman dreht das um: wer den anderen nicht wirklich kennt, kann ihn nicht wirklich lieben. Heute aktualisiert ihr eure innere Karte voneinander. Mit Gottmans 20-Fragen-Spiel, einem Wissens-Test und den fünf Fragen, die das Selbstbild jedes Menschen prägen.',
    category: 'Wir-Reise',
      ...
      pair: {
        ...
        stations: withFeedback([
          ...
          { name: 'Selbsttest', title: 'Wie genau ist deine Karte?', duration: 12*60,
            ...
            description: 'Gottmans Original-Diagnose-Liste, deutsch. 20 Aussagen — wie viele kannst du ehrlich mit „wahr" beantworten?',
            items: [
              ...
              { accent: '3.', label: 'Schwierige Menschen', text: 'Ich kenne die Namen von Menschen, mit denen sie/er gerade Reibung hat.' },
              { accent: '4.', label: 'Lebensträume', text: 'Ich kann mindestens drei Lebensträume meines Partners benennen.' },
              { accent: '5.', label: 'Glaube/Spiritualität', text: 'Ich kenne die religiösen oder spirituellen Überzeugungen meines Partners.' },
              { accent: '6.', label: 'Lebensphilosophie', text: 'Ich kann die Grundphilosophie meines Partners formulieren.' },
              { accent: '7.', label: 'Verwandte', text: 'Ich weiß, welche Verwandten sie/er am wenigsten mag.' },
              { accent: '8.', label: 'Lieblingsmusik', text: 'Ich weiß, welche Musik sie/er gerade am liebsten hört.' },
              { accent: '9.', label: 'Drei Filme', text: 'Ich kann die drei Lieblingsfilme meines Partners nennen.' },
              { accent: '10.', label: 'Aktueller Stress', text: 'Mein Partner kennt die Probleme, mit denen ICH gerade konfrontiert bin.' },
              { accent: '11.', label: 'Lebensphasen', text: 'Ich kenne drei der wichtigsten Phasen im Leben meines Partners.' },
              { accent: '12.', label: 'Kindheits-Schwerpunkt', text: 'Ich kann das schwerwiegendste Ereignis seiner/ihrer Kindheit benennen.' },
              { accent: '13.', label: 'Wichtige Hoffnungen', text: 'Ich kann die wichtigsten Hoffnungen für ihr/sein Leben aufzählen.' },
              { accent: '14.', label: 'Aktuelle Ängste', text: 'Ich kenne die Ängste, die meinen Partner gerade nachts wach halten.' },
              { accent: '15.', label: 'Freunde-Welt', text: 'Mein Partner kennt meine Freund:innen.' },
              { accent: '16.', label: 'Lotto-Test', text: 'Ich weiß, was sie/er tun würde, wenn sie/er morgen plötzlich Lotto gewinnen würde.' },
              { accent: '17.', label: 'Erster Eindruck', text: 'Ich kann den ersten Eindruck, den ich von ihr/ihm hatte, präzise schildern.' },
              { accent: '18.', label: 'Aktive Neugier', text: 'Ich frage regelmäßig nach ihren/seinen Vorstellungen und Erfahrungen.' },
              { accent: '19.', label: 'Gekannt-Werden', text: 'Ich habe das Gefühl, sie/er kennt mich ziemlich gut.' },
              { accent: '20.', label: 'Wunsch-Vertrautheit', text: 'Mein Partner ist mit meinen Wünschen und Hoffnungen vertraut.' }
            ],
          ...
          { name: 'Das Spiel', title: 'Gottmans 20-Fragen-Spiel', duration: 25*60,
            ...
            description: 'Wählt zufällig je 10 Fragen aus dieser 60er-Liste — die Punkte in Klammern werten, wie tief die Frage geht. Spielt zu zweit. Eure Karte aktualisiert sich, während ihr spielt.',
            items: [
          ...
          { name: 'Fünf Fragen', title: 'Wer du werden willst', duration: 18*60,
            ...
            description: 'Gottman nennt das die fünf Fragen, die das Selbstbild eines Menschen ausmachen. Wer die Antworten seines Partners nicht weiß, kennt seinen Partner nicht — nur die Außenseite. Heute legt ihr die fünf nebeneinander.',
            items: [
      ...
      solo: {
        ...
        stations: withFeedback([
          ...
          { name: 'Selbsttest', title: 'Wie genau ist deine Karte?', duration: 10*60,
            ...
            description: 'Gottmans Diagnose-Liste. 20 Aussagen über dein Wissen vom Innen-Leben deines Partners.',
            items: [
              { accent: '1.', label: 'Beste Freund:innen', text: 'Ich kann die besten Freund:innen meines Partners namentlich nennen.' },
              { accent: '2.', label: 'Aktuelle Probleme', text: 'Ich weiß, mit welchen drei Problemen sie/er gerade konfrontiert ist.' },
          ...
          { name: 'Fünf Fragen', title: 'Wer SIE oder ER werden will', duration: 10*60,
            ...
            description: 'Gottmans fünf Selbstbild-Fragen. Beantworte sie aus der Sicht deines Partners. Die Fragezeichen sind die wertvollste Information.',
            items: [
