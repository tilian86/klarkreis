...
,
      ...
      group: {
        ...
        stations: withFeedback([
          ...
          { name: "Konflikt",
            ...
            duration: 900,
            hostNote: "Jede:r wählt aus den eigenen Karten zwei Werte, die im Wertekreis weit auseinanderliegen (z.B. Sicherheit und Selbstbestimmung, Loyalität und Gerechtigkeit). 4 Min still: Konstruiere eine konkrete Situation aus deinem echten Leben, in der du nur einem der beiden folgen kannst. Dann reihum je 2 Min: die Situation, die Entscheidung, der Preis. Kein Trostpflaster von den anderen.",
      ...
      pair: {
        ...
        stations: withFeedback([
          ...
          { name: "Wertekreis",
            ...
            description: "Zehn Werte-Familien, die sich überall auf der Welt wiederfinden — angeordnet in einem Kreis. Zwei Achsen: Offenheit (Selbstbestimmung, Stimulation) gegen Bewahrung (Sicherheit, Konformität, Tradition); Selbst-Erhöhung (Leistung, Macht) gegen Selbst-Überwindung (Benevolenz, Universalismus). Benachbarte Werte vertragen sich, gegenüberliegende reiben sich. Wo ihr im Kreis weit auseinanderliegt, wird später der interessanteste Teil.",
            items: [
          ...
          { name: "Zwei Ebenen",
            ...
            description: "Unterscheide Zielwerte (Endzustände: „ein erfülltes Leben“, „Gerechtigkeit in meiner Nähe“) von Stilwerten (Haltungen: „mutig“, „ehrlich“, „verspielt“). Achtung bei Paaren: Ihr könnt denselben Zielwert teilen und trotzdem streiten — weil der Stil, wie ihr ihn erreichen wollt, verschieden ist." },
          { name: "Sortieren",
            title: "Wertekarten legen",
            duration: 900,
      ...
      solo: {
        ...
        stations: withFeedback([
          ...
          { name: "Wertekreis",
            ...
            description: "Die zehn Werte-Familien liegen in einem Kreis: Offenheit gegen Bewahrung, Selbst-Erhöhung gegen Selbst-Überwindung. Benachbarte vertragen sich, gegenüberliegende reiben sich. Wenn deine drei stärksten Werte weit auseinanderliegen, trägst du eine eingebaute Spannung — das ist normal, aber gut zu wissen.",
            items: [
      ...
      group: {
        ...
        stations: withFeedback([
          ...
          { name: "Rückblende",
            ...
            description: "Letzte Woche habt ihr euren Werten Namen gegeben — die zehn Werte-Familien und die Unterscheidung zwischen Ziel- und Stilwerten. Bevor wir heute fragen, woher diese Werte stammen, kurz zurück in die Woche.",
          ...
          { name: "Familienklima",
            ...
            duration: 720,
            hostNote: "Jede:r nimmt sich 4 Min still zum Erinnern — am besten mit geschlossenen Augen an einem konkreten Ort: dem Küchentisch, dem Wohnzimmer, dem Sonntag. Dann reihum je 3 Min erzählen. Die anderen hören nur zu. „Pass“ ist ausdrücklich in Ordnung.",
      ...
      pair: {
        ...
        stations: withFeedback([
          ...
          { name: "Familienklima",
            title: "Was heilig war, worüber gestritten wurde",
            duration: 660,
            hostNote: "Beide je 4 Min still erinnern — am besten an einem konkreten Ort: Küchentisch, Sonntag, Wohnzimmer. Dann je 4 Min erzählen, die andere Person hört nur zu. „Pass“ ist ausdrücklich in Ordnung.",
      ...
      solo: {
        ...
        stations: withFeedback([
          ...
          { name: "Generation/Milieu",
            ...
            description: "Zwei Schichten von außen: die Werte deiner Jugend (etwa zwischen 10 und 25) tragen ein Leben lang — Sicherheit, Selbstbestimmung, Leistung, Offenheit, je nach Zeit. Dazu kommt das Milieu: Was dir wie Natur vorkommt, ist oft die Kultur deiner Herkunft — ob über Geld geredet wurde, ob Bildung Selbstzweck war, ob man laut oder leise stritt.",
      ...
      pair: {
        ...
        stations: withFeedback([
          ...
          { name: "Rückblick",
            ...
            description: "Letzte Woche habt ihr die Vier Reiter kennengelernt — Kritik, Verachtung, Rechtfertigung, Mauern. Der Punkt ist nicht, dass ein Reiter nie wieder auftaucht. Der Wendepunkt ist, dass ihr ihn kommen seht, bevor er losreitet. Genau das erzählt ihr euch jetzt — von euch selbst, nicht voneinander.",
          ...
          { name: "Selbsttest",
            ...
            description: "Diese 20-Aussagen-Liste ist an Gottmans Liebeslandkarten-Fragebogen angelehnt. Geht sie ehrlich durch — „wahr“ nur, wenn ihr es wirklich könntet, nicht wenn ihr es raten würdet.\n\nDie Faustregel: zehn oder mehr Wahr-Treffer heißt, das Grundgerüst steht. Weniger heißt nicht Versagen — es heißt, der Alltag hat die Aktualisierung verschluckt. Genau dafür ist der heutige Abend da.",
            items: [
          ...
          { name: "Das Spiel",
            ...
            duration: 1440,
            hostNote: "Jede:r schreibt zufällig 10 Zahlen zwischen 1 und 60 auf einen Zettel. In der Liste unten findet ihr die zugehörigen Fragen und stellt sie der Partner:in. Antwortet sie und ihr als Fragesteller:in urteilt „korrekt“, bekommt sie einen Punkt. Bei „falsch“ erzählt ihr kurz die echte Antwort — genau da wächst die Karte. Nach jeder Frage wechseln. Lacht ruhig. Fragen, die sich gerade nicht gut anfühlen, überspringt ihr ohne Begründung. Es geht nicht ums Gewinnen.",
      ...
      solo: {
        ...
        stations: withFeedback([
          ...
          { name: "Eigene Bilanz",
            ...
            question: "Was würde deine Partner:in über dich vermuten, das schlicht nicht mehr stimmt?" },
          { name: "Drei Fragen",
      ...
      pair: {
        ...
        stations: withFeedback([
          ...
          { name: "Selbsttest",
            ...
            description: "Diese Liste ist an Gottmans Fondness-and-Admiration-Fragebogen angelehnt. Sie misst keine Fakten, sondern die Temperatur eurer Brille — wie viel Wärme, Stolz und Anziehung gerade lebendig sind. Die Faustregel: Wer die Hälfte oder mehr mit „ja“ beantwortet, steht auf gutem Grund. Weniger heißt nicht, dass die Liebe weg ist — meist heißt es nur, dass der Alltag die Wärme zugedeckt hat. Genau die legt der Abend wieder frei.",
            items: [
          ...
          { name: "Geschichte",
            ...
            description: "Gottman und seine Kolleg:innen entwickelten das „Oral History Interview“ — ein Gespräch über die eigene Beziehungsgeschichte. Aus der Art, WIE ein Paar seine Anfänge erzählt, lässt sich viel über seinen Zustand ablesen. Nicht die Fakten zählen, sondern der Ton: Erzählt ihr euch mit Wärme und Detail — oder ist die Geschichte flach und ein wenig bitter geworden? Das Erzählen selbst dreht die Brille zurück ins Warme.",
          ...
          { name: "Überstanden",
            ...
            description: "In diesen Gesprächen zeigt sich immer wieder ein Muster, das er das „Loben der Mühsal“ nennt: Stabile Paare blicken auf schwere Zeiten mit einer Art Stolz zurück — „das war hart, aber wir haben es zusammen geschafft“. Instabile Paare erinnern dieselben Zeiten als Beweis, dass es noch nie richtig lief. Dieselbe Vergangenheit, zwei Erzählungen. Welche ihr wählt, formt eure Gegenwart mit.",
      ...
      solo: {
        ...
        stations: withFeedback([
          ...
          { name: "Einstieg",
            ...
            description: "Gottman hat Paare über Jahre begleitet. Der Unterschied lag nicht im Streit, sondern im Alltäglichsten: ob man aufschaut, wenn der andere „schau mal\“ sagt. Heute schaust du auf deine eigene Bilanz — wo bist du Angebot, wo Antwort." },
          { name: "Antworten",
            title: "Zuwenden, Abwenden, Gegen-Drehen",
            duration: 360,
      ...
      pair: {
        ...
        stations: withFeedback([
          ...
          { name: "Einstieg",
            ...
            description: "Gottman hat diese Zahl an frisch verheirateten Paaren in den ersten Ehejahren gemessen. Es ist keine Schätzung, sondern die vorhergesagte Scheidungsrate für ein messbares Verhalten: ob jemand bereit ist, Macht wirklich zu teilen. 81 Prozent ist hart. Aber lest sie richtig — es ist ein Durchschnitt, kein Schicksal, und sie zeigt in Gottmans Daten deshalb auf die Männer, weil die Frauen dort fast durchweg schon Einfluss zuließen. Für euch heute zählt nicht das Etikett, sondern die Frage darunter, die für jede Konstellation gilt: Lasst ihr die Stimme der anderen wirklich an euch heran — oder nur zum Schein?",
          ...
          { name: "Selbsttest",
            ...
            description: "Ein ehrlicher Selbst-Check, an eure Realität angelegt. Antworte ehrlich — niemand außer dir hat Einblick, das ist der ganze Sinn.",
            items: [
      ...
      solo: {
        ...
        stations: withFeedback([
          ...
          { name: "Einstieg",
            ...
            hostNote: "Lies langsam, zweimal.",
            quote: { text: "Wenn ein Mann nicht willens ist, die Macht mit seiner Partnerin zu teilen, beträgt die Wahrscheinlichkeit, dass seine Ehe scheitert, 81 Prozent.", author: "John Gottman" },
            description: "Gottman hat diese Zahl an frisch verheirateten Paaren gemessen — eine vorhergesagte Scheidungsrate für ein messbares Verhalten: Macht teilen oder nicht. Sie zeigt auf die Männer, weil in seinen Daten die Frauen fast durchweg schon Einfluss zuließen. Für dich heute zählt die Frage darunter, egal in welcher Konstellation: Lässt du die Stimme der anderen Person wirklich an dich heran — oder nur zum Schein?" },
          { name: "Zwei Versionen",
            title: "Dieselbe Szene, zweimal",
            duration: 360,
      ...
      pair: {
        ...
        stations: withFeedback([
          ...
          { name: "Interview",
            ...
            duration: 960,
            hostNote: "Wählt EINEN Dauerstreit, der seit Monaten oder Jahren wiederkehrt — nicht euren wundesten Punkt. Jede Frage darf ohne Begründung ausgelassen werden. Einer ist zuerst dran und erzählt seine Seite — der andere ist NUR Fragensteller und Zuhörer, verteidigt nichts, korrigiert nichts. Nutzt die Fragen unten. Nach etwa acht Minuten tauscht ihr die Rollen.",
      ...
      solo: {
        ...
        stations: withFeedback([
          ...
          { name: "Dein Auftakt",
            ...
            duration: 480,
            hostNote: "Schreibe.",
            description: "Am Auftakt eines Streits entscheidet sich meist schon sein Ausgang. Grob heißt: „du“, „immer/nie“, ein Angriff auf den Charakter. Sanft heißt: „ich“, ein konkreter Moment, ein Bedürfnis, eine Bitte. Die Beschwerde bleibt — nur die Tür ändert sich.",
      ...
      pair: {
        ...
        stations: withFeedback([
          ...
          { name: "Sechs Stunden",
            ...
            description: "Gottman hat Paare, die trotz voller Leben verbunden bleiben, gefragt, was sie konkret anders machen. Es waren im Schnitt sechs Stunden pro Woche — verteilt in kleinen Portionen. Er nennt sie die „Magischen Sechs Stunden“ — ihr kennt sie aus Abend 4. Heute prüft ihr, was davon bei euch angekommen ist. Kein Programm, eher eine Landkarte, auf der ihr seht, wo bei euch Lücken sind:",
            items: [
  ...
  frei_reise_2: {
    ...
    formats: {
      pair: {
        label: "Zu zweit", duration: "~1 Std. 45 Min.", people: "2 Personen",
        stations: withFeedback([
          { name: "Öffnen", title: "Ein Moment, bevor ihr anfangt", duration: 180,
            hostNote: "Handys weg. Drei gemeinsame Atemzüge. Heute fallen ein paar Sätze, die unangenehm sind — vereinbart vorher, dass niemand sie persönlich nimmt.",
            description: "Dieser Abend lebt davon, dass ihr euch etwas sagt, was ihr euch sonst nicht sagt. Das geht nur, wenn vorher klar ist: Es ist ein Wetterbericht, kein Urteil.",
            teaser: "Vereinbart, dass nichts persönlich gemeint ist." },
          { name: "Ankommen", title: "Womit kommst du an?", duration: 480,
            hostNote: "Beide nacheinander, je vier Minuten. Nur zuhören.",
            question: "Womit kommst du heute hier an — und welche Überzeugung hast du eigentlich nie geprüft, sondern einfach übernommen?",
            description: "Politisch, beruflich, familiär. Es gibt bei jedem eine Position, die man vertritt, ohne sie jemals durchgerechnet zu haben. Sucht nicht die peinlichste — sucht die, bei der euch das Prüfen bisher zu teuer war.",
            teaser: "Die Überzeugung, die du nie geprüft hast." },
          { name: "Einstieg", title: "Klar denken schlägt intelligent", duration: 480,
            hostNote: "Eine:r liest vor.",
            description: "Intelligenz ist schnell. Klarheit ist langsam. Wer klar denkt, arbeitet sich bis zu einem Punkt vor, an dem er nichts mehr auswendig braucht, weil er alles Weitere ableiten kann.\n\nDie Gegenprobe ist ernüchternd: Fachwörter sind oft ein Signal für Zugehörigkeit, nicht für Verständnis. Wer viele davon benutzt, signalisiert Insider-Wissen — und verdeckt manchmal, dass die Grundlagen fehlen. Heute prüft ihr das aneinander, nicht theoretisch.",
            teaser: "Fachwörter sind oft Zugehörigkeit, nicht Verständnis." },
          { name: "Modell", title: "Was den Blick auf die Realität verstellt", duration: 420,
            hostNote: "Vorlesen. Danach ordnet jede:r für sich ein: welcher der vier ist bei mir gerade am stärksten?",
            description: "Vier Dinge stehen zwischen euch und dem, was tatsächlich der Fall ist. Keines davon ist Dummheit.",
            items: [
              { accent: "1.", label: "Der Wunsch", text: "Je stärker du willst, dass etwas funktioniert, desto unwahrscheinlicher siehst du die Anzeichen dagegen." },
              { accent: "2.", label: "Das Ego", text: "Es will nicht die Wahrheit, es will recht gehabt haben. Je kleiner es ist, desto klarer der Blick." },
              { accent: "3.", label: "Die Identität", text: "Wer sich über ein Etikett definiert, muss dessen Positionen mitverteidigen — auch die undurchdachten." },
              { accent: "4.", label: "Die Geschäftigkeit", text: "Ohne freie Tage entstehen keine Gedanken. Gute Ideen kommen erst nach der Langeweile." }
            ],
            teaser: "Vier Dinge zwischen dir und der Wirklichkeit." },
          { name: "Das Paket", title: "Was hast du selbst durchdacht?", duration: 720,
            hostNote: "Beide nacheinander. Die andere Person stellt genau eine Nachfrage: „Kannst du die Gegenposition formulieren?“",
            description: "Nehmt eure Überzeugung von vorhin. Und dann die Probe, die weh tut: Formuliert die Gegenposition so gut, dass jemand, der sie vertritt, zustimmen würde.\n\nWenn das nicht geht, habt ihr keine Position — ihr habt eine Zugehörigkeit. Das ist kein Vorwurf, es ist bei allen so, und zwar bei den meisten Themen. Interessant wird es erst da, wo ihr merkt, dass ihr etwas verteidigt, das ihr nie gewählt habt.",
            question: "Kannst du die Gegenposition zu deiner Überzeugung so formulieren, dass ihre Vertreter zustimmen würden?",
            teaser: "Wenn du die Gegenposition nicht formulieren kannst, hast du keine." },
          { name: "Der Schmerzpunkt", title: "Wo schiebst du die Realität vor dir her?", duration: 720,
            hostNote: "Beide nacheinander. Keine Lösungsvorschläge — nur Nachfragen. Das ist heute die schwerste Regel.",
            description: "Es gibt bei fast jedem eine Sache, bei der er die Anzeichen kennt und nicht hinsieht: ein Projekt, das nicht funktioniert, eine Beziehung, eine Zahl, ein gesundheitliches Signal.\n\nDas Nützliche daran: Der Moment, in dem es weh tut, ist der Moment, in dem die Realität durchkommt. Von dort aus kann man arbeiten. Von einer geschönten Lage aus nicht.\n\nErstaunlich ist immer, wie gut man dieselbe Sache bei anderen sofort sieht. Nutzt das — ihr sitzt gerade zu zweit.",
            question: "Bei welcher wichtigen Sache kennst du die Anzeichen und schaust nicht hin?",
            teaser: "Was du bei anderen sofort siehst und bei dir nicht." },
          { name: "Haken", title: "Der Einwand: Identität ablegen ist ein Luxus", duration: 420,
            hostNote: "Vorlesen. Danach: Wo widersprecht ihr?",
            description: "Der Rat, sich von Etiketten zu lösen, klingt souverän und lässt etwas aus: Er ist leichter, wenn man niemanden mehr braucht. Wer Geld, Ruf und ein Netzwerk hat, kann sich Unabhängigkeit von jedem Stamm leisten. Wer beruflich, familiär oder finanziell auf eine Gruppe angewiesen ist, zahlt für dieselbe Freiheit einen ganz anderen Preis.\n\nZugehörigkeit ist auch nicht nur Denkfaulheit. Sie ist Bindung, Verlässlichkeit und Schutz. Und radikale Ehrlichkeit kostet Menschen mit weniger Macht mehr als Menschen mit viel.\n\nNehmt also die Prüffrage mit — habe ich das selbst durchdacht? — und nicht die Aufforderung, alles abzulegen.",
            teaser: "Unabhängigkeit vom Stamm kann man sich leisten oder nicht." },
          { name: "Stille", title: "Drei Minuten Atem", duration: 180,
            hostNote: "Timer. Nicht reden.",
            description: "Drei Minuten nichts. Der nächste Teil ist der praktische, und er fällt leichter mit leerem Kopf.",
            teaser: "Drei Minuten nichts." },
          { name: "Der Zehnjährige", title: "Erklär mir, was du tust", duration: 840,
            hostNote: "Beide nacheinander, je fünf Minuten erklären. Die andere Person spielt konsequent den Zehnjährigen: fragt bei jedem Fachwort nach.",
            description: "Erklärt einander, was ihr beruflich tut — so, dass ein Zehnjähriger es versteht. Keine Branchenbegriffe, keine Abkürzungen, keine Rollenbezeichnungen.\n\nWer ins Stolpern gerät, hat eine Stelle gefunden, an der er selbst nicht durchdringt. Das ist der eigentliche Ertrag dieser Station, nicht die gelungene Erklärung.\n\nDanach dieselbe Übung mit etwas, das ihr zuletzt gelesen oder gehört habt und für klug hielt. Erstaunlich oft bleibt dabei nichts übrig — und das sagt etwas über die Quelle, nicht über euch.",
            teaser: "Wer stolpert, hat es nicht verstanden." },
          { name: "Abbrechen", title: "Das Buch, das seit Monaten herumliegt", duration: 600,
            hostNote: "Jede:r entscheidet heute, laut und verbindlich.",
            description: "Die Zahl der zu Ende gelesenen Bücher ist eine Eitelkeitskennzahl. Man liest, bis der Kern da ist, und legt dann weg — ohne schlechtes Gewissen. Das ist eine erlernbare Fähigkeit, und die Schule hat sie den meisten gründlich abtrainiert.\n\nUnd die zweite Hälfte: Das Fundament entscheidet. Wer bei Originalen und Grundlagen anfängt statt bei Zusammenfassungen von Zusammenfassungen, bewertet alles Neue an etwas Solidem statt an Halbwahrheiten.\n\nWelches Buch liegt bei euch seit über drei Monaten angefangen herum? Entscheidet jetzt: weiterlesen oder weglegen. Und dann die ehrliche Frage: Was von dem, was ihr lest, lest ihr für Anerkennung?",
            question: "Würdest du das noch lesen, wenn du es niemandem erzählen dürftest?",
            teaser: "Bücher zu Ende zu lesen ist eine Schulregel." },
          { name: "Denk-Tag", title: "Wo steht er im Kalender?", duration: 300,
            hostNote: "Beide holen jetzt das Telefon heraus — einmal ist es erlaubt — und tragen den Termin ein.",
            description: "Ohne freie Zeit entstehen keine Gedanken. Nicht ein freier Abend nach zwölf Stunden, sondern ein Tag oder ein halber, an dem nichts ansteht.\n\nDie Beobachtung dahinter: Große Ideen kommen nicht unter Druck, sie kommen nach der Langeweile. Wer nie Langeweile zulässt, kommt nie in die Nähe.\n\nTragt es jetzt ein, beide, mit Datum. Ein Vorsatz ohne Kalendereintrag ist keiner.",
            teaser: "Ideen kommen erst nach der Langeweile." },
          { name: "Schritt", title: "Eine Sache in dieser Woche", duration: 420,
            hostNote: "Beide legen sich laut fest. Abend 3 beginnt damit.",
            description: "Ein halber Tag ohne Termine, ohne Bildschirm, mit Papier. Kein Ziel, kein Ergebnisdruck, keine To-do-Liste.\n\nErledigt ist es, wenn er stattgefunden hat — nicht, wenn etwas dabei herauskam. Das ist wichtig: Wer ein Ergebnis erwartet, hat sich wieder Arbeit gemacht.",
            teaser: "Ein halber Tag ohne Bildschirm. Ohne Ziel." },
          { name: "Wort", title: "Ein Wort, mit dem ihr geht", duration: 240,
            hostNote: "Reihum, ohne Erklärung.",
            description: "Ein Wort für das, was hängen bleibt. Es darf unbequem sein.",
            teaser: "Ein Wort, keine Erklärung." }
        ])
      },
      solo: {
        label: "Allein", duration: "~1 Std.", people: "Nur du",
        stations: withFeedback([
          { name: "Öffnen", title: "Ein Moment für dich", duration: 120,
            description: "Telefon weg, Papier bereit. Heute schreibst du mehr, als du denkst.",
            teaser: "Papier bereit." },
          { name: "Ankommen", title: "Womit kommst du an?", duration: 240,
            question: "Welche Überzeugung hast du nie geprüft, sondern übernommen, weil sie dazugehörte?",
            description: "Politisch, beruflich, familiär. Nicht die peinlichste — die, bei der dir das Prüfen bisher zu teuer war.",
            teaser: "Die Überzeugung, die du nie geprüft hast." },
          { name: "Einstieg", title: "Klar denken schlägt intelligent", duration: 240,
            description: "Intelligenz ist schnell, Klarheit ist langsam. Wer klar denkt, arbeitet sich zu einem Punkt vor, an dem er nichts auswendig braucht, weil er alles Weitere ableiten kann.\n\nFachwörter signalisieren oft Zugehörigkeit, nicht Verständnis — manchmal verdecken sie, dass die Grundlagen fehlen.",
            teaser: "Fachwörter sind oft Zugehörigkeit." },
          { name: "Modell", title: "Was den Blick auf die Realität verstellt", duration: 300,
            description: "Vier Dinge stehen zwischen dir und dem, was der Fall ist. Keines davon ist Dummheit. Ordne für dich ein, welches gerade am stärksten wirkt.",
            items: [
              { accent: "1.", label: "Der Wunsch", text: "Je stärker du willst, dass etwas funktioniert, desto weniger siehst du die Anzeichen dagegen." },
              { accent: "2.", label: "Das Ego", text: "Es will nicht die Wahrheit, es will recht gehabt haben." },
              { accent: "3.", label: "Die Identität", text: "Wer sich über ein Etikett definiert, verteidigt auch dessen undurchdachte Positionen." },
              { accent: "4.", label: "Die Geschäftigkeit", text: "Ohne freie Zeit entstehen keine Gedanken." }
            ],
            teaser: "Vier Dinge zwischen dir und der Wirklichkeit." },
          { name: "Das Paket", title: "Was hast du selbst durchdacht?", duration: 480,
            question: "Kannst du die Gegenposition zu deiner Überzeugung so formulieren, dass ihre Vertreter zustimmen würden?",
            description: "Nimm deine Überzeugung von vorhin und schreib die Gegenposition auf — so gut, dass jemand, der sie vertritt, zustimmen würde.\n\nWenn das nicht geht, hast du keine Position, sondern eine Zugehörigkeit. Das ist bei allen so und bei den meisten Themen. Interessant wird es da, wo du merkst, dass du etwas verteidigst, das du nie gewählt hast.",
            teaser: "Wenn du die Gegenposition nicht formulieren kannst, hast du keine." },
          { name: "Der Schmerzpunkt", title: "Wo schiebst du die Realität vor dir her?", duration: 360,
            question: "Bei welcher wichtigen Sache kennst du die Anzeichen und schaust nicht hin?",
            description: "Ein Projekt, eine Beziehung, eine Zahl, ein körperliches Signal. Es gibt bei fast jedem eine Sache.\n\nDas Nützliche: Der Moment, in dem es weh tut, ist der Moment, in dem die Realität durchkommt. Von dort kann man arbeiten, von einer geschönten Lage nicht.\n\nHilfsfrage, wenn es nicht kommt: Was würdest du einem Freund in genau deiner Lage sagen? Die Antwort hast du sofort — bei dir selbst nicht.",
            teaser: "Was du einem Freund sofort sagen würdest." },
          { name: "Haken", title: "Der Einwand: Identität ablegen ist ein Luxus", duration: 240,
            description: "Der Rat, sich von Etiketten zu lösen, ist leichter, wenn man niemanden braucht. Wer Geld, Ruf und Netzwerk hat, kann sich Unabhängigkeit von jedem Stamm leisten — wer beruflich oder familiär auf eine Gruppe angewiesen ist, zahlt einen anderen Preis.\n\nZugehörigkeit ist außerdem nicht nur Denkfaulheit, sondern Bindung und Schutz. Nimm die Prüffrage mit, nicht die Aufforderung, alles abzulegen.",
            teaser: "Unabhängigkeit kann man sich leisten oder nicht." },
          { name: "Der Zehnjährige", title: "Erklär es einem Kind", duration: 480,
            description: "Schreib in einfachen Worten auf, was du beruflich tust — so, dass ein Zehnjähriger es versteht. Keine Fachbegriffe, keine Abkürzungen, keine Rollenbezeichnung.\n\nWo du stolperst, hast du eine Stelle gefunden, an der du selbst nicht durchdringst. Das ist der Ertrag, nicht der gelungene Text.\n\nDanach dasselbe mit etwas, das du zuletzt gelesen und für klug gehalten hast. Oft bleibt nichts übrig — und das sagt etwas über die Quelle.",
            teaser: "Wo du stolperst, hast du es nicht verstanden." },
          { name: "Abbrechen", title: "Das Buch, das herumliegt", duration: 360,
            question: "Würdest du das noch lesen, wenn du es niemandem erzählen dürftest?",
            description: "Die Zahl der zu Ende gelesenen Bücher ist eine Eitelkeitskennzahl. Lies, bis der Kern da ist, dann leg weg. Die Schule hat den meisten das Gegenteil antrainiert.\n\nWelches Buch liegt bei dir seit über drei Monaten angefangen herum? Entscheide jetzt: weiterlesen oder weglegen.",
            teaser: "Bücher zu Ende zu lesen ist eine Schulregel." },
          { name: "Ausblick", title: "Was der nächste Abend bringt", duration: 180,
            description: "Abend 3 nimmt die Entscheidung, die du gerade vor dir herschiebst — und zwei Regeln, die sie kleiner machen. Eine davon ist überraschend brutal: Wenn du dich nicht entscheiden kannst, ist die Antwort Nein.\n\nAußerdem: Ohne freie Zeit entstehen keine Gedanken. Trag jetzt einen halben Denk-Tag in den Kalender ein, mit Datum.",
            teaser: "Erst der Kalendereintrag, dann der Vorsatz." },
          { name: "Schritt", title: "Eine Sache in dieser Woche", duration: 180,
            description: "Ein halber Tag ohne Termine, ohne Bildschirm, mit Papier. Kein Ziel.\n\nErledigt ist es, wenn er stattgefunden hat — nicht, wenn etwas dabei herauskam.",
            teaser: "Ein halber Tag ohne Bildschirm." },
          { name: "Wort", title: "Ein Wort als Anker", duration: 120,
            description: "Ein Wort für das, was bleibt. Ins Notizbuch, unter das von Abend 1.",
            teaser: "Ein Wort, aufgeschrieben." }
        ])
      }
    }
  ...
  frei_reise_3: {
    ...
    formats: {
      pair: {
        ...
        stations: withFeedback([
          { name: "Öffnen", title: "Ein Moment, bevor ihr anfangt", duration: 180,
            hostNote: "Handys weg, drei Atemzüge. Heute wird etwas entschieden — sagt das laut, damit es niemand vergisst.",
            description: "Dieser Abend hat ein Ergebnis. Am Ende sagt jeder von euch etwas ab, das seit Wochen offen ist. Wer das jetzt schon abwehren will, hat den Abend verstanden.",
            teaser: "Heute wird tatsächlich entschieden." },
          { name: "Ankommen", title: "Was schiebst du vor dir her?", duration: 480,
            hostNote: "Beide nacheinander, je vier Minuten. Nur zuhören, nicht raten.",
            question: "Welche Entscheidung schiebst du gerade vor dir her — und seit wann genau?",
            description: "Nennt das Datum, ab dem es offen ist, so gut ihr es könnt. Die Dauer ist die eigentliche Information: Was seit drei Tagen offen ist, ist eine Entscheidung. Was seit acht Monaten offen ist, ist eine Gewohnheit.",
            teaser: "Seit wann genau ist es offen?" },
          { name: "Einstieg", title: "Richtung schlägt Geschwindigkeit", duration: 480,
            hostNote: "Vorlesen.",
            description: "Harte Arbeit ist überschätzt, wenn die Richtung nicht stimmt. Wer in die falsche Richtung sprintet, kommt schneller falsch an.\n\nDas klingt nach einer Ausrede für Faulheit und ist keine: Ohne Arbeit entsteht auch keine Urteilskraft, weil Urteilskraft aus Erfahrung kommt. Aber zwischen zwei gleich fleißigen Menschen entscheidet nicht das Tempo, sondern die Trefferquote — und die kann man trainieren.\n\nHeute geht es um genau dieses Training, an einem echten Fall.",
            teaser: "Wer falsch läuft, kommt schneller falsch an." },
          { name: "Modell", title: "Vier Werkzeuge", duration: 420,
            hostNote: "Vorlesen. Danach: welches fehlt euch bisher?",
            description: "Keines davon ist eine Formel. Es sind Abkürzungen, die verhindern, dass man dieselben Fehler in neuer Verpackung wiederholt.",
            items: [
              { accent: "1.", label: "Die Nein-Regel", text: "Wenn du dich nicht entscheiden kannst, ist die Antwort Nein. Es gibt genug Optionen — sag nur Ja, wenn du ziemlich sicher bist." },
              { accent: "2.", label: "Bergauf", text: "Bei zwei gleichwertigen Wegen nimm den, der kurzfristig wehtut. Der andere schiebt den Schmerz nur nach hinten." },
              { accent: "3.", label: "Inversion", text: "Frag nicht, was funktionieren könnte. Frag, was garantiert scheitert — und lass das weg." },
              { accent: "4.", label: "Prinzipal oder Agent", text: "Wer trägt am Ende das Ergebnis? Wer es nicht trägt, entscheidet anders. Immer." }
            ],
            teaser: "Vier Abkürzungen gegen alte Fehler." },
          { name: "Der Fall", title: "Die geschobene Entscheidung, ernsthaft", duration: 720,
            hostNote: "Zehn Minuten pro Person. Die fragende Person fragt AUSSCHLIESSLICH — keine Meinung, kein Rat, keine Lösung. Das ist unangenehm und der ganze Punkt.",
            description: "Nehmt die Entscheidung des anderen vor. Die erste Frage ist immer dieselbe und meistens die entscheidende:\n\nIst Nichtstun hier eine echte Option — oder ist es heimlich längst die Entscheidung?\n\nBei optionalen Chancen heißt Zögern schlicht Nein, und man darf es aussprechen und weitergehen. Bei Gesundheit, alternden Eltern oder einer Beziehung, die Arbeit bräuchte, heißt Zögern etwas anderes: Ja zum Schlechteren, nur langsamer. Diese beiden Fälle zu verwechseln ist der häufigste Fehler an dieser Stelle.",
            question: "Ist Nichtstun hier eine echte Option oder heimlich längst die Entscheidung?",
            teaser: "Zögern ist manchmal Nein und manchmal Ja zum Schlechteren." },
          { name: "Inversion", title: "Wie es garantiert scheitert", duration: 720,
            hostNote: "Zuerst jede:r fünf Minuten allein schreiben, dann vorlesen und vergleichen.",
            description: "Nehmt euer wichtigstes laufendes Vorhaben — nicht die geschobene Entscheidung, sondern das, woran ihr gerade arbeitet.\n\nUnd dann dreht die Frage um: Was müsste passieren, damit es mit Sicherheit scheitert? Fünf Punkte, konkret, keine Allgemeinplätze wie „zu wenig Disziplin“.\n\nDas ist erstaunlich viel leichter zu beantworten als die Frage nach dem Erfolg — und praktisch nützlicher. Erfolg hat viele Wege, Scheitern hat wenige und wiederkehrende. Wer die wenigen ausschließt, gewinnt oft schon dadurch.",
            teaser: "Scheitern hat weniger Wege als Erfolg." },
          { name: "Haken", title: "Der Einwand: wo die Nein-Regel versagt", duration: 420,
            hostNote: "Vorlesen. Danach: Trifft einer dieser Fälle auf euch zu?",
            description: "„Wenn du dich nicht entscheiden kannst, ist die Antwort Nein“ ist stark bei Chancen, die man auch liegen lassen kann. Sie ist gefährlich überall dort, wo Nichtstun selbst eine Entscheidung ist — bei Gesundheit, bei Menschen, die älter werden, bei einer Beziehung, die Pflege bräuchte. Dort produziert die Regel genau das Ergebnis, vor dem sie schützen sollte.\n\nUnd „nimm den schmerzhafteren Weg“ lässt sich hervorragend in Selbstbestrafung umbauen. Die Regel gilt nur, wenn beide Wege wirklich gleichwertig sind. Wo einer klar besser ist und nur unbequemer klingt, ist Schmerz kein Wegweiser, sondern nur Schmerz.\n\nWer beide Regeln ohne diese Einschränkung übernimmt, trifft nicht bessere Entscheidungen, sondern härtere.",
            teaser: "Wo Nichtstun entscheidet, versagt die Nein-Regel." },
          { name: "Stille", title: "Drei Minuten Atem", duration: 180,
            hostNote: "Timer. Nicht reden.",
            description: "Drei Minuten nichts, bevor es an den Teil geht, in dem ihr euch festlegt.",
            teaser: "Drei Minuten nichts." },
          { name: "Prinzipal", title: "Wer trägt das Ergebnis?", duration: 840,
            hostNote: "Beide nacheinander. Nachfragen erlaubt, Rat nicht.",
            description: "Wer ein Ergebnis selbst trägt, entscheidet anders als jemand, der es weitergibt. Das ist keine Charakterfrage, sondern eine Anreizfrage — und sie gilt für euch selbst genauso wie für andere.\n\nGeht euer Leben durch: Wo tragt ihr das Ergebnis eurer Entscheidungen, und wo nicht? Beim Arbeitgeber, im Verein, in der Familie, bei Geld, das ihr verwaltet.\n\nDann die unbequemere Richtung: Wo entscheidet jemand anderes über euch, ohne die Folgen zu tragen? Und was hält euch davon ab, das zu ändern — Bequemlichkeit, Angst oder ein echter Grund?\n\nZum Schluss die Regel von vorhin, angewandt: Welcher Weg aus dieser Woche ist der kurzfristig schmerzhaftere? Wenn beide gleichwertig aussehen, ist das euer Weg.",
            question: "Wo entscheidet jemand über dich, ohne die Folgen zu tragen?",
            teaser: "Wer nicht trägt, entscheidet anders. Immer." },
          { name: "Falsifizierbar", title: "Was müsste passieren, damit du es aufgibst?", duration: 600,
            hostNote: "Beide nacheinander. Die andere Person darf hartnäckig sein.",
            description: "Eine Überzeugung, die durch nichts widerlegt werden könnte, ist keine Erkenntnis, sondern eine Haltung. Das ist erlaubt — man sollte es nur wissen.\n\nNennt eine eurer festen Überzeugungen über euch selbst, euren Beruf oder euer Vorhaben. Und dann: Was genau müsste eintreten, damit ihr sie aufgäbt? Ein Ereignis, eine Zahl, ein Zeitpunkt.\n\nWenn euch nichts einfällt, habt ihr etwas gefunden, das nicht mehr geprüft wird. Genau solche Sätze steuern die längsten Umwege.",
            question: "Welche deiner Überzeugungen könnte durch nichts widerlegt werden?",
            teaser: "Was durch nichts widerlegt werden kann, ist keine Erkenntnis." },
          { name: "Brücke", title: "Wohin der nächste Abend führt", duration: 300,
            hostNote: "Vorlesen. Danach nächsten Termin bestätigen.",
            description: "Abend 4 nimmt eine Entscheidung, die die meisten nie bewusst treffen: ob ihr Risiken unter eurem eigenen Namen eingeht. Wer das tut, bekommt Vertrauen, Beteiligung und Einfluss — und trägt dafür die Möglichkeit, öffentlich zu scheitern.\n\nDas hängt direkt an heute: Wer nicht entscheiden kann, hängt auch seinen Namen an nichts.",
            teaser: "Nächstes Mal: der eigene Name im Risiko." },
          { name: "Schritt", title: "Sagt eine Sache ab", duration: 420,
            hostNote: "Beide legen sich fest — was genau, an wen, bis wann. Aufschreiben. Abend 4 beginnt mit der Frage, ob es raus ist.",
            description: "Sagt eine Sache ab, bei der ihr seit Wochen unschlüssig seid. Sauber, schriftlich, ohne erfundene Begründung — ein Satz genügt, und er darf ehrlich sein.\n\nErledigt ist es, wenn die Absage raus ist. Nicht, wenn sie formuliert ist.\n\nWas ihr dabei lernt, steht in keinem Buch: wie viel Platz eine einzige Absage macht. Meistens deutlich mehr als die Sache an Zeit gekostet hätte.",
            teaser: "Eine Absage macht mehr Platz als sie Zeit spart." },
          { name: "Wort", title: "Ein Wort, mit dem ihr geht", duration: 240,
            hostNote: "Reihum, ohne Erklärung.",
            description: "Ein Wort für das, was hängen bleibt.",
            teaser: "Ein Wort, keine Erklärung." }
        ])
      },
      solo: {
        ...
        stations: withFeedback([
          { name: "Öffnen", title: "Ein Moment für dich", duration: 120,
            description: "Telefon weg, Papier bereit. Dieser Abend endet mit einer Absage, die tatsächlich rausgeht.",
            teaser: "Heute wird entschieden." },
          { name: "Ankommen", title: "Was schiebst du vor dir her?", duration: 240,
            question: "Welche Entscheidung schiebst du gerade vor dir her — und seit wann genau?",
            description: "Schreib das Datum dazu, so gut du kannst. Die Dauer ist die Information: Was seit drei Tagen offen ist, ist eine Entscheidung. Was seit acht Monaten offen ist, ist eine Gewohnheit.",
            teaser: "Seit wann genau ist es offen?" },
          { name: "Einstieg", title: "Richtung schlägt Geschwindigkeit", duration: 240,
            description: "Wer in die falsche Richtung sprintet, kommt schneller falsch an. Zwischen zwei gleich fleißigen Menschen entscheidet nicht das Tempo, sondern die Trefferquote — und die lässt sich trainieren.\n\nDas ist keine Ausrede für Faulheit: Ohne Arbeit entsteht auch keine Urteilskraft.",
            teaser: "Wer falsch läuft, kommt schneller falsch an." },
          { name: "Modell", title: "Vier Werkzeuge", duration: 300,
            description: "Keine Formeln — Abkürzungen, die verhindern, dass man alte Fehler in neuer Verpackung wiederholt.",
            items: [
              { accent: "1.", label: "Die Nein-Regel", text: "Wenn du dich nicht entscheiden kannst, ist die Antwort Nein." },
              { accent: "2.", label: "Bergauf", text: "Bei zwei gleichwertigen Wegen nimm den, der kurzfristig wehtut." },
              { accent: "3.", label: "Inversion", text: "Frag nicht, was funktioniert. Frag, was garantiert scheitert — und lass das weg." },
              { accent: "4.", label: "Prinzipal oder Agent", text: "Wer trägt das Ergebnis? Wer es nicht trägt, entscheidet anders." }
            ],
            teaser: "Vier Abkürzungen gegen alte Fehler." },
          { name: "Der Fall", title: "Die geschobene Entscheidung", duration: 480,
            question: "Ist Nichtstun hier eine echte Option oder heimlich längst die Entscheidung?",
            description: "Nimm deine Entscheidung von vorhin und beantworte zuerst diese eine Frage schriftlich.\n\nBei optionalen Chancen heißt Zögern schlicht Nein — dann darfst du es aussprechen und weitergehen. Bei Gesundheit, bei Menschen, die älter werden, bei einer Beziehung, die Arbeit bräuchte, heißt Zögern etwas anderes: Ja zum Schlechteren, nur langsamer.\n\nDiese beiden Fälle zu verwechseln ist der häufigste Fehler an dieser Stelle. Schreib auf, welcher deiner ist.",
            teaser: "Zögern ist manchmal Nein und manchmal Ja zum Schlechteren." },
          { name: "Inversion", title: "Wie es garantiert scheitert", duration: 360,
            description: "Nimm dein wichtigstes laufendes Vorhaben. Nicht die Entscheidung — das, woran du arbeitest.\n\nWas müsste passieren, damit es mit Sicherheit scheitert? Fünf Punkte, konkret. Keine Allgemeinplätze wie „zu wenig Disziplin“.\n\nDas ist leichter zu beantworten als die Frage nach dem Erfolg und nützlicher: Erfolg hat viele Wege, Scheitern wenige und wiederkehrende.",
            teaser: "Scheitern hat weniger Wege als Erfolg." },
          { name: "Haken", title: "Der Einwand: wo die Nein-Regel versagt", duration: 240,
            description: "Die Nein-Regel ist stark bei Chancen, die man liegen lassen kann, und gefährlich, wo Nichtstun selbst entscheidet — Gesundheit, alternde Eltern, eine Beziehung, die Pflege bräuchte. Dort produziert sie genau das, wovor sie schützen soll.\n\nUnd „nimm den schmerzhafteren Weg“ lässt sich leicht in Selbstbestrafung umbauen. Die Regel gilt nur bei wirklich gleichwertigen Wegen. Sonst ist Schmerz kein Wegweiser, sondern nur Schmerz.",
            teaser: "Wo Nichtstun entscheidet, versagt die Regel." },
          { name: "Prinzipal", title: "Wer trägt das Ergebnis?", duration: 480,
            question: "Wo entscheidet jemand über dich, ohne die Folgen zu tragen?",
            description: "Wer ein Ergebnis selbst trägt, entscheidet anders als jemand, der es weitergibt. Keine Charakterfrage, eine Anreizfrage.\n\nGeh dein Leben durch: Wo trägst du das Ergebnis deiner Entscheidungen, wo nicht? Arbeit, Verein, Familie, Geld.\n\nDann die unbequemere Richtung — wo entscheidet jemand über dich, ohne die Folgen zu tragen? Und was hält dich davon ab, das zu ändern: Bequemlichkeit, Angst oder ein echter Grund?",
            teaser: "Wer nicht trägt, entscheidet anders." },
          { name: "Falsifizierbar", title: "Was müsste passieren, damit du es aufgibst?", duration: 360,
            question: "Welche deiner Überzeugungen könnte durch nichts widerlegt werden?",
            description: "Eine Überzeugung, die durch nichts widerlegt werden könnte, ist keine Erkenntnis, sondern eine Haltung. Das ist erlaubt — man sollte es nur wissen.\n\nNenn eine feste Überzeugung über dich, deinen Beruf oder dein Vorhaben. Was genau müsste eintreten, damit du sie aufgibst? Ein Ereignis, eine Zahl, ein Zeitpunkt.\n\nFällt dir nichts ein, hast du etwas gefunden, das nicht mehr geprüft wird.",
            teaser: "Was nicht widerlegbar ist, ist keine Erkenntnis." },
          { name: "Ausblick", title: "Was der nächste Abend bringt", duration: 180,
            description: "Abend 4 nimmt eine Entscheidung, die die meisten nie bewusst treffen: ob du Risiken unter deinem eigenen Namen eingehst. Wer das tut, bekommt Vertrauen, Beteiligung und Einfluss — und trägt dafür die Möglichkeit, öffentlich zu scheitern.",
            teaser: "Nächstes Mal: der eigene Name im Risiko." },
          { name: "Schritt", title: "Sag eine Sache ab", duration: 180,
            description: "Sag eine Sache ab, bei der du seit Wochen unschlüssig bist. Sauber, schriftlich, ohne erfundene Begründung — ein ehrlicher Satz genügt.\n\nErledigt ist es, wenn die Absage raus ist. Nicht, wenn sie formuliert ist.",
            teaser: "Erst wenn sie raus ist, zählt sie." },
          { name: "Wort", title: "Ein Wort als Anker", duration: 120,
            description: "Ein Wort ins Notizbuch, unter die von Abend 1 und 2.",
            teaser: "Ein Wort, aufgeschrieben." }
        ])
      }
    }
  ...
  frei_reise_4: {
    ...
    formats: {
      pair: {
        ...
        stations: withFeedback([
          { name: "Öffnen", title: "Ein Moment, bevor ihr anfangt", duration: 180,
            hostNote: "Handys weg, drei Atemzüge. Zuerst die Frage aus Abend 3: Ist die Absage raus?",
            description: "Bevor es losgeht, die Frage vom letzten Mal — und zwar ohne Milde: Ist die Absage raus?\n\nWenn nein, ist das die interessantere Information. Nicht als Vorwurf, sondern als Befund: Was hat sie verhindert?",
            teaser: "Zuerst: ist die Absage raus?" },
          { name: "Ankommen", title: "Wo steht dein Name?", duration: 480,
            hostNote: "Beide nacheinander, je vier Minuten. Nur zuhören.",
            question: "Wo steht dein Name gerade öffentlich an etwas dran — und wo hast du ihn bewusst weggelassen?",
            description: "Nicht nur beruflich. Ein Leserbrief, ein Verein, eine Zusage, ein Text, eine Empfehlung, für die jemand euch beim Wort nehmen kann.\n\nInteressanter ist meistens die zweite Hälfte der Frage.",
            teaser: "Und wo hast du ihn bewusst weggelassen?" },
          { name: "Einstieg", title: "Warum Vertrauen sich verzinst", duration: 480,
            hostNote: "Vorlesen.",
            description: "Große Positionen entstehen selten durch Talent allein. Sie entstehen, weil jemand über Jahrzehnte in denselben Kreisen berechenbar geblieben ist — und weil Berechenbarkeit sich verzinst wie Kapital.\n\nDas Praktische daran: Wer mit denselben Menschen lange arbeitet, muss irgendwann nicht mehr verhandeln. Die kleinen Absicherungen fallen weg, die Reibung sinkt, und Gelegenheiten kommen von selbst, weil jemand einen anruft, statt einen Fremden zu suchen.\n\nDie Kehrseite: Verzinsung braucht Zeit, und wer alle zwei Jahre die Umgebung wechselt, fängt jedes Mal bei null an. Deshalb ist die Frage, mit wem man arbeitet, oft wichtiger als die, woran.",
            teaser: "Berechenbarkeit verzinst sich wie Kapital." },
          { name: "Modell", title: "Drei Bausteine, die einzeln nichts bringen", duration: 420,
            hostNote: "Vorlesen. Danach ordnet jede:r sich ein: welcher fehlt bei mir?",
            description: "Diese drei wirken nur zusammen. Wer nur einen hat, merkt es an einer bestimmten Art von Stillstand.",
            items: [
              { accent: "1.", label: "Verantwortung", text: "Unter eigenem Namen für ein Ergebnis einstehen. Ohne das gibt es keine Glaubwürdigkeit — und keine Anreize." },
              { accent: "2.", label: "Langfristige Spiele", text: "Dieselben Menschen über Jahre. Vertrauen verzinst sich nur, wenn man bleibt." },
              { accent: "3.", label: "Beteiligung", text: "Ein Anteil an dem, was entsteht. Ohne Anteil verdient man nichts, während man schläft." }
            ],
            teaser: "Drei Bausteine, die nur zusammen wirken." },
          { name: "Das Abwärtsrisiko", title: "Was passiert wirklich, wenn es scheitert?", duration: 720,
            hostNote: "Zuerst jede:r fünf Minuten allein und schriftlich rechnen. Dann vorlesen. Nicht trösten.",
            description: "Nehmt euer nächstes größeres Vorhaben und rechnet das Schlimmste aus. Nicht als Gefühl, sondern in zwei Zahlen: Wie viel Geld ist weg? Wie viele Monate braucht ihr, um wieder da zu sein, wo ihr heute steht?\n\nDas ist die wichtigste Rechnung des Abends, weil fast alle sie im Kopf viel zu hoch ansetzen — und einige viel zu niedrig.\n\nSchreibt beides auf. Dann liest es euch vor und der andere fragt genau eine Sache: Was von dieser Zahl ist belegt, und was ist geschätzt?",
            question: "Was ist das Schlimmste, in Euro und in Monaten?",
            teaser: "Zwei Zahlen statt eines Gefühls." },
          { name: "Verzinsung", title: "Welche Verbindung wird leichter?", duration: 720,
            hostNote: "Beide nacheinander. Namen dürfen fallen.",
            description: "Nennt drei Menschen, mit denen ihr seit über fünf Jahren zu tun habt und mit denen es leichter geworden ist statt schwerer. Und dann die eigentliche Frage: Was habt ihr dafür getan?\n\nMeistens ist die Antwort unspektakulär — verlässlich geliefert, nicht kleinlich abgerechnet, im Zweifel zu ihren Gunsten aufgerundet.\n\nDanach die Gegenrichtung, und die ist unbequem: Welche Zusammenarbeit in eurem Leben fängt jedes Mal wieder bei null an? Und liegt das an den anderen oder daran, dass ihr nicht lange genug bleibt?",
            question: "Welche Zusammenarbeit fängt jedes Mal wieder bei null an?",
            teaser: "Was habt ihr dafür getan, dass es leichter wurde?" },
          { name: "Haken", title: "Der Einwand: das Risiko ist nicht überall gleich", duration: 420,
            hostNote: "Vorlesen. Danach: Wie hoch ist euer Abwärtsrisiko wirklich?",
            description: "Der Rat, mehr Risiko unter eigenem Namen einzugehen, kommt oft mit der Beruhigung, das Abwärtsrisiko sei ohnehin gering — Insolvenz sei verzeihlich, Scheitern lehrreich, moderne Gesellschaften seien nachsichtig.\n\nDas ist eine kalifornische Rechnung. In Deutschland folgt der Schufa-Eintrag noch drei Jahre nach der Restschuldbefreiung, Bürgschaften laufen weiter, und der Ruf des Gescheiterten hält sich in kleinen Städten und Branchen deutlich länger als in einem Ökosystem, das Scheitern als Qualifikation liest.\n\nDas heißt nicht: kein Risiko. Es heißt: Nehmt eure eigene Zahl aus der letzten Station, nicht die Zuversicht von jemandem, dessen Umgebung anders funktioniert.",
            teaser: "Kalifornische Nachsicht ist kein deutsches Insolvenzrecht." },
          { name: "Stille", title: "Drei Minuten Atem", duration: 180,
            hostNote: "Timer. Nicht reden.",
            description: "Drei Minuten nichts.",
            teaser: "Drei Minuten nichts." },
          { name: "Ohne Anteil", title: "Wo tauschst du Zeit gegen Geld?", duration: 840,
            hostNote: "Beide nacheinander. Am Ende benennt jede:r einen konkreten kleinsten Schritt — nicht eine Absicht.",
            description: "Ohne Anteil an irgendetwas hängt euer Ertrag eins zu eins an euren Stunden. Das gilt auch bei sehr gut bezahlten Stunden: Wer nur Zeit verkauft, verdient nichts im Urlaub, nichts bei Krankheit, nichts im Ruhestand.\n\nGeht ehrlich durch: Wo tauscht ihr gerade Zeit gegen Geld ohne jeden Anteil?\n\nUnd dann die Frage, die diesen Abend praktisch macht — was wäre der kleinste realistische Schritt zu einer Beteiligung? Nicht die Firmengründung. Anteile über einen Arbeitsvertrag, eine Umsatzbeteiligung, eine Lizenz, ein eigenes kleines Produkt neben der Arbeit, ein Anteil an einem Projekt, das ihr ohnehin voranbringt.\n\nBenennt einen Schritt und ein Datum. Ohne Datum ist es ein Gedanke.",
            question: "Was wäre der kleinste realistische Schritt zu einer Beteiligung?",
            teaser: "Der kleinste Schritt, nicht die Firmengründung." },
          { name: "Die Angst", title: "Vor wem willst du nicht scheitern?", duration: 600,
            hostNote: "Beide nacheinander. Hier wird es persönlich — nur zuhören.",
            description: "Die Furcht, unter eigenem Namen zu scheitern, ist selten diffus. Meistens hat sie ein Gesicht: ein Elternteil, ein früherer Chef, ein Schulfreund, ein Milieu.\n\nBenennt es. Und dann die Frage, die überraschend oft etwas löst: Ist diese Person das wert?\n\nOft ist die Antwort nein, und manchmal ist die Person längst tot oder hat seit zwanzig Jahren nicht an euch gedacht. Das macht die Furcht nicht weg, aber es macht sie kleiner und überprüfbar.",
            question: "Vor wem willst du nicht öffentlich scheitern — und ist diese Person das wert?",
            teaser: "Die Furcht hat meistens ein Gesicht." },
          { name: "Brücke", title: "Wohin der nächste Abend führt", duration: 300,
            hostNote: "Vorlesen, Termin bestätigen.",
            description: "Abend 5 ist der handfesteste der Reise: Hebelwirkung. Warum manche Menschen für Anwesenheit bezahlt werden und andere für Ergebnisse — und was das mit Software, Kapital, Menschen und Medien zu tun hat.\n\nDas baut direkt auf heute auf: Hebel bekommt man nur, wenn man Verantwortung getragen hat. Niemand gibt Kapital oder Gefolgschaft an jemanden, der noch nie für etwas eingestanden ist.",
            teaser: "Nächstes Mal: Hebelwirkung." },
          { name: "Schritt", title: "Hängt euren Namen an etwas", duration: 420,
            hostNote: "Beide legen sich fest: was genau, bis wann, öffentlich wo. Aufschreiben.",
            description: "Veröffentlicht oder versprecht etwas unter eurem vollen Namen, das schiefgehen kann. Klein reicht — ein Angebot, eine Zusage mit Datum, ein Text, eine Empfehlung, für die man euch beim Wort nehmen kann.\n\nErledigt ist es, wenn euer Name daran steht und ihr es nicht mehr zurücknehmen könnt, ohne dass es jemand merkt.\n\nDas letzte Kriterium ist das entscheidende. Alles, was man geräuschlos zurückziehen kann, ist kein Risiko.",
            teaser: "Klein reicht. Zurücknehmbar nicht." },
          { name: "Wort", title: "Ein Wort, mit dem ihr geht", duration: 240,
            hostNote: "Reihum, ohne Erklärung.",
            description: "Ein Wort für das, was hängen bleibt.",
            teaser: "Ein Wort, keine Erklärung." }
      ...
      solo: {
        ...
        stations: withFeedback([
          { name: "Öffnen", title: "Ein Moment für dich", duration: 120,
            description: "Papier bereit. Und zuerst die Frage aus Abend 3: Ist die Absage raus? Wenn nein — was hat sie verhindert?",
            teaser: "Zuerst: ist die Absage raus?" },
          { name: "Ankommen", title: "Wo steht dein Name?", duration: 240,
            question: "Wo steht dein Name öffentlich an etwas dran — und wo hast du ihn bewusst weggelassen?",
            description: "Nicht nur beruflich. Eine Zusage, ein Text, ein Verein, eine Empfehlung, für die man dich beim Wort nehmen kann. Die zweite Hälfte der Frage ist die interessantere.",
            teaser: "Und wo hast du ihn weggelassen?" },
          { name: "Einstieg", title: "Warum Vertrauen sich verzinst", duration: 240,
            description: "Große Positionen entstehen selten durch Talent allein, sondern weil jemand über Jahre in denselben Kreisen berechenbar geblieben ist. Berechenbarkeit verzinst sich wie Kapital: Irgendwann muss man nicht mehr verhandeln, und Gelegenheiten kommen, weil jemand anruft statt zu suchen.\n\nDie Kehrseite: Wer alle zwei Jahre die Umgebung wechselt, fängt jedes Mal bei null an.",
            teaser: "Berechenbarkeit verzinst sich." },
          { name: "Modell", title: "Drei Bausteine, die einzeln nichts bringen", duration: 300,
            description: "Diese drei wirken nur zusammen. Ordne dich ein: welcher fehlt bei dir?",
            items: [
              { accent: "1.", label: "Verantwortung", text: "Unter eigenem Namen für ein Ergebnis einstehen. Ohne das keine Glaubwürdigkeit." },
              { accent: "2.", label: "Langfristige Spiele", text: "Dieselben Menschen über Jahre. Vertrauen verzinst sich nur, wenn man bleibt." },
              { accent: "3.", label: "Beteiligung", text: "Ein Anteil an dem, was entsteht. Ohne Anteil verdienst du nichts, während du schläfst." }
            ],
            teaser: "Drei Bausteine, die nur zusammen wirken." },
          { name: "Das Abwärtsrisiko", title: "Was passiert wirklich, wenn es scheitert?", duration: 480,
            question: "Was ist das Schlimmste, in Euro und in Monaten?",
            description: "Nimm dein nächstes größeres Vorhaben und rechne das Schlimmste aus. Nicht als Gefühl, in zwei Zahlen: Wie viel Geld ist weg? Wie viele Monate brauchst du, um wieder dort zu sein, wo du heute stehst?\n\nSchreib beides auf. Und dann markiere, was davon belegt ist und was geschätzt. Fast alle setzen die Zahl im Kopf viel zu hoch an — einige viel zu niedrig.",
            teaser: "Zwei Zahlen statt eines Gefühls." },
          { name: "Verzinsung", title: "Welche Verbindung wird leichter?", duration: 360,
            question: "Welche Zusammenarbeit fängt bei dir jedes Mal wieder bei null an?",
            description: "Nenn drei Menschen, mit denen du seit über fünf Jahren zu tun hast und mit denen es leichter geworden ist. Was hast du dafür getan? Meistens ist die Antwort unspektakulär: verlässlich geliefert, nicht kleinlich abgerechnet.\n\nDann die Gegenrichtung — und die ehrliche Nachfrage: Liegt das an den anderen oder daran, dass du nicht lange genug bleibst?",
            teaser: "Was hast du dafür getan?" },
          { name: "Haken", title: "Der Einwand: das Risiko ist nicht überall gleich", duration: 240,
            description: "Der Rat, mehr Risiko unter eigenem Namen einzugehen, kommt oft mit der Beruhigung, das Abwärtsrisiko sei gering — Insolvenz verzeihlich, Scheitern lehrreich.\n\nDas ist eine kalifornische Rechnung. In Deutschland folgt der Schufa-Eintrag noch drei Jahre nach der Restschuldbefreiung, Bürgschaften laufen weiter, und in kleinen Städten und Branchen hält sich der Ruf des Gescheiterten länger.\n\nNimm deine eigene Zahl aus der letzten Station, nicht fremde Zuversicht.",
            teaser: "Kalifornische Nachsicht ist kein deutsches Insolvenzrecht." },
          { name: "Ohne Anteil", title: "Wo tauschst du Zeit gegen Geld?", duration: 480,
            question: "Was wäre der kleinste realistische Schritt zu einer Beteiligung?",
            description: "Ohne Anteil hängt dein Ertrag eins zu eins an deinen Stunden — auch bei gut bezahlten. Wer nur Zeit verkauft, verdient nichts im Urlaub, nichts bei Krankheit, nichts im Ruhestand.\n\nWo tauschst du gerade Zeit gegen Geld ohne jeden Anteil?\n\nUnd dann der praktische Teil: der kleinste realistische Schritt. Nicht die Firmengründung — Anteile über einen Arbeitsvertrag, eine Umsatzbeteiligung, eine Lizenz, ein kleines eigenes Produkt.\n\nSchritt und Datum. Ohne Datum ist es ein Gedanke.",
            teaser: "Der kleinste Schritt, nicht die Firmengründung." },
          { name: "Die Angst", title: "Vor wem willst du nicht scheitern?", duration: 360,
            question: "Vor wem willst du nicht öffentlich scheitern — und ist diese Person das wert?",
            description: "Die Furcht, unter eigenem Namen zu scheitern, hat meistens ein Gesicht: ein Elternteil, ein früherer Chef, ein Milieu.\n\nBenenn es. Dann die Frage, die oft etwas löst: Ist diese Person das wert? Manchmal ist sie längst tot oder hat seit zwanzig Jahren nicht an dich gedacht. Das macht die Furcht nicht weg, aber überprüfbar.",
            teaser: "Die Furcht hat meistens ein Gesicht." },
          { name: "Ausblick", title: "Was der nächste Abend bringt", duration: 180,
            description: "Abend 5 ist der handfesteste: Hebelwirkung. Warum manche für Anwesenheit bezahlt werden und andere für Ergebnisse.\n\nDas baut auf heute auf — Hebel bekommt nur, wer schon einmal für etwas eingestanden ist.",
            teaser: "Nächstes Mal: Hebelwirkung." },
          { name: "Schritt", title: "Häng deinen Namen an etwas", duration: 180,
            description: "Veröffentliche oder versprich etwas unter deinem vollen Namen, das schiefgehen kann. Klein reicht.\n\nErledigt ist es, wenn dein Name daran steht und du es nicht mehr zurücknehmen kannst, ohne dass es jemand merkt. Das letzte Kriterium ist das entscheidende.",
            teaser: "Klein reicht. Zurücknehmbar nicht." },
          { name: "Wort", title: "Ein Wort als Anker", duration: 120,
            description: "Ein Wort ins Notizbuch.",
            teaser: "Ein Wort, aufgeschrieben." }
        ])
      }
    }
  ...
  frei_reise_5: {
    ...
    formats: {
      pair: {
        ...
        stations: withFeedback([
          { name: "Öffnen", title: "Ein Moment, bevor ihr anfangt", duration: 180,
            hostNote: "Handys weg, drei Atemzüge. Zuerst die Frage aus Abend 4: Hängt euer Name inzwischen an etwas?",
            description: "Bevor es losgeht, der Rückblick auf letzte Woche: Habt ihr euren Namen an etwas gehängt, das schiefgehen kann? Wer hat reagiert — und war die Reaktion so schlimm wie befürchtet?",
            teaser: "Zuerst: hat jemand reagiert?" },
          { name: "Ankommen", title: "Wo hängt dein Ertrag an deinen Stunden?", duration: 480,
            hostNote: "Beide nacheinander, je vier Minuten. Nur zuhören.",
            question: "Wo hängt dein Ergebnis noch eins zu eins an deiner Zeit — und wie fühlt sich das an?",
            description: "Nicht bewerten, nur benennen. Bei den meisten ist das der größte Teil des Einkommens, und das ist völlig normal. Interessant ist die zweite Hälfte der Frage: Stört es euch, oder ist es in Ordnung?",
            teaser: "Stört es dich überhaupt?" },
          { name: "Einstieg", title: "Wenn Aufwand aufhört zu zählen", duration: 480,
            hostNote: "Vorlesen.",
            description: "In Berufen ohne Hebel ist der Zusammenhang zwischen Einsatz und Ertrag beruhigend eng: doppelt so lange gearbeitet, ungefähr doppelt so viel verdient. In gehebelten Berufen verschwindet dieser Zusammenhang. Zwei Menschen mit gleichem Fleiß landen bei völlig verschiedenen Ergebnissen, weil einer die richtige Sache getan hat.\n\nDas ist die unbequeme Seite. Die bequeme: Wenn Aufwand aufhört zu zählen, zählt Urteilskraft — und die kann man in Ruhe aufbauen, ohne sich kaputtzuarbeiten.\n\nEin Detail, das viele überlesen: Hebel vervielfachen auch Fehler. Wer schlecht entscheidet und dann Kapital, Menschen oder Reichweite dazunimmt, macht den Schaden größer, nicht kleiner. Deshalb kam Abend 3 vor diesem hier.",
            teaser: "Hebel vervielfachen auch Fehler." },
          { name: "Modell", title: "Die vier Hebel", duration: 420,
            hostNote: "Vorlesen. Danach markiert jede:r für sich: welchen nutze ich, welchen habe ich nie ausprobiert?",
            description: "Zwei davon brauchen die Zustimmung anderer. Zwei nicht. Das ist der wichtigste Unterschied zwischen ihnen.",
            items: [
              { accent: "1.", label: "Menschen", text: "Andere arbeiten für dich. Der älteste Hebel — aber jemand muss dir folgen wollen." },
              { accent: "2.", label: "Kapital", text: "Geld vervielfacht jede Entscheidung. Skaliert gut — aber jemand muss es dir geben." },
              { accent: "3.", label: "Code", text: "Einmal geschrieben, arbeitet er weiter, während du schläfst. Niemand muss es erlauben." },
              { accent: "4.", label: "Medien", text: "Text, Ton, Bild — beliebig oft kopierbar ohne Zusatzkosten. Niemand muss es erlauben." }
            ],
            teaser: "Zwei brauchen Erlaubnis, zwei nicht." },
          { name: "Inventur", title: "Fünf Wochen, ehrlich sortiert", duration: 720,
            hostNote: "Zuerst jede:r sieben Minuten allein. Dann vorlesen und vergleichen.",
            description: "Geht eure letzten fünf Arbeitswochen durch und schreibt die größeren Aufgaben auf. Hinter jede kommt eine Markierung: nur ich, Menschen, Kapital, Code, Medien.\n\nDie meisten erschrecken an dieser Stelle über den Anteil „nur ich“. Das ist der Punkt der Übung — nicht als Vorwurf, sondern als Bestandsaufnahme.\n\nZweite Runde, und die ist die produktivere: Was von letzter Woche hätte eine Vorlage, eine Aufzeichnung, ein Textbaustein oder ein kleines Skript ein zweites Mal erledigt? Sucht nicht das Große. Sucht das, was ihr diese Woche schon wieder tun werdet.",
            question: "Was machst du wiederholt, das genau einmal gemacht werden müsste?",
            teaser: "Der Anteil „nur ich“ überrascht die meisten." },
          { name: "Die Ausrede", title: "Welchen Hebel meidest du — und warum?", duration: 720,
            hostNote: "Beide nacheinander. Die andere Person darf einmal nachbohren, aber nicht überreden.",
            description: "Fast jeder hat einen Hebel, den er systematisch meidet, und einen Satz dazu: „Ich kann nicht programmieren.“ „Ich mag mich nicht zeigen.“ „Ich will niemanden führen.“ „Ich habe kein Kapital.“\n\nDiese Sätze sind selten falsch und fast immer unvollständig. Hinter „Ich mag mich nicht zeigen“ steckt meist die Furcht vor Beurteilung, nicht Bescheidenheit. Hinter „Ich kann nicht programmieren“ steckt manchmal nur, dass es niemand gezeigt hat.\n\nSagt euren Satz laut. Und dann: Was steckt tatsächlich dahinter — eine Fähigkeit, die fehlt, oder eine Furcht, die nie geprüft wurde?",
            question: "Welchen Hebel meidest du, und was steckt wirklich hinter deiner Begründung?",
            teaser: "Die Ausrede ist selten falsch und fast immer unvollständig." },
          { name: "Haken", title: "Der Einwand: erlaubnisfrei heißt nicht reibungsfrei", duration: 420,
            hostNote: "Vorlesen. Danach: Trifft das auf euren Bereich zu?",
            description: "Zwei Punkte, an denen die schöne Ordnung von vorhin bröckelt.\n\nErstens: Dass Menschen der schlechteste Hebel seien, ist die Sicht eines Investors. Für eine Handwerksfirma, eine Praxis, ein Café, eine Schule sind Menschen der einzige verfügbare Hebel — und ein gutes Team ist dort kein Rückschritt, sondern das ganze Geschäft. Wer diesen Rat wörtlich nimmt, baut nie etwas, das mehr ist als er selbst.\n\nZweitens: „Code und Medien brauchen keine Erlaubnis“ stimmt technisch und ist inzwischen irreführend. Der Türsteher heißt nicht mehr Verlag oder Sender, er heißt Aufmerksamkeit. Erlaubnisfrei heißt heute: Du darfst dich anstellen. Die Warteschlange ist trotzdem da, und sie ist länger als je zuvor.\n\nDer Hebel liegt frei herum. Das macht ihn nicht leicht.",
            teaser: "Der Türsteher heißt heute Aufmerksamkeit." },
          { name: "Stille", title: "Drei Minuten Atem", duration: 180,
            hostNote: "Timer. Nicht reden.",
            description: "Drei Minuten nichts.",
            teaser: "Drei Minuten nichts." },
          { name: "Stundensatz", title: "Eine Zahl, die absurd hoch ist", duration: 840,
            hostNote: "Beide nennen ihre Zahl laut. Die andere Person fragt: Warum nicht höher? Genau einmal.",
            description: "Setzt euch einen persönlichen Stundensatz. Frei erfunden, absurd hoch, aufgeschrieben. Nicht das, was ihr verdient — das, was eure Zeit euch wert ist.\n\nDann der praktische Teil: Was habt ihr letzte Woche getan, das unter diesem Satz lag? Die Fahrt quer durch die Stadt für eine Kleinigkeit, der Streit mit einem Anbieter über zwölf Euro, die Stunde für etwas, das jemand anderes besser und billiger macht.\n\nDer Satz ist kein Buchhaltungswert, sondern ein Filter. Er beantwortet eine einzige Frage schnell: Mache ich das selbst, gebe ich es ab oder lasse ich es ganz?\n\nZum Schluss die Frage, die weiter reicht: Wo habt ihr euch selbst zu billig eingekauft — nicht bei Aufträgen, sondern bei der eigenen Zeit?",
            question: "Was hast du letzte Woche getan, das unter deinem Stundensatz lag?",
            teaser: "Ein Filter, keine Buchhaltung." },
          { name: "Drei Fragen", title: "Wo, mit wem, was", duration: 600,
            hostNote: "Beide nacheinander. Hier ist Nachdenken wichtiger als Antworten.",
            description: "Drei Entscheidungen bestimmen den Rahmen für fast alles andere: wo ihr lebt, mit wem ihr lebt, was ihr tut. Eine Stadt trägt vielleicht zehn Jahre, ein Beruf fünf, eine Beziehung Jahrzehnte.\n\nDie meisten Menschen verbringen mehr Zeit mit der Auswahl eines Telefons als mit einer dieser drei.\n\nGeht sie einzeln durch und beantwortet für jede nur eine Frage: Habe ich das entschieden — oder ist es mir passiert? Geerbt, mitgenommen, drangeblieben, weil es sich ergab.\n\nDas ist kein Aufruf, etwas davon umzuwerfen. Es ist der Unterschied zwischen einem Leben, das man führt, und einem, das man verwaltet.",
            question: "Welche der drei großen Entscheidungen hast du nie entschieden, sondern geerbt?",
            teaser: "Entschieden oder passiert?" },
          { name: "Brücke", title: "Wohin der nächste Abend führt", duration: 300,
            hostNote: "Vorlesen, nächsten Termin bestätigen.",
            description: "Abend 6 dreht die Perspektive: Warum die Menschen, die in ihrem Feld nicht zu schlagen sind, meistens gar nicht das Gefühl haben zu arbeiten. Und warum Glück kein Zufall ist, sondern etwas, das man baut.\n\nDas passt direkt an heute: Hebel ohne etwas, das euch trägt, ist nur eine schnellere Tretmühle.",
            teaser: "Nächstes Mal: Arbeit, die sich nicht wie Arbeit anfühlt." },
          { name: "Schritt", title: "Zwei Sachen in dieser Woche", duration: 420,
            hostNote: "Beide legen sich fest — welche Aufgabe, welche Abgabe. Aufschreiben.",
            description: "Erstens: Erledigt eine ohnehin anstehende Aufgabe so, dass das Ergebnis wiederverwendbar ist. Vorlage, Aufzeichnung, Textbaustein, Skript. Erledigt ist es, wenn ihr es ein zweites Mal benutzt habt, ohne es neu zu bauen.\n\nZweitens: Gebt genau eine Sache ab oder lasst sie weg, die unter eurem Stundensatz liegt. Bezahlt dafür — oder ertragt, dass sie unerledigt bleibt.\n\nDie zweite ist die schwerere. Fast alle merken dabei, dass es nicht am Geld hängt, sondern am Loslassen.",
            teaser: "Einmal bauen, einmal loslassen." },
          { name: "Wort", title: "Ein Wort, mit dem ihr geht", duration: 240,
            hostNote: "Reihum, ohne Erklärung.",
            description: "Ein Wort für das, was hängen bleibt.",
            teaser: "Ein Wort, keine Erklärung." }
      ...
      solo: {
        ...
        stations: withFeedback([
          { name: "Öffnen", title: "Ein Moment für dich", duration: 120,
            description: "Papier bereit. Zuerst der Rückblick: Hängt dein Name inzwischen an etwas, das schiefgehen kann? Hat jemand reagiert?",
            teaser: "Zuerst: hat jemand reagiert?" },
          { name: "Ankommen", title: "Wo hängt dein Ertrag an deinen Stunden?", duration: 240,
            question: "Wo hängt dein Ergebnis eins zu eins an deiner Zeit — und stört dich das?",
            description: "Nicht bewerten, nur benennen. Bei den meisten ist das der größte Teil des Einkommens. Die zweite Hälfte der Frage ist die interessantere.",
            teaser: "Stört es dich überhaupt?" },
          { name: "Einstieg", title: "Wenn Aufwand aufhört zu zählen", duration: 240,
            description: "In Berufen ohne Hebel ist der Zusammenhang eng: doppelt so lange gearbeitet, ungefähr doppelt so viel verdient. In gehebelten Berufen verschwindet er — zwei gleich fleißige Menschen landen bei völlig verschiedenen Ergebnissen, weil einer die richtige Sache getan hat.\n\nWichtig dabei: Hebel vervielfachen auch Fehler. Deshalb kam der Abend übers Entscheiden vor diesem.",
            teaser: "Hebel vervielfachen auch Fehler." },
          { name: "Modell", title: "Die vier Hebel", duration: 300,
            description: "Zwei brauchen die Zustimmung anderer, zwei nicht. Markiere: welchen nutzt du, welchen hast du nie ausprobiert?",
            items: [
              { accent: "1.", label: "Menschen", text: "Andere arbeiten für dich — aber jemand muss dir folgen wollen." },
              { accent: "2.", label: "Kapital", text: "Geld vervielfacht jede Entscheidung — aber jemand muss es dir geben." },
              { accent: "3.", label: "Code", text: "Einmal geschrieben, arbeitet er weiter. Niemand muss es erlauben." },
              { accent: "4.", label: "Medien", text: "Beliebig oft kopierbar ohne Zusatzkosten. Niemand muss es erlauben." }
            ],
            teaser: "Zwei brauchen Erlaubnis, zwei nicht." },
          { name: "Inventur", title: "Fünf Wochen, ehrlich sortiert", duration: 480,
            question: "Was machst du wiederholt, das genau einmal gemacht werden müsste?",
            description: "Geh deine letzten fünf Arbeitswochen durch. Hinter jede größere Aufgabe eine Markierung: nur ich, Menschen, Kapital, Code, Medien.\n\nDer Anteil „nur ich“ überrascht die meisten. Das ist der Punkt der Übung.\n\nZweite Runde: Was von letzter Woche hätte eine Vorlage, eine Aufzeichnung oder ein kleines Skript ein zweites Mal erledigt? Such nicht das Große — such das, was du diese Woche schon wieder tun wirst.",
            teaser: "Der Anteil „nur ich“ überrascht." },
          { name: "Die Ausrede", title: "Welchen Hebel meidest du?", duration: 360,
            question: "Welchen Hebel meidest du, und was steckt wirklich hinter deiner Begründung?",
            description: "Fast jeder hat einen Hebel, den er meidet, und einen Satz dazu: „Ich kann nicht programmieren.“ „Ich mag mich nicht zeigen.“ „Ich will niemanden führen.“\n\nDiese Sätze sind selten falsch und fast immer unvollständig. Schreib deinen auf — und dann, was tatsächlich dahintersteckt: eine fehlende Fähigkeit oder eine nie geprüfte Furcht?",
            teaser: "Selten falsch, fast immer unvollständig." },
          { name: "Haken", title: "Der Einwand: erlaubnisfrei heißt nicht reibungsfrei", duration: 240,
            description: "Dass Menschen der schlechteste Hebel seien, ist die Sicht eines Investors. Für eine Praxis, ein Café, eine Handwerksfirma sind Menschen der einzige verfügbare Hebel — wer den Rat wörtlich nimmt, baut nie etwas, das mehr ist als er selbst.\n\nUnd „Code und Medien brauchen keine Erlaubnis“ stimmt technisch, ist aber irreführend: Der Türsteher heißt heute Aufmerksamkeit. Erlaubnisfrei heißt, du darfst dich anstellen. Die Warteschlange bleibt.",
            teaser: "Der Türsteher heißt heute Aufmerksamkeit." },
          { name: "Stundensatz", title: "Eine Zahl, die absurd hoch ist", duration: 480,
            question: "Was hast du letzte Woche getan, das unter deinem Stundensatz lag?",
            description: "Setz dir einen persönlichen Stundensatz. Frei erfunden, absurd hoch, aufgeschrieben. Nicht das, was du verdienst — das, was deine Zeit dir wert ist.\n\nDann: Was hast du letzte Woche getan, das darunter lag? Die Fahrt quer durch die Stadt, der Streit über zwölf Euro, die Stunde für etwas, das jemand besser und billiger macht.\n\nDer Satz ist ein Filter, kein Buchhaltungswert. Er beantwortet eine Frage schnell: selbst machen, abgeben oder ganz lassen?",
            teaser: "Ein Filter, keine Buchhaltung." },
          { name: "Drei Fragen", title: "Wo, mit wem, was", duration: 360,
            question: "Welche der drei großen Entscheidungen hast du nie entschieden, sondern geerbt?",
            description: "Drei Entscheidungen bestimmen den Rahmen für fast alles: wo du lebst, mit wem, was du tust. Eine Stadt trägt vielleicht zehn Jahre, ein Beruf fünf, eine Beziehung Jahrzehnte.\n\nGeh sie einzeln durch, eine Frage je Entscheidung: Habe ich das entschieden — oder ist es mir passiert?\n\nKein Aufruf, etwas umzuwerfen. Nur der Unterschied zwischen einem Leben, das man führt, und einem, das man verwaltet.",
            teaser: "Entschieden oder passiert?" },
          { name: "Ausblick", title: "Was der nächste Abend bringt", duration: 180,
            description: "Abend 6 dreht die Perspektive: warum die Menschen, die in ihrem Feld nicht zu schlagen sind, meistens gar nicht das Gefühl haben zu arbeiten — und warum Glück kein Zufall ist, sondern etwas, das man baut.\n\nHebel ohne etwas, das dich trägt, ist nur eine schnellere Tretmühle.",
            teaser: "Nächstes Mal: Arbeit, die sich nicht wie Arbeit anfühlt." },
          { name: "Schritt", title: "Zwei Sachen in dieser Woche", duration: 180,
            description: "Erstens: Erledige eine ohnehin anstehende Aufgabe so, dass das Ergebnis wiederverwendbar ist. Erledigt, wenn du es ein zweites Mal benutzt hast, ohne es neu zu bauen.\n\nZweitens: Gib genau eine Sache ab oder lass sie weg, die unter deinem Stundensatz liegt. Die zweite ist die schwerere — meistens hängt es nicht am Geld, sondern am Loslassen.",
            teaser: "Einmal bauen, einmal loslassen." },
          { name: "Wort", title: "Ein Wort als Anker", duration: 120,
            description: "Ein Wort ins Notizbuch.",
            teaser: "Ein Wort, aufgeschrieben." }
  ...
  frei_reise_6: {
    ...
    formats: {
      pair: {
        ...
        stations: withFeedback([
          { name: "Öffnen", title: "Ein Moment, bevor ihr anfangt", duration: 180,
            hostNote: "Handys weg, drei Atemzüge. Zuerst der Rückblick auf Abend 5: Wurde etwas wiederverwendbar — und wurde etwas abgegeben?",
            description: "Der Rückblick zuerst, und zwar der ehrliche: Habt ihr etwas gebaut, das ein zweites Mal funktioniert hat? Und habt ihr etwas abgegeben? Die zweite Frage fällt bei fast allen schlechter aus.",
            teaser: "Was habt ihr tatsächlich abgegeben?" },
          { name: "Ankommen", title: "Was tust du, ohne dass jemand es verlangt?", duration: 480,
            hostNote: "Beide nacheinander, je vier Minuten. Nur zuhören.",
            question: "Was hast du in den letzten vier Wochen getan, ohne dass jemand es verlangt hat — und ohne dass es jemandem aufgefallen wäre?",
            description: "Der Zusatz ist entscheidend. Gesucht ist nicht das, wofür ihr gelobt wurdet, sondern das, was ihr getan hättet, auch wenn niemand hinsieht.\n\nDas ist oft peinlich klein: eine Tabelle, die niemand braucht, ein Umweg über einen bestimmten Laden, eine Reparatur, die ein Fachmann in zehn Minuten erledigt hätte.",
            teaser: "Was du auch ohne Publikum getan hättest." },
          { name: "Einstieg", title: "Warum niemand gegen Spielen ankommt", duration: 480,
            hostNote: "Vorlesen.",
            description: "Wettbewerb entsteht durch Nachahmung. Wer dasselbe tun will wie andere, konkurriert. Wer etwas tut, das eine Verlängerung seiner selbst ist, hat keine direkten Konkurrenten — nicht aus Überlegenheit, sondern weil es sich nicht kopieren lässt.\n\nDaraus folgt die praktisch nützlichste Regel dieser Reise: Der Weg aus dem Wettbewerb führt nicht über mehr Anstrengung, sondern über mehr Eigenart.\n\nUnd die Zeitrechnung dahinter: Es dauert länger, als alle denken. Wer mitzählt — wer nach zwei Jahren fragt, ob es sich gelohnt hat —, hört auf, bevor es sich verzinst. Das ist der häufigste Abbruchgrund, nicht mangelndes Talent.",
            teaser: "Aus dem Wettbewerb führt Eigenart, nicht Anstrengung." },
          { name: "Modell", title: "Vier Arten von Glück", duration: 420,
            hostNote: "Vorlesen. Danach ordnet jede:r ein: welche nutze ich gerade tatsächlich?",
            description: "Nur die erste ist Zufall. Die anderen drei sind Verhalten — und deshalb lernbar.",
            items: [
              { accent: "1.", label: "Blindes Glück", text: "Es passiert einfach. Darauf kann man nur warten, und die meisten tun genau das." },
              { accent: "2.", label: "Glück durch Bewegung", text: "Wer viel anfängt, anrührt und ausprobiert, erzeugt genug Zufälle, dass einer trifft." },
              { accent: "3.", label: "Glück durch Erkennen", text: "Wer in einem Feld tief drinsteckt, sieht eine Gelegenheit, die andere übersehen — sie ist für sie unsichtbar." },
              { accent: "4.", label: "Glück durch Ruf", text: "Du wirst gesucht, weil du für etwas bekannt bist. Dann kommt fremdes Glück zu dir." }
            ],
            teaser: "Nur die erste Art ist wirklich Zufall." },
          { name: "Nach Arbeit aussehen", title: "Was fällt dir leicht, das andere anstrengt?", duration: 720,
            hostNote: "Beide nacheinander. Wichtig: Am Ende sagt ihr es einander, nicht euch selbst.",
            description: "Zurück zu der Beobachtung von Abend 1, aber diesmal von außen: Was tut ihr, das für andere nach Arbeit aussieht?\n\nDenkt an konkrete Momente, in denen jemand gesagt hat: „Das könnte ich nicht.“ „Wie hältst du das aus?“ „Dafür hätte ich keine Geduld.“ Solche Sätze sind Messpunkte — sie zeigen die Stelle, an der eure Normalität für andere anstrengend ist.\n\nUnd wieder gilt: Ihr seht das beim anderen besser als bei euch selbst. Also sagt es einander, konkret und mit Beispiel.",
            question: "Was tust du, das für andere nach Arbeit aussieht?",
            teaser: "„Das könnte ich nicht“ ist ein Messpunkt." },
          { name: "Warten", title: "Wo wartest du auf blindes Glück?", duration: 720,
            hostNote: "Beide nacheinander. Die andere Person fragt: Was wäre die kleinste Bewegung?",
            description: "Es gibt in fast jedem Leben eine Stelle, an der man auf etwas wartet, das von selbst kommen soll: der Anruf, die Gelegenheit, der richtige Zeitpunkt, dass jemand es endlich merkt.\n\nWarten fühlt sich vernünftig an, weil es nach Geduld aussieht. Meistens ist es aber die erste Art von Glück — die einzige, die man nicht beeinflussen kann.\n\nBenennt eure Wartestelle. Und dann die entscheidende Frage: Was wäre hier die kleinste Bewegung, die ihr diese Woche machen könntet? Nicht der große Schritt — die kleinste Rührung, die überhaupt etwas in Bewegung bringt.",
            question: "Worauf wartest du gerade, statt es zu erzeugen?",
            teaser: "Warten sieht aus wie Geduld." },
          { name: "Haken", title: "Der Einwand: 16 Stunden Spielen ist kein Rezept", duration: 420,
            hostNote: "Vorlesen. Danach: Was heißt das für eure Lage?",
            description: "Wer sagt, er spiele sechzehn Stunden am Tag und deshalb könne niemand mithalten, beschreibt eine Persönlichkeit und keine Methode. Diese Sätze stammen fast immer von Menschen ohne Betreuungspflichten, mit guter Gesundheit und voller Verfügung über den eigenen Kalender.\n\nWer Kinder großzieht, jemanden pflegt, chronisch krank ist oder mit einer Aufmerksamkeitsstörung lebt, verliert diesen Wettbewerb nicht aus Mangel an Leidenschaft. Er spielt ein anderes Spiel, mit anderen Einsätzen.\n\nUnd noch etwas fehlt in solchen Erzählungen fast immer: das verlorene Vermögen, die Partner, die einen hintergangen haben, die Jahre ohne Ergebnis. Rückblickend wird daraus ein Nebensatz. Erlebt wurde es anders.\n\nDie brauchbare Fassung lautet nicht „spiel mehr“, sondern: Findet die Stelle, an der es euch nichts abverlangt, und bleibt dort — in eurem Maß.",
            teaser: "Eine Persönlichkeit ist keine Methode." },
          { name: "Stille", title: "Drei Minuten Atem", duration: 180,
            hostNote: "Timer. Nicht reden.",
            description: "Drei Minuten nichts.",
            teaser: "Drei Minuten nichts." },
          { name: "Wofür man dich anruft", title: "Bist du findbar?", duration: 840,
            hostNote: "Beide nacheinander. Am Ende formuliert jede:r einen Satz, den andere weitererzählen könnten.",
            description: "Die vierte Art von Glück braucht eine Voraussetzung: Man muss wissen, wofür man euch fragen kann. Das ist keine Frage von Bekanntheit, sondern von Klarheit.\n\nProbiert es aus: Wofür seid ihr die Person, die man anruft? Wenn niemand anruft — wofür wolltet ihr es sein?\n\nDann die harte Prüfung: Formuliert einen Satz, den jemand über euch weitererzählen könnte, ohne zu stocken. Nicht euren Beruf. Etwas Konkretes, an dem ein Bedarf hängt.\n\nWenn der Satz zu allgemein wird — „ich mache irgendwas mit Medien“ —, ist das kein Formulierungsproblem. Dann seid ihr für niemanden findbar, und Glück der vierten Art kann euch nicht erreichen.",
            question: "Wofür bist du die Person, die man anruft?",
            teaser: "Wer nicht findbar ist, wird nicht gefunden." },
          { name: "Zu früh aufgehört", title: "Was hast du abgebrochen?", duration: 600,
            hostNote: "Beide nacheinander. Kein Trösten.",
            description: "Fast jeder hat etwas abgebrochen, kurz bevor es angefangen hätte zu tragen: ein Projekt, ein Instrument, ein Schreibvorhaben, eine Zusammenarbeit, eine Gewohnheit.\n\nGeht ehrlich zurück: Was war es? Und woran habt ihr gemerkt, dass ihr aufhören wolltet — an fehlenden Ergebnissen oder daran, dass ihr angefangen habt mitzuzählen?\n\nDas ist der eigentliche Befund dieser Station. Wer mitzählt, hat den Ausstieg schon eingeleitet. Nicht weil Zählen schadet, sondern weil es fast immer dann anfängt, wenn die Sache aufgehört hat, sich selbst zu tragen.\n\nUnd zum Schluss die Frage, die nach vorne zeigt: Zählt ihr gerade irgendwo mit?",
            question: "Wo zählst du gerade mit?",
            teaser: "Wer mitzählt, hat den Ausstieg eingeleitet." },
          { name: "Brücke", title: "Die Hälfte ist geschafft", duration: 300,
            hostNote: "Vorlesen. Danach kurz: Macht ihr weiter? Termin bestätigen.",
            description: "Damit endet der erste Teil der Reise. Sechs Abende über Wohlstand, Urteilskraft und Hebel — alles Fragen nach außen.\n\nDie letzten vier drehen sich um. Sie handeln von Ruhe, von Wünschen, von Neid, vom Körper und von Freiheit. Der Grund für diese Reihenfolge ist nüchtern: Über inneren Frieden zu reden, solange die Geldfrage ungelöst im Raum steht, funktioniert selten. Umgekehrt bringt gelöstes Geld allein auch keine Ruhe — sonst wäre der zweite Teil überflüssig.\n\nEin guter Moment, um kurz Bilanz zu ziehen: Was hat sich in sechs Abenden tatsächlich geändert?",
            teaser: "Sechs Abende nach außen, vier nach innen." },
          { name: "Schritt", title: "Macht euch findbar", duration: 420,
            hostNote: "Beide legen sich fest: welche drei Menschen, welcher Satz. Aufschreiben.",
            description: "Sagt drei Menschen ausdrücklich, wofür ihr die Ansprechperson seid — mit dem Satz, den ihr vorhin formuliert habt. Menschen, die es weitererzählen können.\n\nErledigt ist es, wenn drei Leute den Satz wiedergeben könnten.\n\nWas ihr dabei lernt: wie unkonkret der Satz noch ist. Fast alle merken es erst, wenn sie ihn zum zweiten Mal aussprechen.",
            teaser: "Drei Menschen, ein Satz." },
          { name: "Wort", title: "Ein Wort, mit dem ihr geht", duration: 240,
            hostNote: "Reihum, ohne Erklärung.",
            description: "Ein Wort für das, was hängen bleibt.",
            teaser: "Ein Wort, keine Erklärung." }
      ...
      solo: {
        ...
        stations: withFeedback([
          { name: "Öffnen", title: "Ein Moment für dich", duration: 120,
            description: "Papier bereit. Zuerst der Rückblick: Hast du etwas gebaut, das ein zweites Mal funktioniert hat? Und hast du etwas abgegeben?",
            teaser: "Was hast du tatsächlich abgegeben?" },
          { name: "Ankommen", title: "Was tust du, ohne dass jemand es verlangt?", duration: 240,
            question: "Was hast du in den letzten vier Wochen getan, ohne dass jemand es verlangt hat — und ohne dass es jemandem aufgefallen wäre?",
            description: "Der Zusatz ist entscheidend. Gesucht ist nicht das, wofür du gelobt wurdest, sondern das, was du auch ohne Publikum getan hättest. Oft ist es peinlich klein.",
            teaser: "Was du auch ohne Publikum getan hättest." },
          { name: "Einstieg", title: "Warum niemand gegen Spielen ankommt", duration: 240,
            description: "Wettbewerb entsteht durch Nachahmung. Wer etwas tut, das eine Verlängerung seiner selbst ist, hat keine direkten Konkurrenten — nicht aus Überlegenheit, sondern weil es sich nicht kopieren lässt.\n\nDer Weg aus dem Wettbewerb führt über Eigenart, nicht über Anstrengung. Und: Es dauert länger, als alle denken. Wer mitzählt, hört auf, bevor es sich verzinst.",
            teaser: "Aus dem Wettbewerb führt Eigenart." },
          { name: "Modell", title: "Vier Arten von Glück", duration: 300,
            description: "Nur die erste ist Zufall. Die anderen drei sind Verhalten — und deshalb lernbar. Ordne ein: welche nutzt du gerade tatsächlich?",
            items: [
              { accent: "1.", label: "Blindes Glück", text: "Es passiert einfach. Darauf kann man nur warten." },
              { accent: "2.", label: "Glück durch Bewegung", text: "Wer viel anfängt und ausprobiert, erzeugt genug Zufälle, dass einer trifft." },
              { accent: "3.", label: "Glück durch Erkennen", text: "Wer tief in einem Feld steckt, sieht Gelegenheiten, die für andere unsichtbar sind." },
              { accent: "4.", label: "Glück durch Ruf", text: "Du wirst gesucht, weil du für etwas bekannt bist." }
            ],
            teaser: "Nur die erste Art ist Zufall." },
          { name: "Nach Arbeit aussehen", title: "Was fällt dir leicht, das andere anstrengt?", duration: 480,
            question: "Was tust du, das für andere nach Arbeit aussieht?",
            description: "Denk an konkrete Momente, in denen jemand gesagt hat: „Das könnte ich nicht.“ „Wie hältst du das aus?“ „Dafür hätte ich keine Geduld.“\n\nSolche Sätze sind Messpunkte. Sie zeigen die Stelle, an der deine Normalität für andere anstrengend ist. Schreib drei davon auf, mit Situation.",
            teaser: "„Das könnte ich nicht“ ist ein Messpunkt." },
          { name: "Warten", title: "Wo wartest du auf blindes Glück?", duration: 360,
            question: "Worauf wartest du gerade, statt es zu erzeugen?",
            description: "Es gibt in fast jedem Leben eine Stelle, an der man wartet: auf den Anruf, die Gelegenheit, den richtigen Zeitpunkt, dass jemand es endlich merkt.\n\nWarten fühlt sich vernünftig an, weil es nach Geduld aussieht. Meistens ist es die einzige Art von Glück, die man nicht beeinflussen kann.\n\nBenenn deine Wartestelle. Und dann: Was wäre die kleinste Bewegung, die diese Woche etwas anrührt?",
            teaser: "Warten sieht aus wie Geduld." },
          { name: "Haken", title: "Der Einwand: 16 Stunden Spielen ist kein Rezept", duration: 240,
            description: "Wer sagt, er spiele sechzehn Stunden am Tag, beschreibt eine Persönlichkeit und keine Methode — und meistens eine ohne Betreuungspflichten, mit guter Gesundheit und voller Kalenderhoheit.\n\nWer Kinder großzieht, jemanden pflegt oder chronisch krank ist, verliert diesen Wettbewerb nicht aus Mangel an Leidenschaft.\n\nDie brauchbare Fassung lautet nicht „spiel mehr“, sondern: Finde die Stelle, an der es dir nichts abverlangt, und bleib dort — in deinem Maß.",
            teaser: "Eine Persönlichkeit ist keine Methode." },
          { name: "Wofür man dich anruft", title: "Bist du findbar?", duration: 480,
            question: "Wofür bist du die Person, die man anruft?",
            description: "Die vierte Art von Glück braucht eine Voraussetzung: Man muss wissen, wofür man dich fragen kann. Keine Frage von Bekanntheit, eine Frage von Klarheit.\n\nFormuliere einen Satz, den jemand über dich weitererzählen könnte, ohne zu stocken. Nicht deinen Beruf — etwas Konkretes, an dem ein Bedarf hängt.\n\nWird der Satz zu allgemein, ist das kein Formulierungsproblem: Dann bist du für niemanden findbar.",
            teaser: "Wer nicht findbar ist, wird nicht gefunden." },
          { name: "Zu früh aufgehört", title: "Was hast du abgebrochen?", duration: 360,
            question: "Wo zählst du gerade mit?",
            description: "Fast jeder hat etwas abgebrochen, kurz bevor es getragen hätte. Was war es?\n\nUnd woran hast du gemerkt, dass du aufhören wolltest — an fehlenden Ergebnissen oder daran, dass du angefangen hast mitzuzählen?\n\nWer mitzählt, hat den Ausstieg schon eingeleitet. Nicht weil Zählen schadet, sondern weil es meist dann anfängt, wenn die Sache aufgehört hat, sich selbst zu tragen.",
            teaser: "Wer mitzählt, hat den Ausstieg eingeleitet." },
          { name: "Ausblick", title: "Die Hälfte ist geschafft", duration: 180,
            description: "Sechs Abende über Wohlstand, Urteilskraft und Hebel — alles Fragen nach außen. Die letzten vier drehen sich um: Ruhe, Wünsche, Neid, Körper, Freiheit.\n\nDer Grund für die Reihenfolge ist nüchtern: Über inneren Frieden zu reden, solange die Geldfrage ungelöst ist, funktioniert selten. Umgekehrt bringt gelöstes Geld allein auch keine Ruhe.\n\nGuter Moment für eine kurze Bilanz: Was hat sich in sechs Abenden tatsächlich geändert?",
            teaser: "Sechs nach außen, vier nach innen." },
          { name: "Schritt", title: "Mach dich findbar", duration: 180,
            description: "Sag drei Menschen ausdrücklich, wofür du die Ansprechperson bist — mit deinem Satz von vorhin. Menschen, die es weitererzählen können.\n\nErledigt ist es, wenn drei Leute den Satz wiedergeben könnten.",
            teaser: "Drei Menschen, ein Satz." },
          { name: "Wort", title: "Ein Wort als Anker", duration: 120,
            description: "Ein Wort ins Notizbuch.",
            teaser: "Ein Wort, aufgeschrieben." }
  ...
  frei_reise_7: {
    ...
    formats: {
      pair: {
        ...
        stations: withFeedback([
          { name: "Öffnen", title: "Ein Moment, bevor ihr anfangt", duration: 180,
            hostNote: "Handys weg, drei Atemzüge. Heute geht es nach innen — sagt vorher, dass niemand etwas erreichen muss.",
            description: "Die ersten sechs Abende hatten Ergebnisse: Listen, Zahlen, Absagen. Dieser hat keine. Er wird sich deshalb zwischendurch unproduktiv anfühlen, und das ist richtig so.\n\nEin Hinweis vorweg: Wenn einer von euch gerade in einer schweren Phase steckt — Erschöpfung, Trauer, eine Depression —, dann sind die Fragen heute keine Aufgaben. Dann darf man sie liegen lassen und einfach zuhören.",
            teaser: "Heute gibt es nichts zu erreichen." },
          { name: "Ankommen", title: "Wann warst du zuletzt ganz da?", duration: 480,
            hostNote: "Beide nacheinander, je vier Minuten. Nur zuhören.",
            question: "Wann warst du zuletzt vollständig da — Datum und Situation, nicht ein Gefühl?",
            description: "Nicht „im Urlaub“ und nicht „bei den Kindern manchmal“. Ein Moment, an den ihr euch erinnert, mit Ort und Anlass.\n\nWer keinen findet, hat ein Ergebnis. Es ist bei mehr Menschen so, als man denkt, und es ist der eigentliche Grund für diesen Abend.",
            teaser: "Datum und Ort, nicht ein Gefühl." },
          { name: "Einstieg", title: "Ruhe ist nicht Freude", duration: 480,
            hostNote: "Vorlesen. Danach kurz: Welches von beidem sucht ihr eigentlich?",
            description: "Die meisten Menschen sagen Glück und meinen Freude — Höhepunkte, gute Nachrichten, etwas, das man erlebt. Freude ist aber ihrer Natur nach vorübergehend, und sie trägt ihr Gegenteil in sich: Wo es Hochstimmung gibt, gibt es Absturz.\n\nRuhe funktioniert anders. Sie ist kein Erlebnis, sondern die Abwesenheit von Mangel — der Zustand, in dem der Kopf aufhört, in die Zukunft und die Vergangenheit zu laufen.\n\nDas Praktische daran: Freude kann man kaum planen. Den Grundpegel an Ruhe kann man verschieben, langsam und ziemlich zuverlässig, wie Ausdauer beim Laufen. Nur dauert es ähnlich lange und niemand sieht es von außen.",
            teaser: "Freude ist ein Erlebnis. Ruhe ist ein Pegel." },
          { name: "Modell", title: "Vier Sätze, die zusammengehören", duration: 420,
            hostNote: "Vorlesen. Danach: bei welchem spürt ihr Widerstand? Der ist der interessanteste.",
            description: "Diese vier bauen aufeinander auf. Der letzte ist der unbequemste.",
            items: [
              { accent: "1.", label: "Wunsch als Vertrag", text: "Jeder Wunsch ist eine Abmachung mit dir: unzufrieden zu sein, bis er erfüllt ist." },
              { accent: "2.", label: "Ruhe statt Freude", text: "Glück ist hier nicht Hochstimmung, sondern der Zustand, in dem nichts fehlt." },
              { accent: "3.", label: "Gewöhnung", text: "Fast alles, was du erreichst, wird innerhalb von Wochen normal. Danach zählt es nicht mehr." },
              { accent: "4.", label: "Der Zielkonflikt", text: "Erfolg entsteht aus Unzufriedenheit, Ruhe aus Zufriedenheit. Beides zugleich geht nicht." }
            ],
            teaser: "Vier Sätze, der letzte tut weh." },
          { name: "Die Liste", title: "Alles, was du gerade willst", duration: 720,
            hostNote: "Zuerst jede:r fünf Minuten allein schreiben, dann streichen, dann vorlesen. Nicht kommentieren.",
            description: "Schreibt auf, was ihr gerade wollt. Wirklich alles — beruflich, materiell, körperlich, in Beziehungen, im Kopf. Zwanzig Zeilen sind nicht zu viel.\n\nDann streicht. Nicht nach Wichtigkeit, sondern nach dieser Frage: Bin ich bereit, bis dahin unzufrieden zu sein? Was diese Frage nicht besteht, fliegt raus.\n\nStreicht weiter, bis einer übrig ist.\n\nDas Ergebnis ist selten das, was oben stand. Und der Weg dorthin ist unangenehm, weil man merkt, wie viele Wünsche man mit sich herumträgt, die man nie bewusst gewählt hat.",
            question: "Welcher eine Wunsch bleibt übrig?",
            teaser: "Streichen, bis einer übrig ist." },
          { name: "Danach", title: "Was du bekommen hast", duration: 720,
            hostNote: "Beide nacheinander. Die andere Person fragt nur: Wie lange hat es gehalten?",
            description: "Nehmt etwas, das ihr euch wirklich gewünscht und tatsächlich bekommen habt. Eine Wohnung, eine Stelle, ein Gerät, eine Beziehung, ein Abschluss.\n\nUnd dann die einzige Frage, auf die es hier ankommt: Wie lange hat die Freude gehalten? Nicht die Zufriedenheit im Rückblick — die Freude.\n\nBei den meisten Dingen liegt die Antwort zwischen zwei Tagen und drei Wochen. Bei manchen war sie schon vor dem Bekommen vorbei.\n\nDas ist kein Grund zum Zynismus. Es ist eine Information über die Bauart des Menschen: Wir sind auf Streben gebaut, nicht auf Ankommen. Wer das weiß, wählt seine Wünsche anders — und hört auf, den nächsten für den entscheidenden zu halten.",
            question: "Wie lange hat die Freude gehalten?",
            teaser: "Zwei Tage bis drei Wochen, meistens." },
          { name: "Haken", title: "Der Einwand: hier ist Vorsicht geboten", duration: 420,
            hostNote: "Vorlesen. Wichtig: langsam und ohne Kommentar danach. Diese Station steht für sich.",
            description: "Der Satz „Glück ist eine Entscheidung“ ist als Trainingsprinzip brauchbar und als Diagnose gefährlich.\n\nAls Training heißt er: Der Grundpegel lässt sich über Jahre verschieben, durch Gewohnheiten, Umgebung, Umgang mit den eigenen Gedanken. Das stimmt und ist gut belegt.\n\nAls Diagnose heißt er etwas anderes: Wer nicht ruhig ist, hat sich falsch entschieden. Bei einer Depression, nach einem Verlust, in einer Erschöpfung ist dieser Satz nicht nur falsch, er verschlimmert die Lage — weil er dem Zustand noch die Schuld hinzufügt.\n\nWer solche Sätze aufschreibt, spricht in aller Regel nicht über klinische Zustände. Das steht selten dabei und sollte mitgelesen werden.\n\nUnd der zweite Einwand: Ein Leben ohne Wünsche ist auch ein Leben ohne Richtung. Selbst die Verfechter der Wunschlosigkeit behalten immer einen. Die brauchbare Fassung heißt nicht „wünsche nichts“, sondern: Wähle bewusst, wofür du bereit bist, unzufrieden zu sein.",
            teaser: "Ein Trainingsprinzip, keine Diagnose." },
          { name: "Stille", title: "Zehn Minuten nichts tun", duration: 180,
            hostNote: "Drei Minuten reichen heute, wenn zehn zu viel sind. Timer stellen, nicht reden, nicht liegen.",
            description: "Sitzen, nichts tun. Kein Buch, keine Musik, kein Telefon, keine Atemtechnik.\n\nAchtet auf einen bestimmten Moment: den, in dem der Drang aufzustehen kommt. Er kommt bei den meisten nach knapp zwei Minuten. Merkt euch, wie er sich anfühlt — das ist die Unruhe, um die es an diesem Abend geht, und zwar direkt und ohne Umweg.",
            teaser: "Wartet auf den Drang aufzustehen." },
          { name: "Die Unruhe", title: "Was treibt dich, wenn nichts ansteht?", duration: 840,
            hostNote: "Beide nacheinander. Diese Station braucht Zeit — nicht abkürzen, auch wenn es stockt.",
            description: "Fast alle tragen ein leises, dauerndes Getriebensein mit sich: das Gefühl, dass gleich das Nächste dran ist, während man noch beim Jetzigen sitzt. Man merkt es am deutlichsten in genau den Momenten, in denen nichts ansteht — im Wartezimmer, im Zug, sonntagnachmittags.\n\nGeht dem nach: Wann spürt ihr es? Und was tut ihr dann? Die meisten greifen zum Telefon, und zwar bevor sie es merken.\n\nDann die eigentliche Frage: Was wäre, wenn ihr die Unruhe nicht wegmachen müsstet? Sie ist unangenehm und nicht gefährlich. Der Versuch, sie sofort zu beenden, kostet mehr Lebenszeit als sie selbst.\n\nUnd zum Schluss, konkret: Beschreibt einen Tag, wie er aussähe, wenn ihr ruhig wärt. Kein Gefühl — ein Tagesablauf, mit Uhrzeiten. Erstaunlich oft ist er näher, als man denkt, und erstaunlich oft fehlt nur eine einzige Entscheidung.",
            question: "Beschreib einen konkreten Tag, an dem du ruhig wärst.",
            teaser: "Die Unruhe ist unangenehm, nicht gefährlich." },
          { name: "Zielkonflikt", title: "Welche Seite hast du bedient?", duration: 600,
            hostNote: "Beide nacheinander. Kein Urteil — beide Seiten sind legitim.",
            description: "Erfolg entsteht aus Unzufriedenheit. Ruhe entsteht aus Zufriedenheit. Wer beides gleichzeitig maximieren will, bekommt meist keins von beidem.\n\nSchaut auf die letzten fünf Jahre: Welche Seite habt ihr bedient? Und war das eine Entscheidung oder ein Sog?\n\nDann nach vorn: Welche Seite wollt ihr die nächsten fünf Jahre bedienen? Auch hier ist beides erlaubt — Unzufriedenheit ist ein legitimer Motor, wenn man weiß, dass man ihn gewählt hat, und wenn man ein Datum hat, an dem man ihn abstellt.\n\nWer das Datum nicht nennen kann, hat es nicht gewählt.",
            question: "Welche Seite hast du die letzten fünf Jahre bedient — und war das eine Entscheidung?",
            teaser: "Beides zugleich geht nicht." },
          { name: "Brücke", title: "Wohin der nächste Abend führt", duration: 300,
            hostNote: "Vorlesen, Termin bestätigen.",
            description: "Abend 8 nimmt drei Dinge, die Ruhe zuverlässig zerstören: Neid, die falschen Menschen um einen herum, und das Ausweichen vor Entscheidungen, die längst fällig sind.\n\nDazu ein Werkzeug, das simpel klingt und fast alles abdeckt: In jeder Lage gibt es genau drei Möglichkeiten — ändern, akzeptieren oder gehen. Das ganze Elend sitzt dazwischen.",
            teaser: "Nächstes Mal: ändern, akzeptieren oder gehen." },
          { name: "Schritt", title: "Streicht eine Unruhequelle", duration: 420,
            hostNote: "Beide legen sich fest: was genau, ab wann. Aufschreiben.",
            description: "Streicht für diese eine Woche etwas, von dem ihr wisst, dass es euch unruhig macht. Eine App, eine Nachrichtenquelle, eine Gewohnheit, ein Gespräch, das ihr jeden Abend führt.\n\nNur diese Woche — das ist wichtig, sonst wird es ein Vorsatz und stirbt.\n\nErledigt ist es, wenn ihr am Sonntag beschreiben könnt, wie sich die Woche ohne die Sache angefühlt hat. Ob ihr sie danach zurückholt, ist eure Sache. Interessant ist nur, mit welcher Begründung.",
            teaser: "Eine Woche ohne. Nur eine." },
          { name: "Wort", title: "Ein Wort, mit dem ihr geht", duration: 240,
            hostNote: "Reihum, ohne Erklärung.",
            description: "Ein Wort für das, was hängen bleibt.",
            teaser: "Ein Wort, keine Erklärung." }
      ...
      solo: {
        ...
        stations: withFeedback([
          { name: "Öffnen", title: "Ein Moment für dich", duration: 120,
            description: "Papier bereit. Dieser Abend hat kein Ergebnis und wird sich zwischendurch unproduktiv anfühlen. Das ist richtig so.\n\nWenn du gerade in einer schweren Phase steckst — Erschöpfung, Trauer, eine Depression —, sind die Fragen heute keine Aufgaben. Dann darfst du sie liegen lassen.",
            teaser: "Heute gibt es nichts zu erreichen." },
          { name: "Ankommen", title: "Wann warst du zuletzt ganz da?", duration: 240,
            question: "Wann warst du zuletzt vollständig da — Datum und Situation, nicht ein Gefühl?",
            description: "Nicht „im Urlaub“. Ein Moment mit Ort und Anlass.\n\nWer keinen findet, hat ein Ergebnis. Es ist bei mehr Menschen so, als man denkt.",
            teaser: "Datum und Ort, nicht ein Gefühl." },
          { name: "Einstieg", title: "Ruhe ist nicht Freude", duration: 240,
            description: "Die meisten sagen Glück und meinen Freude — Höhepunkte, gute Nachrichten. Freude ist vorübergehend und trägt ihr Gegenteil in sich.\n\nRuhe ist kein Erlebnis, sondern die Abwesenheit von Mangel. Freude kann man kaum planen; den Grundpegel an Ruhe kann man verschieben, langsam und ziemlich zuverlässig — nur sieht es niemand von außen.",
            teaser: "Freude ist ein Erlebnis. Ruhe ist ein Pegel." },
          { name: "Modell", title: "Vier Sätze, die zusammengehören", duration: 300,
            description: "Sie bauen aufeinander auf. Bei welchem spürst du Widerstand? Der ist der interessanteste.",
            items: [
              { accent: "1.", label: "Wunsch als Vertrag", text: "Jeder Wunsch ist eine Abmachung: unzufrieden zu sein, bis er erfüllt ist." },
              { accent: "2.", label: "Ruhe statt Freude", text: "Glück ist hier nicht Hochstimmung, sondern der Zustand, in dem nichts fehlt." },
              { accent: "3.", label: "Gewöhnung", text: "Fast alles, was du erreichst, wird in Wochen normal und zählt dann nicht mehr." },
              { accent: "4.", label: "Der Zielkonflikt", text: "Erfolg entsteht aus Unzufriedenheit, Ruhe aus Zufriedenheit." }
            ],
            teaser: "Vier Sätze, der letzte tut weh." },
          { name: "Die Liste", title: "Alles, was du gerade willst", duration: 480,
            question: "Welcher eine Wunsch bleibt übrig?",
            description: "Schreib auf, was du gerade willst. Wirklich alles — beruflich, materiell, körperlich, in Beziehungen. Zwanzig Zeilen sind nicht zu viel.\n\nDann streich. Nicht nach Wichtigkeit, sondern nach dieser Frage: Bin ich bereit, bis dahin unzufrieden zu sein?\n\nStreich weiter, bis einer übrig ist. Das Ergebnis ist selten das, was oben stand.",
            teaser: "Streichen, bis einer übrig ist." },
          { name: "Danach", title: "Was du bekommen hast", duration: 360,
            question: "Wie lange hat die Freude gehalten?",
            description: "Nimm etwas, das du dir wirklich gewünscht und bekommen hast. Eine Wohnung, eine Stelle, ein Gerät, eine Beziehung.\n\nWie lange hat die Freude gehalten? Nicht die Zufriedenheit im Rückblick — die Freude. Bei den meisten Dingen: zwei Tage bis drei Wochen.\n\nDas ist kein Grund zum Zynismus, sondern eine Information über die eigene Bauart: Wir sind auf Streben gebaut, nicht auf Ankommen.",
            teaser: "Zwei Tage bis drei Wochen, meistens." },
          { name: "Haken", title: "Der Einwand: hier ist Vorsicht geboten", duration: 240,
            description: "„Glück ist eine Entscheidung“ ist als Trainingsprinzip brauchbar und als Diagnose gefährlich.\n\nAls Training: Der Grundpegel lässt sich über Jahre verschieben. Das stimmt.\n\nAls Diagnose: Wer nicht ruhig ist, hat sich falsch entschieden. Bei einer Depression, nach einem Verlust, in einer Erschöpfung ist das nicht nur falsch — es fügt dem Zustand noch Schuld hinzu.\n\nWer solche Sätze aufschreibt, spricht in aller Regel nicht über klinische Zustände. Das steht selten dabei.",
            teaser: "Ein Trainingsprinzip, keine Diagnose." },
          { name: "Die Unruhe", title: "Was treibt dich, wenn nichts ansteht?", duration: 480,
            question: "Beschreib einen konkreten Tag, an dem du ruhig wärst.",
            description: "Setz dich zuerst zehn Minuten hin und tu nichts. Kein Buch, keine Musik, kein Telefon. Achte auf den Moment, in dem der Drang aufzustehen kommt — bei den meisten nach knapp zwei Minuten.\n\nDanach schreib: Wann spürst du dieses Getriebensein sonst? Und was tust du dann? Die meisten greifen zum Telefon, bevor sie es merken.\n\nZum Schluss, konkret: ein Tagesablauf mit Uhrzeiten, wie er aussähe, wenn du ruhig wärst. Erstaunlich oft fehlt nur eine einzige Entscheidung.",
            teaser: "Die Unruhe ist unangenehm, nicht gefährlich." },
          { name: "Zielkonflikt", title: "Welche Seite hast du bedient?", duration: 360,
            question: "Welche Seite hast du die letzten fünf Jahre bedient — und war das eine Entscheidung?",
            description: "Erfolg entsteht aus Unzufriedenheit, Ruhe aus Zufriedenheit. Wer beides gleichzeitig maximieren will, bekommt meist keins.\n\nSchau auf die letzten fünf Jahre. War das eine Entscheidung oder ein Sog?\n\nDann nach vorn: Welche Seite willst du die nächsten fünf Jahre bedienen? Unzufriedenheit ist ein legitimer Motor — wenn du weißt, dass du ihn gewählt hast, und ein Datum hast, an dem du ihn abstellst. Wer das Datum nicht nennen kann, hat nicht gewählt.",
            teaser: "Beides zugleich geht nicht." },
          { name: "Ausblick", title: "Was der nächste Abend bringt", duration: 180,
            description: "Abend 8 nimmt drei Dinge, die Ruhe zuverlässig zerstören: Neid, die falschen Menschen, und das Ausweichen vor fälligen Entscheidungen.\n\nDazu ein Werkzeug, das fast alles abdeckt: ändern, akzeptieren oder gehen. Das ganze Elend sitzt dazwischen.",
            teaser: "Nächstes Mal: ändern, akzeptieren oder gehen." },
          { name: "Schritt", title: "Streich eine Unruhequelle", duration: 180,
            description: "Streich für diese eine Woche etwas, von dem du weißt, dass es dich unruhig macht: eine App, eine Nachrichtenquelle, eine Gewohnheit.\n\nNur diese Woche — sonst wird es ein Vorsatz und stirbt.\n\nErledigt, wenn du am Sonntag beschreiben kannst, wie sich die Woche ohne angefühlt hat.",
            teaser: "Eine Woche ohne. Nur eine." },
          { name: "Wort", title: "Ein Wort als Anker", duration: 120,
            description: "Ein Wort ins Notizbuch.",
            teaser: "Ein Wort, aufgeschrieben." }
  ...
  frei_reise_8: {
    ...
    formats: {
      pair: {
        ...
        stations: withFeedback([
          { name: "Öffnen", title: "Ein Moment, bevor ihr anfangt", duration: 180,
            hostNote: "Handys weg, drei Atemzüge. Zuerst der Rückblick: Habt ihr die Unruhequelle gestrichen — und zurückgeholt?",
            description: "Der Rückblick zuerst: Habt ihr die Sache eine Woche weggelassen? Habt ihr sie zurückgeholt? Und mit welcher Begründung?\n\nDie Begründung ist der interessante Teil. Fast alle sind gut, und fast keine stimmt.",
            teaser: "Die Begründung ist der interessante Teil." },
          { name: "Ankommen", title: "Auf wen bist du neidisch?", duration: 480,
            hostNote: "Beide nacheinander, je vier Minuten. Namen dürfen fallen und bleiben im Raum. Nicht relativieren.",
            question: "Auf wen bist du gerade neidisch — und worauf genau?",
            description: "Neid zuzugeben ist unangenehmer als fast alles andere an dieser Reise, weil er als kleinlich gilt. Er ist aber die zuverlässigste Auskunft darüber, was man selbst will und sich nicht eingesteht.\n\nDeshalb der zweite Teil der Frage: worauf genau. Nicht „auf sein Leben“ — auf welche einzelne Sache?",
            teaser: "Neid ist die ehrlichste Auskunft über dich." },
          { name: "Einstieg", title: "Das Leben ist kein Katalog", duration: 480,
            hostNote: "Vorlesen.",
            description: "Neid funktioniert nur, solange man auswählt. Man nimmt das Einkommen des einen, den Körper der anderen, die Gelassenheit des dritten — und stellt daraus ein Leben zusammen, das es nicht gibt.\n\nDie Probe, die den Neid meistens beendet: Würdet ihr komplett tauschen? Vollständig, sieben Tage die Woche — mit der Kindheit, der Familie, den Ängsten, dem Körper, der Vergangenheit, dem Selbstbild dieser Person.\n\nFast niemand will das. Und wer nicht komplett tauschen will, beneidet streng genommen niemanden — er hat nur einen Wunsch entdeckt und ihm den falschen Namen gegeben.\n\nDas ist der eigentliche Nutzen des Abends: aus Neid einen Wunsch machen. Wünsche kann man verfolgen. Neid kann man nur haben.",
            teaser: "Wer nicht komplett tauschen will, beneidet niemanden." },
          { name: "Modell", title: "Drei Möglichkeiten, mehr gibt es nicht", duration: 420,
            hostNote: "Vorlesen. Danach nimmt jede:r seine größte Belastung und kreuzt eines an. Nur eines.",
            description: "In jeder Lage gibt es genau drei Wege. Der vierte, den fast alle nehmen, ist keiner.",
            items: [
              { accent: "1.", label: "Ändern", text: "Du greifst ein. Das ist ein Wunsch — er kostet Kraft und macht unruhig, bis er erfüllt ist. Nimm dir nicht zu viele davon gleichzeitig." },
              { accent: "2.", label: "Akzeptieren", text: "Du findest dich damit ab, wirklich und ohne Groll. Nicht Aufgeben — Aufhören zu kämpfen." },
              { accent: "3.", label: "Gehen", text: "Du verlässt die Situation. Oft die ehrlichste und fast immer die gefürchtetste Option." },
              { accent: "4.", label: "Dazwischen", text: "Wünschen, es wäre anders, ohne zu handeln. Hier sitzt der Großteil allen Unglücks." }
            ],
            teaser: "Drei Wege. Der vierte ist keiner." },
          { name: "Der Tausch", title: "Würdest du komplett tauschen?", duration: 720,
            hostNote: "Beide nacheinander. Die andere Person zählt konsequent auf, was zum Paket gehört: Kindheit, Familie, Gesundheit, Ängste, Vergangenheit.",
            description: "Nehmt eure Person von vorhin. Und dann geht das ganze Paket durch — nicht abstrakt, sondern Posten für Posten.\n\nDeren Kindheit. Deren Eltern. Deren Ehe oder deren Alleinsein. Deren Gesundheit, auch die Teile, die man nicht sieht. Deren Ängste um drei Uhr nachts. Deren Selbstbild. Deren Vergangenheit, mit allem, was darin nicht mehr zu ändern ist.\n\nWürdet ihr tauschen? Vollständig?\n\nWenn nein — und es ist fast immer nein — dann übersetzt: Was genau wolltet ihr eigentlich? Formuliert es als Wunsch, in einem Satz, in eurem eigenen Leben.",
            question: "Was wolltest du wirklich — und wie heißt das als Wunsch in deinem Leben?",
            teaser: "Aus Neid einen Wunsch machen." },
          { name: "Die Fünf", title: "Mit wem verbringst du deine Zeit?", duration: 720,
            hostNote: "Zuerst jede:r allein schreiben, dann vorlesen. Hier wird es unangenehm — nicht abmildern.",
            description: "Schreibt die fünf Menschen auf, mit denen ihr die meiste Zeit verbringt. Nicht die liebsten, nicht die wichtigsten — die meiste Zeit. Kollegen zählen. Menschen aus dem Internet, deren Stimme ihr täglich hört, zählen auch.\n\nDann drei Fragen zu jedem: Zieht dich diese Person hoch oder runter? Kostet die Beziehung Pflege oder trägt sie sich? Bewunderst du sie — oder beneidest du sie?\n\nDie letzte Unterscheidung ist die wichtigste. Bewunderung zieht nach oben, Neid zieht nach unten, und von außen sehen sie gleich aus.\n\nUnd zum Schluss die Frage, die man ungern stellt: In wessen Fünferliste steht ihr — und was seid ihr dort, der Hochzieher oder der andere?",
            question: "In wessen Fünferliste stehst du — und was bist du dort?",
            teaser: "Nicht die liebsten. Die meiste Zeit." },
          { name: "Haken", title: "Der Einwand: Akzeptanz und Aussortieren", duration: 420,
            hostNote: "Vorlesen. Danach: Trifft einer der beiden Punkte auf euch zu?",
            description: "Zwei Werkzeuge dieses Abends lassen sich hervorragend missbrauchen.\n\nAkzeptanz ist das eine. Zwischen „ich akzeptiere, was ich nicht ändern kann“ und „ich finde mich mit etwas ab, das ich ändern könnte“ liegt der ganze Unterschied — und von innen fühlen sich beide gleich ruhig an. Deshalb ist die Dreiteilung so wichtig: Akzeptanz zählt nur, wenn ihr vorher ehrlich geprüft habt, ob Ändern oder Gehen möglich wäre. Das Wort allein ist eine Ausrede mit gutem Ruf.\n\nDas andere ist die Fünferliste. Der Rat, sich von Menschen zu trennen, die einen runterziehen, klingt nach Selbstfürsorge und ist manchmal genau das. Manchmal ist er aber Feigheit im Gewand der Achtsamkeit — jemanden fallen zu lassen, weil er gerade unglücklich ist, ist keine Grenzziehung, sondern Schönwetterfreundschaft. Der Unterschied liegt darin, ob die Person euch schadet oder ob sie euch nur gerade nichts gibt.\n\nBei Menschen, die es schwer haben, ist die richtige Frage selten „wegräumen oder nicht“, sondern: Wie viel kann ich tragen, ohne selbst unterzugehen?",
            teaser: "Akzeptanz ist eine Ausrede mit gutem Ruf." },
          { name: "Stille", title: "Drei Minuten Atem", duration: 180,
            hostNote: "Timer. Nicht reden.",
            description: "Drei Minuten nichts, bevor es an die Belastung geht.",
            teaser: "Drei Minuten nichts." },
          { name: "Die Belastung", title: "Ändern, akzeptieren oder gehen", duration: 840,
            hostNote: "Beide nacheinander, je zwölf Minuten. Am Ende benennt jede:r eine der drei Optionen laut — und was sie konkret bedeutet.",
            description: "Nehmt eure größte aktuelle Belastung. Die eine, die seit Monaten mitläuft.\n\nErst die ehrliche Bestandsaufnahme: Wie lange geht das schon? Und in welcher der drei Optionen sitzt ihr gerade — oder sitzt ihr dazwischen?\n\nDann geht alle drei durch, auch die, die ihr sofort verwerfen wollt:\n\nÄndern — was genau wäre der Eingriff? Was kostet er, und traut ihr euch das zu?\n\nAkzeptieren — könntet ihr wirklich aufhören zu kämpfen? Nicht resignieren, sondern es sein lassen, ohne innerlich weiter dagegen zu arbeiten?\n\nGehen — was hält euch? Und ist das ein Grund oder eine Gewohnheit?\n\nEs geht nicht darum, heute die Lösung zu finden. Es geht darum, aus dem Dazwischen herauszukommen, denn dort kostet es am meisten und bringt am wenigsten.",
            question: "In welcher der drei Optionen sitzt du — und in welche willst du?",
            teaser: "Dazwischen kostet am meisten." },
          { name: "Fünf Jahre", title: "Was fiele sofort weg?", duration: 600,
            hostNote: "Beide nacheinander. Ruhig, ohne Dramatik — das ist eine Sortierübung, keine Trauerübung.",
            description: "Eine Frage, die überraschend nüchtern beantwortet werden kann, wenn man sie nicht pathetisch nimmt: Wenn ihr noch fünf Jahre hättet — was fiele sofort weg?\n\nMeistens ist die Liste kurz und eindeutig. Bestimmte Verpflichtungen, bestimmte Menschen, ein bestimmter Teil der Arbeit, eine bestimmte Sorge um die Meinung anderer.\n\nUnd dann der eigentliche Punkt, der unbequem ist: Warum ist es dann jetzt noch da?\n\nEs gibt gute Antworten darauf — Geld, Verantwortung, andere Menschen, die davon abhängen. Es gibt auch schlechte, und die klingen fast genauso. Sortiert einmal ehrlich durch.",
            question: "Wenn du noch fünf Jahre hättest, was fiele sofort weg — und warum ist es jetzt noch da?",
            teaser: "Die Liste ist meistens kurz und eindeutig." },
          { name: "Brücke", title: "Wohin der nächste Abend führt", duration: 300,
            hostNote: "Vorlesen, Termin bestätigen.",
            description: "Abend 9 wird sehr konkret: der Körper. Warum Gesundheit vor Glück, Familie und Arbeit steht — nicht aus Egoismus, sondern weil alles andere darauf aufsitzt.\n\nUnd der ehrlichste Satz über Gewohnheiten, den diese Reise zu bieten hat: Wenn du etwas wirklich willst, tust du es. „Ich versuche“ heißt, du willst noch nicht.",
            teaser: "Nächstes Mal: der Körper zuerst." },
          { name: "Schritt", title: "Eine Woche umdeuten", duration: 420,
            hostNote: "Beide legen sich fest. Zettel oder Notiz-App, jedes Mal ein Eintrag.",
            description: "Immer wenn ihr euch in dieser Woche über etwas Kleines ärgert — Stau, Verspätung, ein schnippischer Satz, eine verlorene Viertelstunde —, benennt ihr laut oder schriftlich, was daran gut ist. Jedes Mal.\n\nDas fühlt sich anfangs albern und erzwungen an. Genau so soll es sein: Ihr trainiert einen Reflex, keine Haltung.\n\nErledigt ist es, wenn mindestens zehn Einträge dastehen.\n\nWas ihr dabei beobachten sollt: wie lange ihr braucht. Am Anfang mehrere Sekunden. Wer es lange genug macht, kommt irgendwann auf Sekundenbruchteile — und dann ist es keine Übung mehr, sondern die Art, wie man Dinge sieht.",
            teaser: "Zehn Einträge. Und messt die Zeit." },
          { name: "Wort", title: "Ein Wort, mit dem ihr geht", duration: 240,
            hostNote: "Reihum, ohne Erklärung.",
            description: "Ein Wort für das, was hängen bleibt.",
            teaser: "Ein Wort, keine Erklärung." }
      ...
      solo: {
        ...
        stations: withFeedback([
          { name: "Öffnen", title: "Ein Moment für dich", duration: 120,
            description: "Papier bereit. Zuerst der Rückblick: Hast du die Unruhequelle eine Woche weggelassen? Hast du sie zurückgeholt — und mit welcher Begründung?\n\nDie Begründung ist der interessante Teil. Fast alle sind gut, und fast keine stimmt.",
            teaser: "Die Begründung ist der interessante Teil." },
          { name: "Ankommen", title: "Auf wen bist du neidisch?", duration: 240,
            question: "Auf wen bist du gerade neidisch — und worauf genau?",
            description: "Neid zuzugeben ist unangenehm, weil er als kleinlich gilt. Er ist aber die zuverlässigste Auskunft darüber, was du willst und dir nicht eingestehst.\n\nDeshalb der zweite Teil: worauf genau. Nicht „auf sein Leben“ — auf welche einzelne Sache?",
            teaser: "Neid ist die ehrlichste Auskunft über dich." },
          { name: "Einstieg", title: "Das Leben ist kein Katalog", duration: 240,
            description: "Neid funktioniert nur, solange man auswählt: das Einkommen des einen, den Körper der anderen, die Gelassenheit des dritten.\n\nDie Probe: Würdest du komplett tauschen — mit Kindheit, Familie, Ängsten, Vergangenheit, Selbstbild?\n\nFast niemand will das. Und wer nicht komplett tauschen will, beneidet streng genommen niemanden. Er hat einen Wunsch entdeckt und ihm den falschen Namen gegeben.",
            teaser: "Wer nicht komplett tauschen will, beneidet niemanden." },
          { name: "Modell", title: "Drei Möglichkeiten, mehr gibt es nicht", duration: 300,
            description: "In jeder Lage gibt es genau drei Wege. Der vierte, den fast alle nehmen, ist keiner. Nimm deine größte Belastung und kreuze eines an.",
            items: [
              { accent: "1.", label: "Ändern", text: "Du greifst ein. Das ist ein Wunsch — er macht unruhig, bis er erfüllt ist." },
              { accent: "2.", label: "Akzeptieren", text: "Du findest dich ab, wirklich und ohne Groll. Nicht Aufgeben — Aufhören zu kämpfen." },
              { accent: "3.", label: "Gehen", text: "Du verlässt die Situation. Oft die ehrlichste, fast immer die gefürchtetste Option." },
              { accent: "4.", label: "Dazwischen", text: "Wünschen, es wäre anders, ohne zu handeln. Hier sitzt der Großteil allen Unglücks." }
            ],
            teaser: "Drei Wege. Der vierte ist keiner." },
          { name: "Der Tausch", title: "Würdest du komplett tauschen?", duration: 480,
            question: "Was wolltest du wirklich — und wie heißt das als Wunsch in deinem Leben?",
            description: "Nimm deine Person von vorhin und geh das ganze Paket durch, Posten für Posten: deren Kindheit, deren Eltern, deren Gesundheit auch da, wo man sie nicht sieht, deren Ängste um drei Uhr nachts, deren Vergangenheit.\n\nWürdest du tauschen? Vollständig?\n\nWenn nein — und es ist fast immer nein — übersetz: Was wolltest du eigentlich? Formulier es als Wunsch, in einem Satz, in deinem eigenen Leben.",
            teaser: "Aus Neid einen Wunsch machen." },
          { name: "Die Fünf", title: "Mit wem verbringst du deine Zeit?", duration: 360,
            question: "In wessen Fünferliste stehst du — und was bist du dort?",
            description: "Schreib die fünf Menschen auf, mit denen du die meiste Zeit verbringst. Nicht die liebsten — die meiste Zeit. Kollegen zählen, Stimmen aus dem Internet auch.\n\nZu jedem drei Fragen: Zieht dich diese Person hoch oder runter? Kostet die Beziehung Pflege oder trägt sie sich? Bewunderst du sie — oder beneidest du sie?\n\nDie letzte Unterscheidung ist die wichtigste. Bewunderung zieht nach oben, Neid nach unten, und von außen sehen sie gleich aus.",
            teaser: "Nicht die liebsten. Die meiste Zeit." },
          { name: "Haken", title: "Der Einwand: Akzeptanz und Aussortieren", duration: 240,
            description: "Akzeptanz lässt sich missbrauchen. Zwischen „ich akzeptiere, was ich nicht ändern kann“ und „ich finde mich mit etwas ab, das ich ändern könnte“ liegt alles — und von innen fühlt sich beides gleich ruhig an. Deshalb zählt Akzeptanz nur, wenn du vorher geprüft hast, ob Ändern oder Gehen möglich wäre.\n\nUnd die Fünferliste: Menschen fallen zu lassen, weil sie gerade unglücklich sind, ist keine Grenzziehung, sondern Schönwetterfreundschaft. Der Unterschied liegt darin, ob jemand dir schadet oder dir nur gerade nichts gibt.",
            teaser: "Akzeptanz ist eine Ausrede mit gutem Ruf." },
          { name: "Die Belastung", title: "Ändern, akzeptieren oder gehen", duration: 480,
            question: "In welcher der drei Optionen sitzt du — und in welche willst du?",
            description: "Nimm deine größte aktuelle Belastung, die eine, die seit Monaten mitläuft. Wie lange geht das schon? Und sitzt du gerade dazwischen?\n\nGeh alle drei durch, auch die, die du sofort verwerfen willst.\n\nÄndern — was genau wäre der Eingriff, was kostet er?\n\nAkzeptieren — könntest du wirklich aufhören zu kämpfen, ohne innerlich weiter dagegen zu arbeiten?\n\nGehen — was hält dich? Ist das ein Grund oder eine Gewohnheit?\n\nEs geht nicht um die Lösung heute. Es geht darum, aus dem Dazwischen herauszukommen.",
            teaser: "Dazwischen kostet am meisten." },
          { name: "Fünf Jahre", title: "Was fiele sofort weg?", duration: 360,
            question: "Wenn du noch fünf Jahre hättest, was fiele sofort weg — und warum ist es jetzt noch da?",
            description: "Nüchtern beantwortbar, wenn man sie nicht pathetisch nimmt. Meistens ist die Liste kurz: bestimmte Verpflichtungen, bestimmte Menschen, ein Teil der Arbeit, die Sorge um fremde Meinungen.\n\nDann der unbequeme Teil: Warum ist es dann jetzt noch da? Es gibt gute Antworten — Geld, Verantwortung, Menschen, die davon abhängen. Und schlechte, die fast genauso klingen.",
            teaser: "Die Liste ist meistens kurz." },
          { name: "Ausblick", title: "Was der nächste Abend bringt", duration: 180,
            description: "Abend 9 wird konkret: der Körper. Warum Gesundheit vor Glück, Familie und Arbeit steht — nicht aus Egoismus, sondern weil alles andere darauf aufsitzt.\n\nUnd der ehrlichste Satz dieser Reise über Gewohnheiten: Wenn du etwas wirklich willst, tust du es.",
            teaser: "Nächstes Mal: der Körper zuerst." },
          { name: "Schritt", title: "Eine Woche umdeuten", duration: 180,
            description: "Immer wenn du dich über etwas Kleines ärgerst, benenn schriftlich, was daran gut ist. Jedes Mal.\n\nDas fühlt sich anfangs albern an. Genau so soll es sein — du trainierst einen Reflex, keine Haltung.\n\nErledigt bei mindestens zehn Einträgen. Und miss, wie lange du brauchst: Am Anfang mehrere Sekunden, später Sekundenbruchteile.",
            teaser: "Zehn Einträge. Und miss die Zeit." },
          { name: "Wort", title: "Ein Wort als Anker", duration: 120,
            description: "Ein Wort ins Notizbuch.",
            teaser: "Ein Wort, aufgeschrieben." }
        ])
