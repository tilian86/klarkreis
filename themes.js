...
,
  ...
  wir_reise_2: {
    ...
    philosophy1: 'Gottmans Daten sind nüchtern: 67 Prozent der Paare erleben nach der ersten Elternschaft einen jähen Einbruch der Beziehungsqualität. Das eine Drittel, das ihn nicht erlebt, hat eine messbare Gemeinsamkeit: detaillierte Liebeslandkarten. Sie wissen, wie der andere innerlich tickt, und sie aktualisieren dieses Wissen. Krisen werfen sie nicht aus der Bahn — weil ihre Innenkarte zur Außenwelt passt.',
    philosophy2: 'Liebeslandkarten sind nicht Trivia-Wissen („Lieblingsfarbe Blau"). Sie sind das, was Gottman „kognitiven Raum" nennt — wieviel Platz dein Kopf für die Innenwelt deines Partners reserviert. Heute prüft ihr die Genauigkeit eurer Karten und füllt die weißen Flecken. Es wird leichter als ihr denkt — und ehrlicher als ihr erwartet.',
    formats: {
      pair: {
        label: 'Zu zweit',
        duration: '~1 Std. 50 Min.',
        ...
        stations: withFeedback([
          ...
          { name: 'Rückblende', title: 'Was die Vier Reiter gemacht haben', duration: 8*60,
            hostNote: 'Beide je 3-4 Min. Nicht den anderen analysieren — nur eigenes berichten.',
          ...
          { name: 'Selbsttest', title: 'Wie genau ist deine Karte?', duration: 12*60,
            hostNote: 'Jede:r markiert für sich 20 Aussagen mit „wahr" oder „falsch". Punktet zählt nur „wahr". Über 10 Punkte = solide. Unter 10 = es liegt brach. Wichtig: ihr testet euer EIGENES Wissen, nicht den anderen.',
            ...
            items: [
              { accent: '1.', label: 'Wer ihr/ihm nah ist', text: 'Ich könnte spontan aufzählen, wer aktuell zum engsten Kreis meines Partners gehört.' },
              { accent: '2.', label: 'Womit sie/er kämpft', text: 'Mir ist klar, was meinen Partner gerade beruflich oder privat wirklich belastet.' },
              { accent: '3.', label: 'Wo es knirscht', text: 'Ich kenne mindestens eine Person, an der sich mein Partner zurzeit reibt — beim Namen.' },
              { accent: '4.', label: 'Was sie/er träumt', text: 'Ich könnte drei Dinge nennen, von denen mein Partner irgendwann einmal träumt.' },
              { accent: '5.', label: 'Was ihr/ihm heilig ist', text: 'Ich verstehe, was mein Partner glaubt — oder bewusst nicht glaubt.' },
              { accent: '6.', label: 'Wie sie/er die Welt sieht', text: 'Ich könnte den inneren Kompass meines Partners in eigenen Worten beschreiben.' },
              { accent: '7.', label: 'Familien-Reibung', text: 'Ich weiß, mit welchen Verwandten mein Partner lieber wenig zu tun hat — und warum.' },
              { accent: '8.', label: 'Was im Ohr läuft', text: 'Ich könnte sagen, welche Musik bei meinem Partner gerade in Endlosschleife rotiert.' },
              { accent: '9.', label: 'Lieblings-Filme', text: 'Drei Filme, die mein Partner immer wieder schaut — fallen mir spontan ein.' },
              { accent: '10.', label: 'Bin ich gesehen?', text: 'Mein Partner weiß, was MICH gerade umtreibt — nicht nur an der Oberfläche.' },
              { accent: '11.', label: 'Stationen des Lebens', text: 'Ich könnte drei prägende Lebensabschnitte meines Partners erzählen — chronologisch.' },
              { accent: '12.', label: 'Was prägt aus der Kindheit', text: 'Mir ist das Ereignis aus seiner/ihrer Kindheit bewusst, das bis heute nachwirkt.' },
              { accent: '13.', label: 'Was sie/er noch will', text: 'Die zentralen Hoffnungen meines Partners für die nächsten Jahre — die kenne ich.' },
              { accent: '14.', label: 'Was ihn/sie nachts plagt', text: 'Ich weiß, welche Sorgen meinen Partner um den Schlaf bringen.' },
              { accent: '15.', label: 'Meine Welt kennt sie/er', text: 'Mein Partner kennt meine engsten Bezugspersonen mit Namen und Gesicht.' },
              { accent: '16.', label: 'Plötzlich reich', text: 'Wenn ein unerwarteter Glücksfall käme — ich könnte sagen, was mein Partner damit täte.' },
              { accent: '17.', label: 'Erster Funke', text: 'Wie unser erstes Treffen war, kann ich detailliert erzählen — Kleidung, Stimmung, Ort.' },
              { accent: '18.', label: 'Aktive Neugier', text: 'Ich stelle meinem Partner regelmäßig echte Fragen — nicht nur Logistik-Fragen.' },
              { accent: '19.', label: 'Erkannt-Werden', text: 'Ich habe das Gefühl, von meinem Partner wirklich verstanden zu sein.' },
              { accent: '20.', label: 'Sie/er sieht mich', text: 'Was ich mir vom Leben erhoffe, ist meinem Partner kein Rätsel.' }
            ],
          ...
          { name: 'Das Spiel', title: 'Sechzig Fragen — ein Karten-Spiel', duration: 25*60,
            hostNote: 'Jede:r wählt zufällig 10 Zahlen zwischen 1 und 60 — schreibt sie auf zwei Zettel. Aus der Liste unten findet ihr die zugehörigen Fragen und stellt sie eurem Partner. Wenn der antwortet und ihr (als Fragesteller:in) urteilt: korrekt → Punkte für beide (Antwortpunkt für den Partner, Wisspunkt für euch). Falsch → null Punkte für beide. Wechselt nach je einer Frage. Lacht. Macht euch keinen Stress. Es geht nicht ums Gewinnen.',
          ...
          { name: 'Fünf Fragen', title: 'Wer du werden willst', duration: 18*60,
            hostNote: 'Beide schreiben 6 Min still für sich. Dann reihum je 5 Min vorlesen — der/die andere hört nur zu, fragt höchstens einmal sanft nach.',
            description: 'Fünf Fragen, die das Selbstbild eines Menschen ausmachen — inspiriert von Gottmans Selbstbild-Arbeit, aber in unserer eigenen Sprache. Wer diese Antworten seines Partners nicht weiß, kennt nur die Außenseite. Heute legt ihr die fünf nebeneinander.',
            items: [
      ...
      solo: {
        ...
        stations: withFeedback([
          { name: 'Öffnen', title: 'Allein bei dir', duration: 2*60,
            ...
            description: 'Du machst Liebeslandkarten-Arbeit allein — als Vorbereitung, als Bilanz, oder weil dein Partner nicht dabei ist. Was du findest, ist deins.' },
          { name: 'Einstieg', title: 'Erkennen heißt lieben', duration: 4*60,
            ...
            description: 'Heute prüfst du, wie aktuell deine innere Karte deines Partners ist. Lücken sind keine Schande — sie sind Material.' },
          { name: 'Selbsttest', title: 'Wie genau ist deine Karte?', duration: 10*60,
            ...
            description: 'Eine eigene Diagnose-Liste, inspiriert von Gottmans Liebeslandkarten-Forschung. 20 Aussagen über dein Wissen vom Innen-Leben deines Partners.',
            items: [
              { accent: '1.', label: 'Beste Freund:innen', text: 'Ich kann die besten Freund:innen meines Partners namentlich nennen.' },
              { accent: '2.', label: 'Aktuelle Probleme', text: 'Ich weiß, mit welchen drei Problemen sie/er gerade konfrontiert ist.' },
              { accent: '3.', label: 'Lebensträume', text: 'Ich kann drei Lebensträume meines Partners benennen.' },
              { accent: '4.', label: 'Aktuelle Ängste', text: 'Ich kenne die Ängste, die sie/ihn gerade nachts wach halten.' },
              { accent: '5.', label: 'Lebensphasen', text: 'Ich kenne drei wichtige Phasen ihres/seines Lebens.' },
              { accent: '6.', label: 'Kindheits-Schwerpunkt', text: 'Ich kann das schwerste Ereignis ihrer/seiner Kindheit benennen.' },
              { accent: '7.', label: 'Lotto-Test', text: 'Ich weiß, was sie/er bei plötzlichem Lotto-Gewinn tun würde.' },
              { accent: '8.', label: 'Aktive Neugier', text: 'Ich frage regelmäßig nach ihren/seinen Vorstellungen und Erfahrungen.' }
            ],
          ...
          { name: 'Was du nicht weißt', title: 'Drei Lücken', duration: 8*60,
            ...
            question: 'Welche drei Fragen über deinen Partner kannst du gerade nicht wirklich beantworten?' },
          { name: 'Fünf Fragen', title: 'Wer SIE oder ER werden will', duration: 10*60,
            hostNote: 'Schreibe für jede der fünf Fragen, was du glaubst, dass dein Partner antworten würde. Wo du unsicher bist, markiere mit Fragezeichen.',
            description: 'Fünf Selbstbild-Fragen — inspiriert von Gottmans Selbstbild-Arbeit. Beantworte sie aus der Sicht deines Partners. Die Fragezeichen sind die wertvollste Information.',
            items: [
              { accent: '1.', label: 'Werden', text: 'Wer will sie/er werden?' },
              { accent: '2.', label: 'Tun', text: 'Was tut sie/er konkret dafür?' },
              { accent: '3.', label: 'Dämonen', text: 'Welche inneren Widerstände kämpft sie/er?' },
              { accent: '4.', label: 'Verlorene Träume', text: 'Welche Träume hat sie/er sich nicht gegönnt?' },
              { accent: '5.', label: 'Fünf Jahre', text: 'Wie soll ihr/sein Leben in 5 Jahren aussehen?' }
            ] },
          { name: 'Eigene Bilanz', title: 'Wer du selbst werden willst', duration: 8*60,
            ...
            description: 'Jetzt umgekehrt — wer bist DU heute, wenn du diese fünf Fragen ehrlich beantwortest? Vielleicht hat dein Partner ein veraltetes Bild von dir. Das ist wertvolle Information für Abend 3.',
            question: 'Was würde dein Partner über dich raten, das nicht mehr stimmt?' },
          { name: 'Drei Fragen', title: 'Was du beim nächsten Treffen wissen willst', duration: 5*60,
            ...
            question: 'Welche drei Fragen willst du deinem Partner stellen, sobald sich Gelegenheit ergibt?' },
          { name: 'Ausblick', title: 'Was Abend 3 bringt', duration: 3*60,
            hostNote: 'Lies.',
  ...
  wir_reise_3: {
    ...
    philosophy1: 'In glücklichen Beziehungen passieren ständig zwei Dinge gleichzeitig: einer macht etwas Kleines, der/die andere bemerkt es positiv. Das nennt Gottman „die positive Innenwelt". Bei Paaren in Krise dreht sich diese Mechanik um — selbst gute Taten werden negativ gedeutet („was hat er denn jetzt im Schilde?"). Diese Filter-Verschiebung ist messbar, und sie ist umkehrbar.',
    philosophy2: 'Gottman: wenn ihr eure Geschichte nicht mehr in positiven Worten erzählen könnt, ist eure Beziehung in Gefahr. Wenn ihr es noch könnt — auch nach Streit, auch nach schweren Zeiten — habt ihr ein Polster, das Stürme trägt. Heute erinnert ihr eure Geschichte und üben die Worte ein.',
    formats: {
      pair: {
        label: 'Zu zweit',
        duration: '~1 Std. 40 Min.',
        ...
        stations: withFeedback([
          ...
          { name: 'Geschichte', title: 'Wie alles anfing — neu erzählt', duration: 18*60,
            hostNote: 'Setzt euch gegenüber. Person A erzählt 7 Min: wie habt ihr euch das erste Mal getroffen? Was hat dich an ihm/ihr sofort getroffen? Welche Szene aus der frühen Zeit ist dir geblieben? Person B hört nur zu — nicht korrigieren, nicht ergänzen. Dann wechseln. Wer schon viele Jahre zusammen ist: erzählt eine konkrete Anekdote aus dem ersten Jahr, die ihr nicht oft erzählt habt.',
            ...
            question: 'Was war der Moment, an dem du wusstest, dass du den anderen wirklich kennenlernen willst?' },
          { name: 'Was ich schätze', title: '50 Wertschätzungs-Worte', duration: 12*60,
            hostNote: 'Beide markieren für sich je drei Eigenschaften aus der Liste, die ihr am Partner besonders schätzt. Dann reihum: nennt eure drei und benennt jeweils einen konkreten Moment, in dem ihr diese Eigenschaft erlebt habt. Empfänger:in sagt nur „Danke".',
            description: 'Gottmans Liste von 50 Wertschätzungs-Worten — wählt drei, mit denen ihr euren Partner ehrlich beschreiben würdet.',
            items: [
          ...
          { name: 'Sieben Wochen', title: 'Der Sieben-Wochen-Plan', duration: 8*60,
            hostNote: 'Eine:r liest die Anweisung vor. Ihr bekommt diesen Plan als Mitnahme — er ist die eigentliche Arbeit zwischen heute und Abend 4.',
            description: 'Gottmans messbar wirksame Methode, die positive Brille einzuüben: sieben Wochen lang, jeden Werktag, ein Gedanke und eine Aufgabe. Die Aufgaben sind klein, die Gedanken positiv und konkret.\n\nBeispiele (jeden Tag ein anderer Mini-Anker): „Mein Partner ist großzügig" — heute schreibe ich einen Satz auf einen Zettel, der das ehrt. „Sex ist gut zwischen uns" — heute plane ich einen erotischen Abend. „Wir haben es weit zusammen gebracht" — heute erinnere ich an eine schwere Zeit, die wir durchstanden haben.\n\nDer Plan ist nicht Selbst-Training — er ist Aufmerksamkeits-Verschiebung. Sieben Wochen reichen, weil die Forschung zeigt: nach sieben Wochen bewusster Wertschätzung hat sich die Standard-Brille verändert.',
          ...
          { name: 'Erste Woche', title: 'Eure erste Woche planen', duration: 8*60,
            hostNote: 'Beide schreiben für sich fünf Aufgaben für die erste Woche (Mo-Fr, je eine kleine konkrete Mini-Tat). Dann tauscht ihr aus. Wichtig: nicht „ich werde besser sein", sondern: „Montag schicke ich ihr ein Foto von dem Café, in dem wir zum ersten Mal Kaffee getrunken haben."',
      ...
      solo: {
        ...
        stations: withFeedback([
          { name: 'Öffnen', title: 'Kurz ankommen', duration: 2*60,
            hostNote: 'Kerze, Notizbuch.',
            description: 'Wertschätzungs-Arbeit allein ist genauso real — sie reaktiviert deine eigene Brille auf den Partner, der nicht im Raum ist.' },
          { name: 'Einstieg', title: 'Die positive Brille', duration: 4*60,
            ...
            description: 'Heute reaktivierst du deine eigene Wertschätzungs-Brille — auch wenn der Partner nicht da ist.' },
          { name: 'Geschichte', title: 'Wie alles anfing', duration: 10*60,
            hostNote: 'Schreibe 8 Min am Stück — nicht editieren.',
            question: 'Wie habt ihr euch das erste Mal getroffen? Was hat dich an ihm/ihr sofort getroffen — und welche Szene aus der frühen Zeit erinnerst du besonders warm?' },
          { name: 'Drei Worte', title: 'Wertschätzung in drei Worten', duration: 6*60,
            hostNote: 'Schreibe drei Eigenschaften deines Partners — und für jede einen konkreten Moment, in dem du sie erlebt hast.',
            description: 'Wertschätzung ohne Anlass ist Kompliment. Wertschätzung mit konkretem Moment ist Wahrheit.',
            question: 'Welche drei Eigenschaften deines Partners schätzt du gerade besonders — woran erinnerst du sie?' },
          { name: 'Brief', title: 'Ein nicht-geschickter Brief', duration: 10*60,
            hostNote: 'Schreibe einen Brief an deinen Partner, den du nicht abschickst. Beginne mit: „Was du nicht weißt, ist…". Schreibe 8 Min, ohne abzusetzen.',
          ...
          { name: 'Sieben Wochen', title: 'Der Plan für dich allein', duration: 6*60,
            hostNote: 'Schreibe für die ersten 5 Werktage je eine Mini-Aufgabe. Wenn du allein machst: die Aufgaben fließen in deine Aufmerksamkeit, nicht in seine/ihre Reaktion.',
            description: 'Auch ohne Partner kannst du den Sieben-Wochen-Plan beginnen. Jeden Tag eine konkrete Mini-Geste: eine Nachricht, ein Erinnerungs-Foto, ein kurzes „Ich denke an dich". Die Verschiebung ist deine, nicht seine/ihre.',
            question: 'Fünf Mini-Akte für die nächsten fünf Werktage?' },
          { name: 'Brille-Check', title: 'Wo deine Brille trüb ist', duration: 5*60,
            hostNote: 'Schreibe ehrlich.',
            question: 'In welchem Bereich deiner Wahrnehmung deines Partners ist die positive Brille gerade trüb geworden — und was hat sie trüb gemacht?' },
          { name: 'Ausblick', title: 'Abend 4', duration: 3*60,
            hostNote: 'Lies.',
  ...
  wir_reise_4: {
    ...
    philosophy1: 'Im Ehelabor liebt Gottman die langweiligen Szenen am meisten — wenn ein Partner aus dem Fenster schaut und sagt „He, schau dir das Schiff an", und der andere kurz aufblickt und nickt. Solche Mikro-Momente sind, was Beziehungen wirklich tragen. Sie scheinen banal — und sind in Wahrheit das Material, aus dem Romantik gemacht ist.',
      ...
      pair: {
        ...
        stations: withFeedback([
          ...
          { name: 'Einstieg', title: 'Die Mikro-Momente', duration: 7*60,
            hostNote: 'Vorlesen.',
            quote: { text: 'In den langweiligsten Szenen — wenn er sagt „he, schau dir das Schiff an" und sie kurz hochschaut — entscheidet sich das Schicksal einer Ehe.', author: 'John Gottman (sinngemäß)' },
            description: 'Gottman hat eine kleine Studie gemacht, die alles verändert: 130 Paare beobachtet, sechs Jahre später nachgesehen. In den Ehen, die hielten, hatten die Partner 86 % der „bids for connection" — der kleinen Verbindungsangebote — angenommen. In den geschiedenen Ehen: 33 %. Das war alles. Keine großen Streits. Nur das tägliche Wegschauen.',
          ...
          { name: 'Antworten', title: 'Drei Antwort-Klassen', duration: 8*60,
            ...
            items: [
              { accent: 'A.', label: 'Zuwenden', text: 'Aufschauen, kurz antworten, nicken, zustimmen. Auch minimale Aktivität zählt. „Aha." reicht oft.' },
            ...
            question: 'In welche Klasse fällt deine Standard-Antwort auf Mikro-Angebote deines Partners?' },
          { name: 'Beobachtungs-Übung', title: 'Eine Stunde Mikro-Inventar', duration: 12*60,
            hostNote: 'Zwei Minuten still. Dann reihum: erinnert euch an die letzte gemeinsame Stunde (gestern Abend / heute morgen). Geht sie langsam durch — welche Angebote habt ihr gesendet, welche habt ihr bekommen? Wie habt ihr reagiert? Sehr wichtige Regel: jede:r benennt nur eigene Angebote und eigene Reaktionen. Nicht den Partner analysieren.',
            ...
            question: 'Welche Angebote von dir wurden in dieser Stunde nicht angenommen — und welche nahmst du nicht an?' },
          ...
          { name: 'Mini-Praxen', title: 'Sechs Mikro-Übungen für die Woche', duration: 10*60,
            ...
            items: [
              ...
              { accent: '2.', label: 'Sechs-Stunden-Regel', text: 'Gottmans empirischer Befund — Paare, die mindestens 6 Stunden pro Woche bewusst füreinander aufwenden (verteilt über Tage), bleiben verbunden. Verteilt auf 5 Mini-Akte täglich.' },
              { accent: '3.', label: 'Tag-Briefing', text: 'Einmal täglich, fester Slot: 5 Min. Wie war dein Tag? Nicht „gut, und deiner?". Echte Antwort, echtes Zuhören.' },
              { accent: '4.', label: 'Stress-Reduktions-Gespräch', text: '20 Min am Abend, bei dem nicht ihr beide diskutiert werdet, sondern jede:r über externen Stress (Arbeit, Familie, Welt) spricht — der/die andere hört nur zu und tröstet. Stress-Importeur, nicht Stress-Lösung.' },
              ...
              { accent: '6.', label: 'Hand-auf-Schulter', text: 'Beim Vorbeigehen, wenn der/die andere am Schreibtisch sitzt: einmal kurz die Hand auf die Schulter. Wortlos.' }
            ],
          ...
          { name: 'Schritt', title: 'Die zwei für diese Woche', duration: 6*60,
            ...
            question: 'Welche zwei Mikro-Übungen einübt ihr diese Woche bewusst?' },
          { name: 'Einladung', title: 'Wohin Abend 5 führt', duration: 4*60,
            hostNote: 'Vorlesen.',
            description: '→ Abend 5 — Einfluss zulassen. Hier wird es politisch: Macht teilen ist nicht „brav", es ist statistisch das stärkste Mittel gegen Trennung. Gottman fand: Ehemänner, die den Einfluss ihrer Frauen NICHT zulassen, scheitern zu 81 %. Das gilt für alle Partner:innen aller Konstellationen — wer die Stimme des/der anderen nicht wirklich an sich heranlässt, verliert sie irgendwann.' },
          { name: 'Wort', title: 'Ein Wort', duration: 3*60,
            hostNote: 'Beide je ein Wort.',
            question: 'Ein Wort.' }
        ])
      ...
      solo: {
        ...
        stations: withFeedback([
          ...
          { name: 'Einstieg', title: '86 vs 33', duration: 4*60,
            hostNote: 'Lies zweimal.',
            quote: { text: 'In stabilen Ehen werden 86 % der Verbindungs-Angebote angenommen. In geschiedenen 33 %.', author: 'John Gottman' },
          ...
          { name: 'Inventar', title: 'Die letzte Stunde mit ihm/ihr', duration: 10*60,
          ...
          { name: 'Sechs Übungen', title: 'Was du allein einüben kannst', duration: 8*60,
            ...
            description: 'Auch ohne den Partner kannst du beginnen — das Angebot-Senden ist immer in deiner Macht:',
            items: [
              { accent: '1.', label: '6-Sekunden-Kuss', text: 'beim Hallo/Tschüss, sechs statt zwei Sekunden.' },
              { accent: '2.', label: 'Tag-Briefing', text: 'fester Slot, echte Antwort.' },
              { accent: '3.', label: 'Hand-auf-Schulter', text: 'wortlos beim Vorbeigehen.' },
              { accent: '4.', label: 'Stress-Reduktions-Gespräch', text: '20 Min Zuhören ohne Lösungs-Drang.' },
              { accent: '5.', label: 'Abschieds-Ritual', text: '30 Sekunden vor Trennung.' },
              { accent: '6.', label: 'Aktive Antwort', text: '24 Stunden lang bewusst auf jedes Angebot zuwenden. Auch wenn klein.' }
            ],
            question: 'Welche zwei probierst du diese Woche?' },
          { name: 'Ausblick', title: 'Abend 5', duration: 3*60,
            hostNote: 'Lies.',
            description: '→ Abend 5 — Einfluss zulassen. Die schwerste Übung der Reise — wirklich die Stimme des anderen an sich heranlassen.' },
          { name: 'Wort', title: 'Ein Wort', duration: 2*60,
            hostNote: 'Ein Wort.',
            question: 'Ein Wort.' }
        ])
  ...
  wir_reise_5: {
    ...
    lead: 'Gottmans schärfste Statistik: Ehemänner, die ihre Frauen NICHT an sich heranlassen, scheitern zu 81 %. Das ist nicht „nett sein müssen" — das ist Beziehungs-Physik. Wer die Stimme des anderen nicht wirklich an sich heranlässt, verliert sie irgendwann ganz. Heute schaut ihr ehrlich hin: wo lasst ihr Einfluss zu, wo blockt ihr ab.',
    category: 'Wir-Reise',
    image: 'images/wir-reise-5.jpg',
    reise: { id: 'wir', nr: 5, total: 7, titel: 'Wir-Reise — Sieben Abende nach Gottman' },
    philosophy1: 'Einfluss zulassen heißt nicht: nachgeben. Es heißt: die Meinung des anderen ernsthaft in dein Entscheiden einbeziehen — als gleichwertig, nicht als Bittsteller-Stimme. Gottman fand: wer das tut, hat in 80 % aller Konflikte später eine bessere Lösung als der „Sieger" eines Machtkampfs. Beeinflussbarkeit ist keine Schwäche — sie ist Beziehungs-Intelligenz.',
    philosophy2: 'Diese Geheimnis ist die schwerste. Es kratzt am Selbstbild („ich bin doch flexibel"). Heute prüft ihr ehrlich mit Gottmans Selbsttest, wo ihr blockt — und ihr seht eine Hierarchie der Mauer: welcher der vier Reiter wird euer Standard-Tool, sobald die Stimme des anderen unbequem wird.',
    formats: {
      pair: {
        label: 'Zu zweit',
        duration: '~1 Std. 40 Min.',
        ...
        stations: withFeedback([
          ...
          { name: 'Einstieg', title: 'Die 81-Prozent-Zahl', duration: 7*60,
            ...
            description: 'Gottman hat diese Zahl bei jungverheirateten Paaren in seinen ersten Monaten der Ehe gemessen. 81 Prozent ist keine Schätzung — es ist die direkt vorhergesagte Scheidungsrate für eine messbare Eigenschaft: Beeinflussbarkeit. Männer, die ihren Frauen die Tür zur Mit-Entscheidung verschließen, verlieren ihre Ehe mit dieser Wahrscheinlichkeit.\n\nDie Zahl gilt umgekehrt nicht so scharf — Frauen, die ihre Männer blockieren, gefährden die Ehe nicht so messbar, weil sie statistisch ohnehin meistens beeinflussbar sind. Aber das Prinzip ist gegenseitig: wer die Stimme des anderen nicht ernsthaft an sich heranlässt, verliert sie irgendwann ganz.',
            teaser: '81 % — die schärfste Zahl der Beziehungs-Forschung.' },
          { name: 'Selbsttest', title: 'Wie beeinflussbar bist du?', duration: 12*60,
            hostNote: 'Jede:r markiert für sich. Antworte: trifft zu / trifft nicht zu. Bei „trifft nicht zu" gibt es einen Punkt für Beeinflussbarkeit. Maximum: 13 Punkte. Unter 7 = wirklich zu prüfen.',
            description: 'Gottmans Diagnostik. Antworte ehrlich — niemand außer dir hat Einblick.',
            items: [
              { accent: '1.', label: 'Schwarz-weiß', text: 'Wenn wir streiten, halte ich meine Position für klar richtig — am Schluss meistens.' },
              { accent: '2.', label: 'Eskalation', text: 'Wenn sie/er mit Kritik kommt, antworte ich oft mit größerer Kritik zurück.' },
              { accent: '3.', label: 'Spott', text: 'Manchmal mache ich ihre/seine Position lächerlich, ohne es zu wollen.' },
              ...
              { accent: '6.', label: 'Übersehen', text: 'Wenn sie/er einen guten Punkt macht, sage ich das selten zu Beginn.' },
              { accent: '7.', label: 'Verachtung', text: 'Bei Streit denke ich manchmal: „typisch wieder".' },
              { accent: '8.', label: 'Geschlechter-Karte', text: 'Ich denke manchmal: „Männer/Frauen verstehen das einfach nicht".' },
              { accent: '9.', label: 'Über-stimmen', text: 'Bei Entscheidungen über Geld/Erziehung/Wohnen treffe ich öfter die finale Entscheidung.' },
              { accent: '10.', label: 'Pünktlichkeit', text: 'Wenn ihre/seine Wünsche meinen Plan stören, halte ich meinen Plan.' },
              { accent: '11.', label: 'Verteidigen', text: 'Bei Beschwerde fange ich oft mit „aber" oder „du auch" an.' },
              { accent: '12.', label: 'Gefühl-Übersehen', text: 'Wenn sie/er traurig ist, suche ich oft sofort eine Lösung statt zuzuhören.' },
              { accent: '13.', label: 'Übergangen', text: 'Manchmal habe ich das Gefühl, mein:e Partner:in fühlt sich von mir übergangen.' }
            ],
          ...
          { name: 'Auswertung', title: 'Was die Zahl bedeutet', duration: 5*60,
            ...
            description: '11-13 Punkte: solide beeinflussbar. Wahrscheinlich Quelle der Stabilität in eurer Beziehung.\n7-10: durchwachsen. In Stress-Situationen klappt es weniger. Übung hier ist sinnvoll.\nUnter 7: hier ist Material. Nicht „du bist schlecht" — du hast Muster, die in Stress-Momenten greifen, und sie kosten dich.',
          ...
          { name: 'Vier Reiter Reload', title: 'Welcher Reiter trägt deine Blockade?', duration: 10*60,
            hostNote: 'Reihum je 4 Min. Erinnere konkret an einen Moment der letzten zwei Wochen, wo du nicht an dich rangelassen hast. Welcher Reiter war es?',
            description: 'Einfluss-Blockade hat fast immer einen der vier Reiter als Tool: Kritik (deine Position klein machen), Verachtung (sie/ihn klein machen), Rechtfertigung (alles weg-erklären), Mauern (zumachen). Welcher ist dein Standard, wenn etwas zu nah kommt?',
            question: 'In welchem Moment hast du den/die andere(n) gerade nicht an dich herangelassen — und welcher der vier Reiter hat dabei mitgeritten?' },
          { name: 'Stille', title: 'Drei Minuten', duration: 3*60,
          ...
          { name: 'Drei Themen', title: 'Drei Bereiche, in denen du an dich heranlassen willst', duration: 14*60,
            hostNote: 'Beide schreiben für sich 5 Min: drei konkrete Bereiche, in denen ihr beide bisher nicht wirklich gleichberechtigt entscheidet — eure Stimme dominiert oder eure Stimme verstummt. Dann reihum je 4 Min — der/die andere hört nur, sagt am Schluss „Danke".',
            description: 'Es gibt in jeder Beziehung Bereiche, in denen einer der beiden faktisch entscheidet (Geld, Urlaubsplanung, Kinder-Erziehung, Wohnungs-Einrichtung, sexueller Initiative, Sozialkontakte). Wer die Macht in einem Bereich nicht teilt, gewinnt scheinbar — und verliert auf lange Sicht. Heute benennt ihr drei.',
          ...
          { name: 'Konkreter Pakt', title: 'Ein Pakt für die Woche', duration: 8*60,
            hostNote: 'Vereinbart zu zweit: eine konkrete Entscheidung, die ihr diese Woche bewusst gemeinsam trefft. Ihr beide ehrlich mit Stimme. Schreibt sie auf einen Zettel.',
            description: 'Nicht „wir werden besser kommunizieren". Sondern: „Sonntag, beim Wochenend-Planung, hören wir beide einander 5 Min an, bevor wir entscheiden." Klein, konkret, überprüfbar.',
          ...
          { name: 'Einladung', title: 'Wohin Abend 6 führt', duration: 4*60,
            hostNote: 'Vorlesen.',
            description: '→ Abend 6 — Konflikte: lösbar vs. patt. Jetzt geht ihr an das, was im Alltag wirklich schwierig ist: streiten. Gottman hat in seinen Daten zwei Arten Streit entdeckt — 69 % aller Paar-Konflikte sind „ewige Probleme" (Pattsituationen), die nicht gelöst werden können, sondern nur gemanagt. Und 31 % sind lösbar. Wer das nicht trennt, kämpft an der falschen Front. Plus: Träume hinter Pattsituationen — die Goldader unter euren Dauer-Konflikten.' },
          { name: 'Wort', title: 'Ein Wort', duration: 3*60,
            hostNote: 'Beide je ein Wort.',
            question: 'Ein Wort.' }
        ])
      ...
      solo: {
        ...
        stations: withFeedback([
          ...
          { name: 'Einstieg', title: '81 Prozent', duration: 4*60,
            hostNote: 'Lies zweimal.',
            quote: { text: 'Wer die Stimme des anderen nicht wirklich an sich heranlässt, verliert sie irgendwann.', author: 'John Gottman (sinngemäß)' },
          ...
          { name: 'Selbsttest', title: 'Deine Beeinflussbarkeit', duration: 10*60,
            ...
            description: '13 Aussagen — jedes „trifft nicht zu" ist ein Punkt für Beeinflussbarkeit.',
            items: [
              { accent: '1.', label: 'Schwarz-weiß', text: 'Ich halte meine Position bei Streit für meistens klar richtig.' },
              { accent: '2.', label: 'Eskalation', text: 'Bei Kritik antworte ich mit größerer Kritik.' },
              { accent: '3.', label: 'Spott', text: 'Ich mache die Position des anderen manchmal lächerlich.' },
              ...
              { accent: '6.', label: 'Übersehen', text: 'Gute Punkte des anderen erkenne ich selten direkt an.' },
              { accent: '7.', label: 'Verachtung', text: '„Typisch wieder" denke ich öfter als gesagt.' },
          ...
          { name: 'Reiter-Diagnose', title: 'Welcher Reiter trägt dich?', duration: 8*60,
            hostNote: 'Schreibe.',
            question: 'Erinnere konkret an einen Moment der letzten zwei Wochen, in dem du nicht an dich rangelassen hast — welcher der vier Reiter (Kritik / Verachtung / Rechtfertigung / Mauern) war dein Tool?' },
          ...
          { name: 'Geste', title: 'Eine konkrete Geste für die Woche', duration: 5*60,
            ...
            question: 'Welche eine konkrete Geste in deinem Alltag macht diese Woche sichtbar, dass du die Stimme des anderen wirklich einlässt?' },
          { name: 'Ausblick', title: 'Abend 6', duration: 3*60,
            hostNote: 'Lies.',
            description: '→ Abend 6 — Konflikte: lösbar vs. patt. Die zwei Arten Streit, und wie ihr sie unterscheidet.' },
          { name: 'Wort', title: 'Ein Wort', duration: 3*60,
            hostNote: 'Ein Wort, Zettel, Tasche.',
            question: 'Ein Wort.' }
        ])
  ...
  wir_reise_6: {
    ...
    lead: '69 Prozent aller Paar-Konflikte sind nicht lösbar — sie sind „ewige Probleme", in denen ihr lernt zu leben. Die anderen 31 Prozent sind lösbar, brauchen aber Werkzeug. Gottmans schärfste Diagnose: wer beide Typen für lösbar hält, kämpft sich tot. Wer beide für unlösbar hält, gibt zu früh auf. Heute lernt ihr trennen und in beiden navigieren.',
    category: 'Wir-Reise',
    image: 'images/wir-reise-6.jpg',
    reise: { id: 'wir', nr: 6, total: 7, titel: 'Wir-Reise — Sieben Abende nach Gottman' },
    philosophy1: 'Gottman hat 130 Paare 7 Jahre lang beobachtet. Bei jedem fand er: die ewigen Probleme sind dieselben — Punkt 1 nach 5 Jahren ist Punkt 1 nach 12 Jahren. „Sie wollte mehr zusammen sein, er wollte mehr Zeit allein" — das ändert sich nicht. Was sich ändert, ist, wie das Paar damit umgeht. Glückliche Paare lachen darüber. Unglückliche zerreiben sich.',
      ...
      pair: {
        ...
        stations: withFeedback([
          ...
          { name: 'Einstieg', title: 'Zwei Arten Streit', duration: 8*60,
            ...
            description: 'Gottmans schärfste Einsicht: Konflikte teilen sich in zwei klare Klassen.\n\nLösbare Probleme (31 %): konkret, situativ, ohne tiefere persönliche Wurzel. „Wer ruft die Schwiegermutter an?" „Wer macht heute den Müll?" Diese kann man wirklich lösen mit Methode.\n\nEwige Probleme (69 %): tiefer verwurzelt in Persönlichkeit, Werten, Lebensträumen. „Wir wollen unterschiedlich oft Sex." „Du willst Stadt, ich Land." „Du willst Kinder, ich nicht." Diese kann man NICHT lösen. Sie kann man nur konstruktiv leben.\n\nDer fatale Fehler: ein ewiges Problem wie ein lösbares behandeln. Da kämpft man sich tot. Heute lernt ihr beide Wege.',
          ...
          { name: 'Lösbar Schritt 1', title: 'Der sanfte Auftakt', duration: 10*60,
            hostNote: 'Vorlesen.',
            description: 'Gottman hat untersucht, was in den ersten drei Minuten eines Streits passiert — und mit 96 % Genauigkeit das Ende vorhergesagt. Der Schlüssel ist der Auftakt.\n\nGrober Auftakt: „Du bist so ein Egoist." „Du hörst NIE zu." „Wieder mal hast du..." Vier-Reiter-Energie ab Sekunde eins.\n\nSanfter Auftakt: „Ich war heute traurig, als…" „Mir würde es helfen, wenn…" „Ich brauche dich gerade für..." Ich-Botschaft, konkret, ohne Charakter-Attacke.\n\nGottmans Daten: nach grobem Auftakt endet der Streit in 96 % der Fälle negativ — egal was danach passiert. Nach sanftem Auftakt: in 80 % positiv.',
            items: [
            ...
            teaser: 'Drei Minuten entscheiden — in 96 % der Fälle.' },
          { name: 'Lösbar Schritt 2-5', title: 'Vier weitere Schritte für Lösbares', duration: 12*60,
            ...
            items: [
              ...
              { accent: '2.', label: 'Reparatur-Versuche annehmen', text: 'Mitten im Streit macht einer von euch ein „Repair" (Humor, Berührung, „Du hast recht damit"). Das ist Gold — wenn ihr es bemerkt und annehmt.' },
              { accent: '3.', label: 'Selbst-Beruhigung', text: 'Bei „Flooding" (Herzfrequenz über 100): Pause vereinbaren. Mindestens 20 Min, in denen ihr NICHT übers Thema redet. Atmet, geht spazieren, hört Musik. Dann wieder rein.' },
              { accent: '4.', label: 'Kompromiss finden', text: 'Beide schreiben für sich: was darf nicht verhandelt werden? Was ist flexibel? Tauscht aus. Der Kompromiss ist da, wo beide Flexibel-Listen sich treffen.' },
              { accent: '5.', label: 'Schwächen tolerieren', text: 'Wer die Verschrobenheit des anderen NICHT akzeptiert, kann nichts wirklich lösen. Ihr verhandelt nicht „wer hat recht", sondern „wie machen WIR das?"' }
            ],
            teaser: 'Fünf Schritte für die 31 % der Konflikte, die wirklich lösbar sind.' },
          { name: 'Lebensszene', title: 'Eine echte eigene Szene durchgehen', duration: 18*60,
            ...
            description: 'Theorie ist leicht. Das eigene Beispiel durch das Modell laufen lassen ist die Übung. Achtet darauf: heute IST das nicht der Streit — heute ist es Analyse. Wenn dabei doch Emotionen hochkommen, atmet und macht weiter ruhig.',
          ...
          { name: 'Eigene Patt', title: 'Eure ewige Streit-Frage', duration: 15*60,
            ...
            description: 'Das ist die wahrscheinlich wichtigste Übung der ganzen Reise. Wenn ihr versteht, welche Träume eures gegenüber in einer Pattsituation ringen, könnt ihr den Streit zwar nicht „lösen" — aber respektieren. Und respektierte Pattsituationen verlieren ihre Schärfe.',
      ...
      solo: {
        ...
        stations: withFeedback([
          ...
          { name: 'Sanfter Auftakt', title: 'Wie du beginnst', duration: 8*60,
            hostNote: 'Schreibe.',
            question: 'Welcher deiner letzten zwei Streits hatte einen groben Auftakt — und wie hätte ein sanfter Auftakt geklungen? („Du machst immer..." → „Ich brauche...")?' },
          { name: 'Träume', title: 'Welcher Traum liegt unter eurem Dauer-Streit?', duration: 12*60,
            hostNote: 'Schreibe 10 Min. Erinnere an einen Konflikt, der seit Monaten/Jahren immer wieder kommt.',
            ...
            question: 'Welcher Traum von dir steckt unter dem Konflikt — und welcher Traum vermutest du beim anderen?' },
          { name: 'Fünf Schritte', title: 'Dein Lösbar-Werkzeug', duration: 8*60,
            hostNote: 'Lies + markiere.',
            description: 'Gottmans 5 Schritte für lösbare Konflikte.',
            items: [
              { accent: '1.', label: 'Sanfter Auftakt', text: 'Ich-Botschaft.' },
              { accent: '2.', label: 'Repair', text: 'Mitten im Streit kleine Reparatur.' },
              { accent: '3.', label: 'Selbst-Beruhigung', text: 'Bei Flooding: Pause 20+ Min.' },
              { accent: '4.', label: 'Kompromiss', text: 'Was nicht verhandelbar, was flexibel?' },
    ...
    formats: {
      pair: {
        ...
        stations: withFeedback([
          ...
          { name: 'Rückblende', title: 'Die ganze Reise in einem Bild', duration: 12*60,
            hostNote: 'Beide schreiben 4 Min: „Wenn die ganze Reise von Abend 1 bis heute ein Bild wäre — was wäre es?" Dann reihum je 2 Min. Kurz, nicht-interpretierbar.',
          ...
          { name: 'Rollen', title: 'Wer ihr füreinander seid', duration: 10*60,
            ...
            description: 'In einer Beziehung übernehmt ihr viele Rollen: Partner:in, Freund:in, Verbündete:r, Eltern (wenn Kinder), Ko-Pilot:in im Alltag, Lehrer:in (manchmal), Schüler:in (auch manchmal), Tröster:in, Ratgeber:in, Bewunderer:in. Welche Rollen sind klar, welche schwierig?',
          ...
          { name: 'Ziele', title: 'Eure gemeinsamen Ziele', duration: 10*60,
            ...
            description: 'Ziele können konkret (ein bestimmtes Haus, ein Kind, eine Reise) oder abstrakt (sich sicher fühlen, Abenteuer leben, Würde im Alter) sein. Wichtig ist nicht, dass ihr alle teilt — wichtig ist, dass ihr beide eure kennt und respektiert.',
          ...
          { name: 'Kreis-Vertrag', title: 'Drei Vereinbarungen, die euch tragen', duration: 14*60,
            ...
            description: 'Nicht „wir wollen liebevoll sein". Sondern: „Jeden Sonntag 30 Min Wir-Zeit mit Kaffee und ohne Handy." Oder: „Bei Streit machen wir immer einen sanften Auftakt — auch wenn schwer." Oder: „Einmal im Monat ein langes Gespräch über das, was zwischen uns passiert ist."\n\nSchreibt sie auf einen Zettel, beide unterschreiben symbolisch, an die Wand oder in eine Schublade.',
            items: [
          ...
          { name: 'Dank', title: 'Was ich von dir mitnehme', duration: 10*60,
            hostNote: 'Beide je 4 Min. „Was ich in diesen sieben Abenden über dich gelernt habe, das ich vorher nicht wusste, ist…" Andere:r sagt am Ende „Danke", nichts mehr.',
      ...
      solo: {
        ...
        stations: withFeedback([
          ...
          { name: 'Was fehlt', title: 'Welches Ritual fehlt euch', duration: 6*60,
            hostNote: 'Schreibe.',
            question: 'Welches eine Ritual würde eurer Beziehung gut tun, das ihr noch nicht habt?' },
